...
def angle_diff_sym(angle1, angle2, simi=1):
	...
	else:            return degrees(old_div(atan2(sini, cosi),simi))%(old_div(360.0,simi))
...
def ave_ali_err(data1, data2=None, r=25, suffix="_ideal"):
	...
	return alphai, sxi, syi, mirror, old_div(float(mirror_same),nima), old_div(err,mirror_same)
...
def mapcoords(x, y, r, nx, ny):
	...
	if r > 1:
		...
		nbrhd = int(ceil(old_div(1.0,r)))+1
