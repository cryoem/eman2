...
def print_a_line_with_timestamp_deprecated_1(string_to_be_printed ):
	line = strftime("%Y-%m-%d_%H:%M:%S", localtime()) + " =>"
...
def get_number_of_groups_deprecated_1(total_particles,number_of_images_per_group, round_off=.2):
