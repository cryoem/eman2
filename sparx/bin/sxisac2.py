...
def main(args):
	...
	parser.add_option("--img_per_grp",           type="int",           default=200,        help="number of images per class: in the ideal case (essentially maximum size of class) (default 100)")
	parser.add_option("--minimum_grp_size",      type="int",           default=60,         help="minimum size of class (default 30)")
