...
"""
	...
	parser.add_option("--new_apix",           type="float", 		 default=-1.0,                help="New target pixel size to which the micrograph should be resampled. Default is -1, in which case new_pixel_size is assumed to be same as pixel_size.")
