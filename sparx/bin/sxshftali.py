...
def main():
	...
	parser.add_option("--search_rng",       type="int",  default=-1,             help="a nwx by nwx of the image is windowed out for peak search of ccf between image and reference, where nwx=2*search_rng+1 (if search_rng is -1, then nwx=nx")
	parser.add_option("--ou",       type="float",  default=-1,            help="outer radius for making default mask < nx/2-1 (set to the radius of the particle)")
	parser.add_option("--maxit",    type="float",  default=100,             help="maximum number of iterations")
	...
	parser.add_option("--oneDx",  action="store_true", default=False,   help="Window out central line for peak search of ccf between image and reference")
