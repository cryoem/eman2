...
def main():
	...
	usage = progname + " stack outdir --delta=angular_delta --rand_seed=random_seed --trials=number_of_trials --refine --MPI"
	...
	parser.add_option("--iterations",type="int",          default=10,       help=" Maximum number of iterations (10)")
	...
	(options, args) = parser.parse_args()
		...
		find_struct(args[0], args[1], options.delta, options.ir, options.ou, options.iterations, options.rand_seed, options.trials, options.refine, options.MPI, options.debug)
