...
class SXMainWindow(QMainWindow): # class SXMainWindow(QWidget):
	...
	def construct_sxcmd_category_list(self):
		...
		token = SXcmd_token(); token.key_base = "no_adjustment"; token.key_prefix = "--"; token.label = "No power adjustment"; token.help = "Do not adjust power spectrum of averages. "; token.group = "main"; token.is_required = False; token.is_locked = False; token.default = False; token.restore = False; token.type = "bool"; sxcmd.token_list.append(token)
		token = SXcmd_token(); token.key_base = "adjust_to_analytic_model"; token.key_prefix = "--"; token.label = "Adjust power to analytical model"; token.help = "Adjust power spectrum of averages to an analytical model. "; token.group = "main"; token.is_required = False; token.is_locked = False; token.default = False; token.restore = False; token.type = "bool"; sxcmd.token_list.append(token)
		token = SXcmd_token(); token.key_base = "adjust_to_given_pw2"; token.key_prefix = "--"; token.label = "Adjust power to rotational average"; token.help = "Adjust power spectrum of averages to a given 1-D reference power spectrum. "; token.group = "main"; token.is_required = False; token.is_locked = False; token.default = False; token.restore = False; token.type = "bool"; sxcmd.token_list.append(token)
		...
		token = SXcmd_token(); token.key_base = "B_enhance"; token.key_prefix = "--"; token.label = "Adjust power to B-factor"; token.help = "using B-factor to enhance averages. "; token.group = "main"; token.is_required = False; token.is_locked = False; token.default = False; token.restore = False; token.type = "bool"; sxcmd.token_list.append(token)
