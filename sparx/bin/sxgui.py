...
class SXMainWindow(QMainWindow): # class SXMainWindow(QWidget):
	...
	def construct_sxcmd_category_list(self):
		...
		token = SXcmd_token(); token.key_base = "new"; token.key_prefix = "--"; token.label = "Use new code"; token.help = "Use new code. "; token.group = "advanced"; token.is_required = False; token.is_locked = False; token.default = False; token.restore = False; token.type = "bool"; sxcmd.token_list.append(token)
		...
		token = SXcmd_token(); token.key_base = "data_stack"; token.key_prefix = "--"; token.label = "Original image stack"; token.help = "Particles required to create the full-sized class averages. "; token.group = "main"; token.is_required = True; token.is_locked = False; token.default = ""; token.restore = ""; token.type = "image"; sxcmd.token_list.append(token)
		token = SXcmd_token(); token.key_base = "isac_dir"; token.key_prefix = "--"; token.label = "Isac output directory"; token.help = "Name of the directory where isac was run previously. "; token.group = "main"; token.is_required = True; token.is_locked = False; token.default = ""; token.restore = ""; token.type = "directory"; sxcmd.token_list.append(token)
		token = SXcmd_token(); token.key_base = "masterdir"; token.key_prefix = "--"; token.label = "Output directory"; token.help = "The directory will be automatically created and the results will be written here. "; token.group = "main"; token.is_required = True; token.is_locked = False; token.default = ""; token.restore = ""; token.type = "output"; sxcmd.token_list.append(token)
		...
		token = SXcmd_token(); token.key_base = "noctf"; token.key_prefix = "--"; token.label = "No CTF correction"; token.help = "Use this option if full CTF correction should not be applied. Useful for negative stained data. By default, the program will do full CTF correction. "; token.group = "main"; token.is_required = False; token.is_locked = False; token.default = False; token.restore = False; token.type = "bool"; sxcmd.token_list.append(token)
		token = SXcmd_token(); token.key_base = "nompw_adj"; token.key_prefix = "--"; token.label = "Do not adjust PW spectrum"; token.help = "Do not adjust PW spectrum to analytical model or given 1-D rotationally averaged power spectrum. Apply PW spectrum adjustment to model. "; token.group = "advanced"; token.is_required = False; token.is_locked = False; token.default = False; token.restore = False; token.type = "bool"; sxcmd.token_list.append(token)
		...
		token = SXcmd_token(); token.key_base = "low_pass_filter"; token.key_prefix = "--"; token.label = "Low-pass filter frequency"; token.help = "Cutoff frequency of low-pass filter. "; token.group = "advanced"; token.is_required = False; token.is_locked = False; token.default = "-1.0"; token.restore = "-1.0"; token.type = "float"; sxcmd.token_list.append(token)
		token = SXcmd_token(); token.key_base = "pixel_size"; token.key_prefix = "--"; token.label = "Pixel size [A/Pixels]"; token.help = "The pixel size of images in input particle stack for isac. "; token.group = "advanced"; token.is_required = False; token.is_locked = False; token.default = "-1.0"; token.restore = "-1.0"; token.type = "apix"; sxcmd.token_list.append(token)
		...
		sxcmd = SXcmd(); sxcmd.name = "sxsort3d_new"; sxcmd.subname = ""; sxcmd.mode = ""; sxcmd.label = "3D Clustering - SORT3D_NEW"; sxcmd.short_info = "UNDER DEVELOPMENT. Reproducible 3D Clustering of heterogeneous dataset. Sort out 3D heterogeneity of 2D data whose 3D reconstruction parameters have been determined already."; sxcmd.mpi_support = True; sxcmd.mpi_add_flag = False; sxcmd.category = "sxc_sort3d"; sxcmd.role = "sxr_pipe"; sxcmd.is_submittable = True
		token = SXcmd_token(); token.key_base = "refinement_dir"; token.key_prefix = "--"; token.label = "Input 3D refinement directory"; token.help = "The master output directory of sxmeridien. "; token.group = "main"; token.is_required = True; token.is_locked = False; token.default = ""; token.restore = ""; token.type = "directory"; sxcmd.token_list.append(token)
		...
		token = SXcmd_token(); token.key_base = "img_per_grp"; token.key_prefix = "--"; token.label = "Images per group"; token.help = "The number of images per a group. This value is critical for successful 3D clustering. "; token.group = "main"; token.is_required = False; token.is_locked = False; token.default = "1000"; token.restore = "1000"; token.type = "int"; sxcmd.token_list.append(token)
		token = SXcmd_token(); token.key_base = "minimum_grp_size"; token.key_prefix = "--"; token.label = "Smallest group size"; token.help = "Minimum number of members for being identified as a group. This value must be smaller than the number of images per a group (img_per_grp). "; token.group = "main"; token.is_required = False; token.is_locked = False; token.default = "500"; token.restore = "500"; token.type = "int"; sxcmd.token_list.append(token)
		...
		token = SXcmd_token(); token.key_base = "eqkmeans_tilt2"; token.key_prefix = "--"; token.label = "EQK-means Upper tilting bound"; token.help = "Upper bound of sampling tilting angle (theta) used for EQKmeans orientation constraints. "; token.group = "advanced"; token.is_required = False; token.is_locked = False; token.default = "180.0"; token.restore = "180.0"; token.type = "float"; sxcmd.token_list.append(token)
		...
		token = SXcmd_token(); token.key_base = "minimum_ptl_number"; token.key_prefix = "--"; token.label = "Smallest orientation group size"; token.help = "The smallest orientation group size wich equals number_of_groups multiplied by this number. The value have to be an integer. "; token.group = "advanced"; token.is_required = False; token.is_locked = False; token.default = "20"; token.restore = "20"; token.type = "int"; sxcmd.token_list.append(token)
		token = SXcmd_token(); token.key_base = "notapplybckgnoise"; token.key_prefix = "--"; token.label = "Do not apply noise"; token.help = "Do not apply background noise. "; token.group = "advanced"; token.is_required = False; token.is_locked = False; token.default = False; token.restore = False; token.type = "bool"; sxcmd.token_list.append(token)
		token = SXcmd_token(); token.key_base = "mtf"; token.key_prefix = "--"; token.label = "MTF file"; token.help = "File contains the MTF (modulation transfer function) of the detector used. "; token.group = "advanced"; token.is_required = False; token.is_locked = False; token.default = "none"; token.restore = "none"; token.type = "parameters"; sxcmd.token_list.append(token)
		token = SXcmd_token(); token.key_base = "B_enhance"; token.key_prefix = "--"; token.label = "B-factor enhancement"; token.help = "-1.0: B-factor is not applied; 0.0: program estimates B-factor from options. B_start (usually 10 Angstrom) to the resolution determined by FSC143; 128.0: program use the given value 128.0 [A^2] to enhance map. "; token.group = "advanced"; token.is_required = False; token.is_locked = False; token.default = "0.0"; token.restore = "0.0"; token.type = "float"; sxcmd.token_list.append(token)
		token = SXcmd_token(); token.key_base = "postlowpassfilter"; token.key_prefix = "--"; token.label = "Low-pass filter frequency"; token.help = "0.0: low_pass filter to resolution; -1.0: no low_pass filter; 5.8: low_pass filter to 5.8 [A]; 0.2: low_pass filter to 0.2 (absolute frequency). "; token.group = "advanced"; token.is_required = False; token.is_locked = False; token.default = "0.0"; token.restore = "0.0"; token.type = "float"; sxcmd.token_list.append(token)
		token = SXcmd_token(); token.key_base = "aa"; token.key_prefix = "--"; token.label = "Low-pass filter fall-off"; token.help = "Low-pass filter fall-off. "; token.group = "advanced"; token.is_required = False; token.is_locked = False; token.default = "0.1"; token.restore = "0.1"; token.type = "float"; sxcmd.token_list.append(token)
		token = SXcmd_token(); token.key_base = "B_start"; token.key_prefix = "--"; token.label = "B-factor lower limit [A]"; token.help = "Lower limit for B-factor estimation. "; token.group = "advanced"; token.is_required = False; token.is_locked = False; token.default = "10.0"; token.restore = "10.0"; token.type = "float"; sxcmd.token_list.append(token)
		token = SXcmd_token(); token.key_base = "B_stop"; token.key_prefix = "--"; token.label = "B-factor higher limit [A]"; token.help = "Higher limit for B-factor estimation. "; token.group = "advanced"; token.is_required = False; token.is_locked = False; token.default = "0.0"; token.restore = "0.0"; token.type = "float"; sxcmd.token_list.append(token)
		token = SXcmd_token(); token.key_base = "nofsc_adj"; token.key_prefix = "--"; token.label = "Do not apply FSC-based low-pass filter"; token.help = "Do not apply an FSC-based low-pass filter (square root of FSC) to the merged volume before the B-factor estimation. "; token.group = "advanced"; token.is_required = False; token.is_locked = False; token.default = False; token.restore = False; token.type = "bool"; sxcmd.token_list.append(token)
