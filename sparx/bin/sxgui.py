...
class SXMainWindow(QMainWindow): # class SXMainWindow(QWidget):
	...
	def construct_sxcmd_category_list(self):
		...
		token = SXcmd_token(); token.key_base = "selection_list"; token.key_prefix = "--"; token.label = "Micrograph selecting list"; token.help = "Specify a name of micrograph selection list text file. The file extension must be '.txt'. If this is not provided, all files matched with the micrograph name pattern will be processed. (This option is specific to SPHIRE, and not directly used by unblur and summovie executables.) "; token.group = "main"; token.is_required = False; token.is_locked = False; token.default = "none"; token.restore = "none"; token.type = "any_micrograph"; sxcmd.token_list.append(token)
		...
		token = SXcmd_token(); token.key_base = "dont_restore_noise"; token.key_prefix = "--"; token.label = "Do not restore noise power"; token.help = "Effective only when expert_mode option is used. "; token.group = "advanced"; token.is_required = False; token.is_locked = False; token.default = False; token.restore = False; token.type = "bool"; sxcmd.token_list.append(token)
		...
		sxcmd = SXcmd(); sxcmd.name = "sxgui_cter"; sxcmd.subname = ""; sxcmd.mode = ""; sxcmd.label = "CTF Assessment"; sxcmd.short_info = "GUI tool to assess and sort micrographs based on their estimated CTF by sxcter."; sxcmd.mpi_support = False; sxcmd.mpi_add_flag = False; sxcmd.category = "sxc_cter"; sxcmd.role = "sxr_pipe"; sxcmd.is_submittable = False
		...
		sxcmd = SXcmd(); sxcmd.name = "e2boxer_old"; sxcmd.subname = ""; sxcmd.mode = ""; sxcmd.label = "Particle Picking"; sxcmd.short_info = "Manual and automatic particle picking."; sxcmd.mpi_support = False; sxcmd.mpi_add_flag = False; sxcmd.category = "sxc_window"; sxcmd.role = "sxr_pipe"; sxcmd.is_submittable = False
		...
		sxcmd = SXcmd(); sxcmd.name = "sxisac"; sxcmd.subname = ""; sxcmd.mode = ""; sxcmd.label = "ISAC - 2D Clustering"; sxcmd.short_info = "Iterative Stable Alignment and Clustering (ISAC) of a 2D image stack."; sxcmd.mpi_support = True; sxcmd.mpi_add_flag = False; sxcmd.category = "sxc_isac"; sxcmd.role = "sxr_pipe"; sxcmd.is_submittable = True
		...
		sxcmd = SXcmd(); sxcmd.name = "sxpipe"; sxcmd.subname = "isac_substack"; sxcmd.mode = ""; sxcmd.label = "Create Stack Subset"; sxcmd.short_info = "Create virtual subset stack consisting from ISAC accounted particles by retrieving particle numbers associated with the class averages. The command also saves a list text file containing the retrieved original image numbers."; sxcmd.mpi_support = False; sxcmd.mpi_add_flag = False; sxcmd.category = "sxc_isac"; sxcmd.role = "sxr_pipe"; sxcmd.is_submittable = True
		...
		token = SXcmd_token(); token.key_base = "no_virtual_stack"; token.key_prefix = "--"; token.label = "Do not create virtual stack"; token.help = "Use this option to create only the particle ID list text file associated with the ISAC class averages. "; token.group = "advanced"; token.is_required = False; token.is_locked = False; token.default = False; token.restore = False; token.type = "bool"; sxcmd.token_list.append(token)

		sxcmd_list.append(sxcmd)

		sxcmd = SXcmd(); sxcmd.name = "sxisac_post_processing"; sxcmd.subname = ""; sxcmd.mode = ""; sxcmd.label = "Beautifier"; sxcmd.short_info = "Beautify the ISAC 2D clustering result with the original pixel size."; sxcmd.mpi_support = True; sxcmd.mpi_add_flag = False; sxcmd.category = "sxc_isac"; sxcmd.role = "sxr_pipe"; sxcmd.is_submittable = True
		...
		sxcmd = SXcmd(); sxcmd.name = "e2proc3d"; sxcmd.subname = ""; sxcmd.mode = "clip"; sxcmd.label = "Pad/Clip VIPER Model"; sxcmd.short_info = "Pad or clip. Pad or clip volume to the specific dimensions. Specify 1, 3 or 6 arguments; '<x>[,<y>,<z>[,<xc>,<yc>,<zc>]]'. "; sxcmd.mpi_support = False; sxcmd.mpi_add_flag = False; sxcmd.category = "sxc_viper"; sxcmd.role = "sxr_pipe"; sxcmd.is_submittable = True
		token = SXcmd_token(); token.key_base = "clip"; token.key_prefix = "--"; token.label = "Pad/Clip volume to specified size [Pixels]"; token.help = "Pad or clip volume to the specific dimensions. Specify 1, 3 or 6 arguments; '<x>[,<y>,<z>[,<xc>,<yc>,<zc>]]'. "; token.group = "main"; token.is_required = True; token.is_locked = False; token.default = ""; token.restore = ""; token.type = "string"; sxcmd.token_list.append(token)
		...
		sxcmd = SXcmd(); sxcmd.name = "sxmeridien"; sxcmd.subname = ""; sxcmd.mode = ""; sxcmd.label = "3D Refinement"; sxcmd.short_info = "Performs 3D structure refinement."; sxcmd.mpi_support = True; sxcmd.mpi_add_flag = False; sxcmd.category = "sxc_meridien"; sxcmd.role = "sxr_pipe"; sxcmd.is_submittable = True
		...
		token = SXcmd_token(); token.key_base = "hardmask"; token.key_prefix = "--"; token.label = "Apply hard 2D mask"; token.help = "Apply hard mask to 2D data with the particle radius. "; token.group = "main"; token.is_required = False; token.is_locked = False; token.default = True; token.restore = True; token.type = "bool"; sxcmd.token_list.append(token)
		...
		token = SXcmd_token(); token.key_base = "delta"; token.key_prefix = "--"; token.label = "Initial angular sampling step"; token.help = "Initial angular sampling step. "; token.group = "main"; token.is_required = False; token.is_locked = False; token.default = "7.5"; token.restore = "7.5"; token.type = "float"; sxcmd.token_list.append(token)
		...
		token = SXcmd_token(); token.key_base = "randomphasesafter"; token.key_prefix = "--"; token.label = "Randomise phases after this FSC"; token.help = "Set Fourier pixels random phases after this FSC value. "; token.group = "main"; token.is_required = False; token.is_locked = False; token.default = "0.8"; token.restore = "0.8"; token.type = "float"; sxcmd.token_list.append(token)
		...
		sxcmd = SXcmd(); sxcmd.name = "sx3dvariability"; sxcmd.subname = ""; sxcmd.mode = "symmetrize"; sxcmd.label = "3D Variability Preprocess"; sxcmd.short_info = "Symmetrise input stack. Please skip this preparation step if the structure is asymmetrical (i.e. c1), since it is required only when the structure has internal symmetry. "; sxcmd.mpi_support = False; sxcmd.mpi_add_flag = False; sxcmd.category = "sxc_sort3d"; sxcmd.role = "sxr_pipe"; sxcmd.is_submittable = True
		...
		sxcmd = SXcmd(); sxcmd.name = "sxsort3d_new"; sxcmd.subname = ""; sxcmd.mode = ""; sxcmd.label = "NEW 3D Clustering - RSORT3D"; sxcmd.short_info = "UNDER DEVELOPMENT. Reproducible 3D Clustering of heterogeneous dataset. Sort out 3D heterogeneity of 2D data whose 3D reconstruction parameters have been determined already."; sxcmd.mpi_support = True; sxcmd.mpi_add_flag = False; sxcmd.category = "sxc_sort3d"; sxcmd.role = "sxr_pipe"; sxcmd.is_submittable = True
		...
		token = SXcmd_token(); token.key_base = "no_final_sharpen"; token.key_prefix = "--"; token.label = "Do not reconstruct final maps"; token.help = "Do not reconstruct unfiltered final maps for post refinement process. "; token.group = "advanced"; token.is_required = False; token.is_locked = False; token.default = False; token.restore = False; token.type = "bool"; sxcmd.token_list.append(token)
		token = SXcmd_token(); token.key_base = "applymask"; token.key_prefix = "--"; token.label = "Apply mask"; token.help = "Apply mask. If not, hard 2D mask is not used as well. "; token.group = "advanced"; token.is_required = False; token.is_locked = False; token.default = False; token.restore = False; token.type = "bool"; sxcmd.token_list.append(token)
		token = SXcmd_token(); token.key_base = "applybckgnoise"; token.key_prefix = "--"; token.label = "Apply background noise"; token.help = "Apply background noise when comaparing raw images with references. "; token.group = "advanced"; token.is_required = False; token.is_locked = False; token.default = False; token.restore = False; token.type = "bool"; sxcmd.token_list.append(token)
		token = SXcmd_token(); token.key_base = "angle_step"; token.key_prefix = "--"; token.label = "Angular sampling step"; token.help = "Sampling anglular step used for EQKmeans orientation constraints. "; token.group = "advanced"; token.is_required = False; token.is_locked = False; token.default = "15.0"; token.restore = "15.0"; token.type = "float"; sxcmd.token_list.append(token)
		token = SXcmd_token(); token.key_base = "tilt1"; token.key_prefix = "--"; token.label = "Lower tilting bound"; token.help = "Lower bound of sampling tilting angle (theta) used for EQKmeans orientation constraints. "; token.group = "advanced"; token.is_required = False; token.is_locked = False; token.default = "0.0"; token.restore = "0.0"; token.type = "float"; sxcmd.token_list.append(token)
		token = SXcmd_token(); token.key_base = "tilt2"; token.key_prefix = "--"; token.label = "Upper tilting bound"; token.help = "Upper bound of sampling tilting angle (theta) used for EQKmeans orientation constraints. "; token.group = "advanced"; token.is_required = False; token.is_locked = False; token.default = "180.0"; token.restore = "180.0"; token.type = "float"; sxcmd.token_list.append(token)
		token = SXcmd_token(); token.key_base = "not_make_normal_maps"; token.key_prefix = "--"; token.label = "Do not make non-sharpen maps"; token.help = "Do not make non-sharpen maps. By default, the regularised maps will be reconstructed. "; token.group = "advanced"; token.is_required = False; token.is_locked = False; token.default = False; token.restore = False; token.type = "bool"; sxcmd.token_list.append(token)
		token = SXcmd_token(); token.key_base = "post_sorting_sharpen"; token.key_prefix = "--"; token.label = "Sharpen maps of each clusters"; token.help = "Make sharpen maps from sorted clusters. "; token.group = "advanced"; token.is_required = False; token.is_locked = False; token.default = False; token.restore = False; token.type = "bool"; sxcmd.token_list.append(token)
		token = SXcmd_token(); token.key_base = "stop_eqkmeans_percentage"; token.key_prefix = "--"; token.label = "Stop EQK-means Percentage [%]"; token.help = "Particle change percentage for stopping Equal-Sized K-means. "; token.group = "advanced"; token.is_required = False; token.is_locked = False; token.default = "2.0"; token.restore = "2.0"; token.type = "float"; sxcmd.token_list.append(token)
		token = SXcmd_token(); token.key_base = "smallest_particle_number"; token.key_prefix = "--"; token.label = "Smallest orientation group size"; token.help = "The smallest orientation group size wich equals number_of_groups multiplied by this number. The value have to be an integer. "; token.group = "advanced"; token.is_required = False; token.is_locked = False; token.default = "20"; token.restore = "20"; token.type = "int"; sxcmd.token_list.append(token)

		sxcmd_list.append(sxcmd)

		sxcmd = SXcmd(); sxcmd.name = "sxmeridien"; sxcmd.subname = ""; sxcmd.mode = "ctrefromsort3d"; sxcmd.label = "Local Subset Refinement"; sxcmd.short_info = "Continue refinement after 3D sorting. Continue local/exhaustive refinement with a data subset generated by a 3D sorting. "; sxcmd.mpi_support = True; sxcmd.mpi_add_flag = False; sxcmd.category = "sxc_sort3d"; sxcmd.role = "sxr_pipe"; sxcmd.is_submittable = True
		token = SXcmd_token(); token.key_base = "ctrefromsort3d"; token.key_prefix = "--"; token.label = "Continue refinement after 3D sorting"; token.help = "Continue local/exhaustive refinement with a data subset generated by a 3D sorting. "; token.group = "main"; token.is_required = True; token.is_locked = True; token.default = True; token.restore = True; token.type = "bool"; sxcmd.token_list.append(token)
		token = SXcmd_token(); token.key_base = "output_directory"; token.key_prefix = ""; token.label = "Output directory"; token.help = "The results will be written here. This directory will be created automatically if it does not exist. "; token.group = "main"; token.is_required = False; token.is_locked = False; token.default = "none"; token.restore = "none"; token.type = "output_continue"; sxcmd.token_list.append(token)
		token = SXcmd_token(); token.key_base = "subset"; token.key_prefix = "--"; token.label = "Subset text file path"; token.help = "A text contains indexes of data subset sorted by a 3D sorting. Typically, use Cluster#.txt created by sxrsort3d (e.g. Cluster1.txt). "; token.group = "main"; token.is_required = False; token.is_locked = False; token.default = "none"; token.restore = "none"; token.type = "parameters"; sxcmd.token_list.append(token)
		token = SXcmd_token(); token.key_base = "oldrefdir"; token.key_prefix = "--"; token.label = "3D refinement directory"; token.help = "The master output directory of a 3D refinement which is used for the input of 3D sorting. "; token.group = "main"; token.is_required = False; token.is_locked = False; token.default = "none"; token.restore = "none"; token.type = "directory"; sxcmd.token_list.append(token)
		token = SXcmd_token(); token.key_base = "ctrefromiter"; token.key_prefix = "--"; token.label = "Restarting iteration"; token.help = "The iteration from which 3D refinement should be continued. "; token.group = "main"; token.is_required = False; token.is_locked = False; token.default = "-1"; token.restore = "-1"; token.type = "int"; sxcmd.token_list.append(token)
		token = SXcmd_token(); token.key_base = "memory_per_node"; token.key_prefix = "--"; token.label = "Memory per node [GB]"; token.help = "User provided information about memory per node in GB (NOT per CPU). By default, it uses 2GB * (number of CPUs per node) "; token.group = "main"; token.is_required = False; token.is_locked = False; token.default = "-1.0"; token.restore = "-1.0"; token.type = "float"; sxcmd.token_list.append(token)
		...
		token = SXcmd_token(); token.key_base = "hardmask"; token.key_prefix = "--"; token.label = "Apply hard 2D mask"; token.help = "Apply hard mask to 2D data with the particle radius. "; token.group = "advanced"; token.is_required = False; token.is_locked = False; token.default = True; token.restore = True; token.type = "bool"; sxcmd.token_list.append(token)
		token = SXcmd_token(); token.key_base = "symmetry"; token.key_prefix = "--"; token.label = "Point-group symmetry"; token.help = "Symmetry of the refined structure. Acceptable values are: cn, dn, where n is multiplicity. "; token.group = "advanced"; token.is_required = False; token.is_locked = False; token.default = "c1"; token.restore = "c1"; token.type = "sym"; sxcmd.token_list.append(token)
		...
		token = SXcmd_token(); token.key_base = "delta"; token.key_prefix = "--"; token.label = "Initial angular sampling step"; token.help = "Initial angular sampling step. "; token.group = "advanced"; token.is_required = False; token.is_locked = False; token.default = "7.5"; token.restore = "7.5"; token.type = "float"; sxcmd.token_list.append(token)
		token = SXcmd_token(); token.key_base = "xr"; token.key_prefix = "--"; token.label = "Search range [Pixels]"; token.help = "Range for translation search in both directions. Search is +/-xr. It can be fractional "; token.group = "advanced"; token.is_required = False; token.is_locked = False; token.default = "5.0"; token.restore = "5.0"; token.type = "float"; sxcmd.token_list.append(token)
		token = SXcmd_token(); token.key_base = "ts"; token.key_prefix = "--"; token.label = "Search step size [Pixels]"; token.help = "Step size of translation search in both directions. Search is within a circle of radius xr on a grid with steps ts. It can be fractional. "; token.group = "advanced"; token.is_required = False; token.is_locked = False; token.default = "1.0"; token.restore = "1.0"; token.type = "float"; sxcmd.token_list.append(token)
		token = SXcmd_token(); token.key_base = "shake"; token.key_prefix = "--"; token.label = "Shake"; token.help = "Shake "; token.group = "advanced"; token.is_required = False; token.is_locked = False; token.default = "0.5"; token.restore = "0.5"; token.type = "float"; sxcmd.token_list.append(token)
		token = SXcmd_token(); token.key_base = "small_memory"; token.key_prefix = "--"; token.label = "Do not keep data in memory"; token.help = "Data will not be kept in memory if small_memory is true "; token.group = "advanced"; token.is_required = False; token.is_locked = False; token.default = False; token.restore = False; token.type = "bool"; sxcmd.token_list.append(token)
		...
		sxcmd = SXcmd(); sxcmd.name = "sxrsort3d"; sxcmd.subname = ""; sxcmd.mode = ""; sxcmd.label = "OLD 3D Clustering - RSORT3D"; sxcmd.short_info = "Reproducible 3D Clustering of heterogeneous dataset. Sort out 3D heterogeneity of 2D data whose 3D reconstruction parameters have been determined already."; sxcmd.mpi_support = True; sxcmd.mpi_add_flag = False; sxcmd.category = "sxc_sort3d"; sxcmd.role = "sxr_alt"; sxcmd.is_submittable = True
		token = SXcmd_token(); token.key_base = "refinement_method"; token.key_prefix = "--"; token.label = "Input 3D refinement method"; token.help = "Valid values are 'SPARX' and 'relion'. Currently, SHPIRE GUI (sxgui) supports only 'SPARX'. "; token.group = "main"; token.is_required = True; token.is_locked = True; token.default = ""; token.restore = "SPARX"; token.type = "string"; sxcmd.token_list.append(token)
		token = SXcmd_token(); token.key_base = "refinement_dir"; token.key_prefix = "--"; token.label = "Input 3D refinement directory"; token.help = "Usually the master output directory of sxmeridien. "; token.group = "main"; token.is_required = True; token.is_locked = False; token.default = ""; token.restore = ""; token.type = "directory"; sxcmd.token_list.append(token)
		token = SXcmd_token(); token.key_base = "masterdir"; token.key_prefix = "--"; token.label = "Output directory"; token.help = "The master output directory for sorting. "; token.group = "main"; token.is_required = True; token.is_locked = False; token.default = ""; token.restore = ""; token.type = "output"; sxcmd.token_list.append(token)
		token = SXcmd_token(); token.key_base = "niter_for_sorting"; token.key_prefix = "--"; token.label = "3D refinement iteration"; token.help = "Specify an iteration number of 3D refinement where the 3D alignment parameters should be extracted for this sorting. By default, it uses iteration achieved best resolution. "; token.group = "main"; token.is_required = False; token.is_locked = False; token.default = "-1"; token.restore = "-1"; token.type = "int"; sxcmd.token_list.append(token)
