...
class Popupmrefthreedali(QWidget):
	...
	self.setWindowTitle('sxmref_ali3d')
        #Here we just set a label and its position in the window
	title1=QtGui.QLabel('<b>sxmref_ali3d</b> -  perform 3-D multireference projection matching given initial reference volumes and image series', self)
	title1.move(self.x1,self.y1)
	self.y1 += 30
