...
###		sxinfo = SXmenu_item(); sxinfo.name = "GUI Information"; sxinfo.label = "GUI Appliation Information"; sxinfo.short_info = "DUMMY STRING"
	...
	def construct_sxcmd_category_list(self):
		...
		token = SXcmd_token(); token.key_base = "dilation"; token.key_prefix = "--"; token.label = "Dilation width [Pixels]"; token.help = "The pixel width to dilate the 3D binary map corresponding to the specified molecular mass or density threshold prior to softening the edge. By default, it is set to half of --moon_distance so that the voxels with 1.0 values in the mask are same as the hard-edged molecular-mass binary map. "; token.group = "main"; token.is_required = False; token.is_locked = False; token.is_reversed = False; token.dependency_group = ['', '', '']; token.default = "-1.0"; token.restore = "-1.0"; token.type = "float"; sxcmd.token_list.append(token); sxcmd.token_dict[token.key_base] = token
		token = SXcmd_token(); token.key_base = "edge_sigma"; token.key_prefix = "--"; token.label = "Edge sigma [Pixels]"; token.help = "The Gaussian sigma of transition area for soft-edge of the moon eliminator 3D mask. This value controls the falloff speed of soft-edge; The samller the sigma, the faster the falloff. Effective only with --edge_type='gauss'. "; token.group = "main"; token.is_required = False; token.is_locked = False; token.is_reversed = False; token.dependency_group = ['', '', '']; token.default = "1.0"; token.restore = "1.0"; token.type = "float"; sxcmd.token_list.append(token); sxcmd.token_dict[token.key_base] = token
		...
		token = SXcmd_token(); token.key_base = "resampled_shift3d"; token.key_prefix = "--"; token.label = "Providing resampled 3D shifts"; token.help = "Use this option when you are providing the resampled 3D shifts (using pixel size of outputs) when --resample_ratio!=1.0. By default, the program assums the provided shifts are not resampled. "; token.group = "main"; token.is_required = False; token.is_locked = False; token.is_reversed = False; token.dependency_group = ['', '', '']; token.default = False; token.restore = False; token.type = "bool"; sxcmd.token_list.append(token); sxcmd.token_dict[token.key_base] = token
		token = SXcmd_token(); token.key_base = "shift3d_x"; token.key_prefix = "--"; token.label = "3D x-shift [Pixels]"; token.help = "3D x-shift value. "; token.group = "main"; token.is_required = False; token.is_locked = False; token.is_reversed = False; token.dependency_group = ['', '', '']; token.default = "0"; token.restore = "0"; token.type = "int"; sxcmd.token_list.append(token); sxcmd.token_dict[token.key_base] = token
		token = SXcmd_token(); token.key_base = "shift3d_y"; token.key_prefix = "--"; token.label = "3D y-shift [Pixels]"; token.help = "3D y-shift value. "; token.group = "main"; token.is_required = False; token.is_locked = False; token.is_reversed = False; token.dependency_group = ['', '', '']; token.default = "0"; token.restore = "0"; token.type = "int"; sxcmd.token_list.append(token); sxcmd.token_dict[token.key_base] = token
		token = SXcmd_token(); token.key_base = "shift3d_z"; token.key_prefix = "--"; token.label = "3D z-shift [Pixels]"; token.help = "3D z-shift value. "; token.group = "main"; token.is_required = False; token.is_locked = False; token.is_reversed = False; token.dependency_group = ['', '', '']; token.default = "0"; token.restore = "0"; token.type = "int"; sxcmd.token_list.append(token); sxcmd.token_dict[token.key_base] = token
		...
		token = SXcmd_token(); token.key_base = "aa"; token.key_prefix = "--"; token.label = "Low-pass filter fall-off [1/Pixels]"; token.help = "Low-pass filter fall-off in absolute frequency. The program applies this low-pass filter before the moon elimination. Effective only when --fl &gt; 0.0. "; token.group = "main"; token.is_required = False; token.is_locked = False; token.is_reversed = False; token.dependency_group = ['', '', '']; token.default = "0.1"; token.restore = "0.1"; token.type = "float"; sxcmd.token_list.append(token); sxcmd.token_dict[token.key_base] = token
		token = SXcmd_token(); token.key_base = "generate_mask"; token.key_prefix = "--"; token.label = "Generate soft-edged mask"; token.help = "Generate soft-edged mask with specified method from the 3D binary map corresponding to the specified molecular mass or density threshold, using the values provided through --gm_* options. Available methods are (1) 'gauss' for gaussian soft-edge and (2) 'cosine' for cosine soft-edged (used in PostRefiner). "; token.group = "main"; token.is_required = False; token.is_locked = False; token.is_reversed = False; token.dependency_group = ['', '', '']; token.default = False; token.restore = False; token.type = "bool"; sxcmd.token_list.append(token); sxcmd.token_dict[token.key_base] = token
		token = SXcmd_token(); token.key_base = "gm_dilation"; token.key_prefix = "--"; token.label = "Soft-edge dilation [Pixels]"; token.help = "The pixel width to dilate the 3D binary map corresponding to the specified molecular mass or density threshold prior to softening the edge. By default, it is set to half of --gm_edge_width so that the voxels with 1.0 values in the mask are same as the hard-edged binary map with the threadhold. Effective only with --enerate_mask option. "; token.group = "advanced"; token.is_required = False; token.is_locked = False; token.is_reversed = False; token.dependency_group = ['generate_mask', 'True', 'False']; token.default = "-1.0"; token.restore = "-1.0"; token.type = "float"; sxcmd.token_list.append(token); sxcmd.token_dict[token.key_base] = token; sxcmd.dependency_dict.setdefault('generate_mask', []).append([token.key_base, 'True', 'False'])
		token = SXcmd_token(); token.key_base = "gm_edge_width"; token.key_prefix = "--"; token.label = "Soft-edge width [Pixels]"; token.help = "The pixel width of transition area for soft-edged masking. Effective only with --generate_mask option. "; token.group = "advanced"; token.is_required = False; token.is_locked = False; token.is_reversed = False; token.dependency_group = ['generate_mask', 'True', 'False']; token.default = "6.0"; token.restore = "6.0"; token.type = "float"; sxcmd.token_list.append(token); sxcmd.token_dict[token.key_base] = token; sxcmd.dependency_dict.setdefault('generate_mask', []).append([token.key_base, 'True', 'False'])
		token = SXcmd_token(); token.key_base = "gm_edge_sigma"; token.key_prefix = "--"; token.label = "Soft-edge sigma [Pixels]"; token.help = "The Gaussian sigma of transition area for soft-edged masking. This value controls the fall-speed of soft-edge; The samller the sigma, the faster the falloff. Effective only with --generate_mask and --generate_mask='gauss'. "; token.group = "advanced"; token.is_required = False; token.is_locked = False; token.is_reversed = False; token.dependency_group = ['generate_mask', 'True', 'False']; token.default = "2.0"; token.restore = "2.0"; token.type = "float"; sxcmd.token_list.append(token); sxcmd.token_dict[token.key_base] = token; sxcmd.dependency_dict.setdefault('generate_mask', []).append([token.key_base, 'True', 'False'])
		...
		token = SXcmd_token(); token.key_base = "allow_disconnect"; token.key_prefix = "--"; token.label = "Allow disconnection"; token.help = "Allow disconnection of density maps. Only for very special cases. "; token.group = "advanced"; token.is_required = False; token.is_locked = False; token.is_reversed = False; token.dependency_group = ['', '', '']; token.default = False; token.restore = False; token.type = "bool"; sxcmd.token_list.append(token); sxcmd.token_dict[token.key_base] = token
		token = SXcmd_token(); token.key_base = "edge_type"; token.key_prefix = "--"; token.label = "Soft-edge type"; token.help = "The type of soft-edge for moon-eliminator 3D mask and a moon-eliminated soft-edged 3D mask. Available methods are (1) 'cosine' for cosine soft-edged (used in PostRefiner) and (2) 'gauss' for gaussian soft-edge. "; token.group = "advanced"; token.is_required = False; token.is_locked = False; token.is_reversed = False; token.dependency_group = ['generate_mask', 'True', 'False']; token.default = "cosine"; token.restore = "cosine"; token.type = "string"; sxcmd.token_list.append(token); sxcmd.token_dict[token.key_base] = token; sxcmd.dependency_dict.setdefault('generate_mask', []).append([token.key_base, 'True', 'False'])
		...
		token = SXcmd_token(); token.key_base = "input_volume"; token.key_prefix = ""; token.label = "Input volume"; token.help = "Input reference volume"; token.group = "main"; token.is_required = True; token.is_locked = False; token.is_reversed = False; token.dependency_group = ['', '', '']; token.default = ""; token.restore = ""; token.type = "data3d_one"; sxcmd.token_list.append(token); sxcmd.token_dict[token.key_base] = token
		token = SXcmd_token(); token.key_base = "output_mask3D"; token.key_prefix = ""; token.label = "Output mask"; token.help = "Output 3D mask"; token.group = "main"; token.is_required = True; token.is_locked = False; token.is_reversed = False; token.dependency_group = ['', '', '']; token.default = ""; token.restore = ""; token.type = "output"; sxcmd.token_list.append(token); sxcmd.token_dict[token.key_base] = token
		token = SXcmd_token(); token.key_base = "nsigma"; token.key_prefix = "--"; token.label = "Density standard deviation threshold"; token.help = "Defines the threshold used in the first step of the processing to generate a binary version of the structure. The threshold is set to &lt;= mean + (nsigma x standard deviations). This option will not be used if the option threshold is larger than -9999.0. "; token.group = "main"; token.is_required = False; token.is_locked = False; token.is_reversed = False; token.dependency_group = ['', '', '']; token.default = "1.0"; token.restore = "1.0"; token.type = "float"; sxcmd.token_list.append(token); sxcmd.token_dict[token.key_base] = token
		token = SXcmd_token(); token.key_base = "threshold"; token.key_prefix = "--"; token.label = "Binarization threshold"; token.help = "Defines the threshold used in the first step of the processing to generate a binary version of the input structure. If the value is lower-equal than the default, the option will be ignored and the threshold will be set according to nsigma method above. "; token.group = "main"; token.is_required = False; token.is_locked = False; token.is_reversed = False; token.dependency_group = ['', '', '']; token.default = "-9999.0"; token.restore = "-9999.0"; token.type = "float"; sxcmd.token_list.append(token); sxcmd.token_dict[token.key_base] = token
		token = SXcmd_token(); token.key_base = "ndilation"; token.key_prefix = "--"; token.label = "Mask extension cycles"; token.help = "The initial mask will be dilated (extended) the number of cycles. "; token.group = "main"; token.is_required = False; token.is_locked = False; token.is_reversed = False; token.dependency_group = ['', '', '']; token.default = "3"; token.restore = "3"; token.type = "int"; sxcmd.token_list.append(token); sxcmd.token_dict[token.key_base] = token
		token = SXcmd_token(); token.key_base = "kernel_size"; token.key_prefix = "--"; token.label = "Gaussian kernel size [Pixels]"; token.help = "Size of the Gaussian kernel used for intermediate processing. "; token.group = "main"; token.is_required = False; token.is_locked = False; token.is_reversed = False; token.dependency_group = ['', '', '']; token.default = "11"; token.restore = "11"; token.type = "int"; sxcmd.token_list.append(token); sxcmd.token_dict[token.key_base] = token
		token = SXcmd_token(); token.key_base = "gauss_standard_dev"; token.key_prefix = "--"; token.label = "Kernel standard deviation [Pixels]"; token.help = "Standard deviation of the Gaussian smoothing used to produce smooth edge. "; token.group = "main"; token.is_required = False; token.is_locked = False; token.is_reversed = False; token.dependency_group = ['', '', '']; token.default = "9"; token.restore = "9"; token.type = "int"; sxcmd.token_list.append(token); sxcmd.token_dict[token.key_base] = token
		...
		token = SXcmd_token(); token.key_base = "mask_threshold"; token.key_prefix = "--"; token.label = "Adaptive mask threshold"; token.help = "Density threshold for creating adaptive surface mask. Effective only with --do_adaptive_mask option. "; token.group = "main"; token.is_required = False; token.is_locked = False; token.is_reversed = False; token.dependency_group = ['do_adaptive_mask', 'True', 'False']; token.default = "0.02"; token.restore = "0.02"; token.type = "float"; sxcmd.token_list.append(token); sxcmd.token_dict[token.key_base] = token; sxcmd.dependency_dict.setdefault('do_adaptive_mask', []).append([token.key_base, 'True', 'False'])
		token = SXcmd_token(); token.key_base = "cosine_edge"; token.key_prefix = "--"; token.label = "Cosine edge width [Pixels]"; token.help = "Width of cosine transition area for soft-edge masking. Effective only with --do_adaptive_mask option. "; token.group = "main"; token.is_required = False; token.is_locked = False; token.is_reversed = False; token.dependency_group = ['do_adaptive_mask', 'True', 'False']; token.default = "6.0"; token.restore = "6.0"; token.type = "float"; sxcmd.token_list.append(token); sxcmd.token_dict[token.key_base] = token; sxcmd.dependency_dict.setdefault('do_adaptive_mask', []).append([token.key_base, 'True', 'False'])
		...
		sxcmd = SXcmd(); sxcmd.name = "sxsort3d"; sxcmd.subname = ""; sxcmd.mode = ""; sxcmd.subset_config = ""; sxcmd.label = "3D Clustering - SORT3D"; sxcmd.short_info = "Sort 3D heterogeneity based on the reproducible members of K-means and Equal K-means classification. It runs after 3D refinement where the alignment parameters are determined."; sxcmd.mpi_support = True; sxcmd.mpi_add_flag = False; sxcmd.category = "sxc_sort3d"; sxcmd.role = "sxr_alt"; sxcmd.is_submittable = True
		token = SXcmd_token(); token.key_base = "stack"; token.key_prefix = ""; token.label = "Input images stack"; token.help = ""; token.group = "main"; token.is_required = True; token.is_locked = False; token.is_reversed = False; token.dependency_group = ['', '', '']; token.default = ""; token.restore = ""; token.type = "bdb2d_stack"; sxcmd.token_list.append(token); sxcmd.token_dict[token.key_base] = token
		...
		token = SXcmd_token(); token.key_base = "mask"; token.key_prefix = ""; token.label = "3D mask"; token.help = "File path of the global 3D mask for clustering. "; token.group = "main"; token.is_required = False; token.is_locked = False; token.is_reversed = False; token.dependency_group = ['', '', '']; token.default = "none"; token.restore = "none"; token.type = "data3d_one"; sxcmd.token_list.append(token); sxcmd.token_dict[token.key_base] = token
		token = SXcmd_token(); token.key_base = "focus"; token.key_prefix = "--"; token.label = "Binary Focus 3D mask"; token.help = "Binary 3D mask used for focused clustering. "; token.group = "main"; token.is_required = False; token.is_locked = False; token.is_reversed = False; token.dependency_group = ['', '', '']; token.default = "none"; token.restore = "none"; token.type = "data3d_one"; sxcmd.token_list.append(token); sxcmd.token_dict[token.key_base] = token
		token = SXcmd_token(); token.key_base = "radius"; token.key_prefix = "--"; token.label = "Particle radius [Pixels]"; token.help = "Used as outer radius for rotational correlation.  Must be smaller than half the box size. "; token.group = "main"; token.is_required = False; token.is_locked = False; token.is_reversed = False; token.dependency_group = ['', '', '']; token.default = "-1"; token.restore = "-1"; token.type = "radius"; sxcmd.token_list.append(token); sxcmd.token_dict[token.key_base] = token
		token = SXcmd_token(); token.key_base = "delta"; token.key_prefix = "--"; token.label = "Angular step for projections [Degrees]"; token.help = "Angular step of reference projections. "; token.group = "main"; token.is_required = False; token.is_locked = False; token.is_reversed = False; token.dependency_group = ['', '', '']; token.default = "'2'"; token.restore = "'2'"; token.type = "string"; sxcmd.token_list.append(token); sxcmd.token_dict[token.key_base] = token
		token = SXcmd_token(); token.key_base = "CTF"; token.key_prefix = "--"; token.label = "Use CTF"; token.help = "Do a full CTF correction during the alignment. "; token.group = "main"; token.is_required = False; token.is_locked = False; token.is_reversed = False; token.dependency_group = ['', '', '']; token.default = False; token.restore = False; token.type = "bool"; sxcmd.token_list.append(token); sxcmd.token_dict[token.key_base] = token
		token = SXcmd_token(); token.key_base = "sym"; token.key_prefix = "--"; token.label = "Point-group symmetry"; token.help = "Point-group symmetry of the target structure. "; token.group = "main"; token.is_required = False; token.is_locked = False; token.is_reversed = False; token.dependency_group = ['', '', '']; token.default = "c1"; token.restore = "c1"; token.type = "sym"; sxcmd.token_list.append(token); sxcmd.token_dict[token.key_base] = token
		token = SXcmd_token(); token.key_base = "number_of_images_per_group"; token.key_prefix = "--"; token.label = "Images per group"; token.help = "Critical value defined by user. It suggests program the number of groups. "; token.group = "main"; token.is_required = False; token.is_locked = False; token.is_reversed = False; token.dependency_group = ['', '', '']; token.default = "1000"; token.restore = "1000"; token.type = "int"; sxcmd.token_list.append(token); sxcmd.token_dict[token.key_base] = token
		token = SXcmd_token(); token.key_base = "nxinit"; token.key_prefix = "--"; token.label = "Initial image size for sorting"; token.help = "Initial image size for sorting. "; token.group = "main"; token.is_required = False; token.is_locked = False; token.is_reversed = False; token.dependency_group = ['', '', '']; token.default = "64"; token.restore = "64"; token.type = "int"; sxcmd.token_list.append(token); sxcmd.token_dict[token.key_base] = token
		token = SXcmd_token(); token.key_base = "smallest_group"; token.key_prefix = "--"; token.label = "Smallest group size"; token.help = "Minimum members for identified group. "; token.group = "main"; token.is_required = False; token.is_locked = False; token.is_reversed = False; token.dependency_group = ['', '', '']; token.default = "500"; token.restore = "500"; token.type = "int"; sxcmd.token_list.append(token); sxcmd.token_dict[token.key_base] = token
		token = SXcmd_token(); token.key_base = "chunk0"; token.key_prefix = "--"; token.label = "Chunk file name for 1st halfset"; token.help = "Name of chunk file containing particle IDs of 1st halfset (chunk0) for computing margin of error. "; token.group = "main"; token.is_required = False; token.is_locked = False; token.is_reversed = False; token.dependency_group = ['', '', '']; token.default = "none"; token.restore = "none"; token.type = "select_data2d_stack"; sxcmd.token_list.append(token); sxcmd.token_dict[token.key_base] = token
		token = SXcmd_token(); token.key_base = "chunk1"; token.key_prefix = "--"; token.label = "Chunk file name for 2nd halfset"; token.help = "Name of chunk file containing particle IDs of 2nd halfset (chunk1) for computing margin of error. "; token.group = "main"; token.is_required = False; token.is_locked = False; token.is_reversed = False; token.dependency_group = ['', '', '']; token.default = "none"; token.restore = "none"; token.type = "select_data2d_stack"; sxcmd.token_list.append(token); sxcmd.token_dict[token.key_base] = token
		token = SXcmd_token(); token.key_base = "ir"; token.key_prefix = "--"; token.label = "Inner radius for rotational correlation [Pixels]"; token.help = "Must be bigger than 1. "; token.group = "advanced"; token.is_required = False; token.is_locked = False; token.is_reversed = False; token.dependency_group = ['', '', '']; token.default = "1"; token.restore = "1"; token.type = "int"; sxcmd.token_list.append(token); sxcmd.token_dict[token.key_base] = token
		token = SXcmd_token(); token.key_base = "maxit"; token.key_prefix = "--"; token.label = "Maximum iterations"; token.help = "Maximum number of iteration. "; token.group = "advanced"; token.is_required = False; token.is_locked = False; token.is_reversed = False; token.dependency_group = ['', '', '']; token.default = "25"; token.restore = "25"; token.type = "int"; sxcmd.token_list.append(token); sxcmd.token_dict[token.key_base] = token
		token = SXcmd_token(); token.key_base = "rs"; token.key_prefix = "--"; token.label = "Step between rings in rotational correlation"; token.help = "Must be bigger than 0. "; token.group = "advanced"; token.is_required = False; token.is_locked = False; token.is_reversed = False; token.dependency_group = ['', '', '']; token.default = "1"; token.restore = "1"; token.type = "int"; sxcmd.token_list.append(token); sxcmd.token_dict[token.key_base] = token
		token = SXcmd_token(); token.key_base = "xr"; token.key_prefix = "--"; token.label = "X search range [Pixels]"; token.help = "The translational search range in the x direction will take place in -xr to +xr range. "; token.group = "advanced"; token.is_required = False; token.is_locked = False; token.is_reversed = False; token.dependency_group = ['', '', '']; token.default = "'1'"; token.restore = "'1'"; token.type = "string"; sxcmd.token_list.append(token); sxcmd.token_dict[token.key_base] = token
		token = SXcmd_token(); token.key_base = "yr"; token.key_prefix = "--"; token.label = "Y search range [Pixels]"; token.help = "The translational search range in the y direction will take place in -yr to +yr range.. If omitted, it will be set as xr. "; token.group = "advanced"; token.is_required = False; token.is_locked = False; token.is_reversed = False; token.dependency_group = ['', '', '']; token.default = "'-1'"; token.restore = "'-1'"; token.type = "string"; sxcmd.token_list.append(token); sxcmd.token_dict[token.key_base] = token
		token = SXcmd_token(); token.key_base = "ts"; token.key_prefix = "--"; token.label = "Translational search step [Pixels]"; token.help = "The search will be performed in -xr, -xr+ts, 0, xr-ts, xr, can be fractional. "; token.group = "advanced"; token.is_required = False; token.is_locked = False; token.is_reversed = False; token.dependency_group = ['', '', '']; token.default = "'0.25'"; token.restore = "'0.25'"; token.type = "string"; sxcmd.token_list.append(token); sxcmd.token_dict[token.key_base] = token
		...
		token = SXcmd_token(); token.key_base = "nassign"; token.key_prefix = "--"; token.label = "Number of reassignment iterations"; token.help = "Performed for each angular step. "; token.group = "advanced"; token.is_required = False; token.is_locked = False; token.is_reversed = False; token.dependency_group = ['', '', '']; token.default = "1"; token.restore = "1"; token.type = "int"; sxcmd.token_list.append(token); sxcmd.token_dict[token.key_base] = token
		token = SXcmd_token(); token.key_base = "nrefine"; token.key_prefix = "--"; token.label = "Number of alignment iterations"; token.help = "Performed for each angular step. "; token.group = "advanced"; token.is_required = False; token.is_locked = False; token.is_reversed = False; token.dependency_group = ['', '', '']; token.default = "0"; token.restore = "0"; token.type = "int"; sxcmd.token_list.append(token); sxcmd.token_dict[token.key_base] = token
		...
		token = SXcmd_token(); token.key_base = "function"; token.key_prefix = "--"; token.label = "Reference preparation function"; token.help = "Specify name of function used to prepare the reference volume. "; token.group = "advanced"; token.is_required = False; token.is_locked = False; token.is_reversed = False; token.dependency_group = ['', '', '']; token.default = "do_volume_mrk05"; token.restore = "do_volume_mrk05"; token.type = "user_func"; sxcmd.token_list.append(token); sxcmd.token_dict[token.key_base] = token
		token = SXcmd_token(); token.key_base = "independent"; token.key_prefix = "--"; token.label = "Number of independent runs"; token.help = "Number of independent equal-Kmeans. "; token.group = "advanced"; token.is_required = False; token.is_locked = False; token.is_reversed = False; token.dependency_group = ['', '', '']; token.default = "3"; token.restore = "3"; token.type = "int"; sxcmd.token_list.append(token); sxcmd.token_dict[token.key_base] = token
		...
		token = SXcmd_token(); token.key_base = "unaccounted"; token.key_prefix = "--"; token.label = "Reconstruct unaccounted images"; token.help = "Reconstruct unaccounted images. "; token.group = "advanced"; token.is_required = False; token.is_locked = False; token.is_reversed = False; token.dependency_group = ['', '', '']; token.default = False; token.restore = False; token.type = "bool"; sxcmd.token_list.append(token); sxcmd.token_dict[token.key_base] = token
		token = SXcmd_token(); token.key_base = "PWadjustment"; token.key_prefix = "--"; token.label = "Power spectrum reference"; token.help = "Text file containing a 1D reference power spectrum used for EM density map power spectrum correction. Typically, compute 1D power spectrum from PDB file. "; token.group = "advanced"; token.is_required = False; token.is_locked = False; token.is_reversed = False; token.dependency_group = ['', '', '']; token.default = "none"; token.restore = "none"; token.type = "spectrum1d"; sxcmd.token_list.append(token); sxcmd.token_dict[token.key_base] = token
		token = SXcmd_token(); token.key_base = "protein_shape"; token.key_prefix = "--"; token.label = "Protein Shape"; token.help = "It defines protein preferred orientation angles. 'g' is for globular proteins and 'f' is for filament proteins. "; token.group = "advanced"; token.is_required = False; token.is_locked = False; token.is_reversed = False; token.dependency_group = ['', '', '']; token.default = "'g'"; token.restore = "'g'"; token.type = "string"; sxcmd.token_list.append(token); sxcmd.token_dict[token.key_base] = token
		...
		token = SXcmd_token(); token.key_base = "wn"; token.key_prefix = "--"; token.label = "Target image size [Pixels]"; token.help = "Specify optimal window size for data processing. If different than 0, then the images will be rescaled to fit this size. "; token.group = "advanced"; token.is_required = False; token.is_locked = False; token.is_reversed = False; token.dependency_group = ['', '', '']; token.default = "0"; token.restore = "0"; token.type = "int"; sxcmd.token_list.append(token); sxcmd.token_dict[token.key_base] = token
		token = SXcmd_token(); token.key_base = "interpolation"; token.key_prefix = "--"; token.label = "3D interpolation method"; token.help = "Method interpolation in 3D. Options are tr1 or 4nn. "; token.group = "advanced"; token.is_required = False; token.is_locked = False; token.is_reversed = False; token.dependency_group = ['', '', '']; token.default = "'4nn'"; token.restore = "'4nn'"; token.type = "string"; sxcmd.token_list.append(token); sxcmd.token_dict[token.key_base] = token
		...
		sxcmd = SXcmd(); sxcmd.name = "sxprocess"; sxcmd.subname = ""; sxcmd.mode = "binary_mask"; sxcmd.subset_config = ""; sxcmd.label = "Binary 3D Mask"; sxcmd.short_info = "Create binary 3D mask from the input structure. "; sxcmd.mpi_support = False; sxcmd.mpi_add_flag = False; sxcmd.category = "sxc_sort3d"; sxcmd.role = "sxr_util"; sxcmd.is_submittable = True
		token = SXcmd_token(); token.key_base = "binary_mask"; token.key_prefix = "--"; token.label = "Create binary 3D mask"; token.help = "Create binary 3D mask from the input structure. "; token.group = "main"; token.is_required = True; token.is_locked = True; token.is_reversed = False; token.dependency_group = ['', '', '']; token.default = True; token.restore = True; token.type = "bool"; sxcmd.token_list.append(token); sxcmd.token_dict[token.key_base] = token
		token = SXcmd_token(); token.key_base = "input_volume"; token.key_prefix = ""; token.label = "Input volume"; token.help = "Input reference volume"; token.group = "main"; token.is_required = True; token.is_locked = False; token.is_reversed = False; token.dependency_group = ['', '', '']; token.default = ""; token.restore = ""; token.type = "data3d_one"; sxcmd.token_list.append(token); sxcmd.token_dict[token.key_base] = token
		token = SXcmd_token(); token.key_base = "output_mask3D"; token.key_prefix = ""; token.label = "Output mask"; token.help = "Output 3D mask"; token.group = "main"; token.is_required = True; token.is_locked = False; token.is_reversed = False; token.dependency_group = ['', '', '']; token.default = ""; token.restore = ""; token.type = "output"; sxcmd.token_list.append(token); sxcmd.token_dict[token.key_base] = token
		token = SXcmd_token(); token.key_base = "bin_threshold"; token.key_prefix = "--"; token.label = "Binarization threshold"; token.help = "Defines the threshold used in the first step of the processing to generate a binary version of the input structure. "; token.group = "main"; token.is_required = False; token.is_locked = False; token.is_reversed = False; token.dependency_group = ['', '', '']; token.default = "0.0"; token.restore = "0.0"; token.type = "float"; sxcmd.token_list.append(token); sxcmd.token_dict[token.key_base] = token
		token = SXcmd_token(); token.key_base = "ne"; token.key_prefix = "--"; token.label = "Erosion cycles"; token.help = "After initial binarization the structure is eroded to remove fragmented pieces of the map. "; token.group = "main"; token.is_required = False; token.is_locked = False; token.is_reversed = False; token.dependency_group = ['', '', '']; token.default = "0"; token.restore = "0"; token.type = "int"; sxcmd.token_list.append(token); sxcmd.token_dict[token.key_base] = token
		token = SXcmd_token(); token.key_base = "nd"; token.key_prefix = "--"; token.label = "Dilation cycles"; token.help = "After erosing the binary structure is dilated back to smooth the surface and match the original size. "; token.group = "main"; token.is_required = False; token.is_locked = False; token.is_reversed = False; token.dependency_group = ['', '', '']; token.default = "0"; token.restore = "0"; token.type = "int"; sxcmd.token_list.append(token); sxcmd.token_dict[token.key_base] = token
