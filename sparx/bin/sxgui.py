...
###		sxinfo = SXmenu_item(); sxinfo.name = "GUI Information"; sxinfo.label = "GUI Appliation Information"; sxinfo.short_info = "DUMMY STRING"
	...
	def construct_sxcmd_category_list(self):
		...
		token = SXcmd_token(); token.key_base = "pws"; token.key_prefix = "--"; token.label = "Skip calculation of 2D power spectra"; token.help = "Will write periodograms to disk. "; token.group = "advanced"; token.is_required = False; token.is_locked = False; token.is_reversed = False; token.dependency_group = [['', '', '']]; token.default = True; token.restore = True; token.type = "bool"; sxcmd.token_list.append(token); sxcmd.token_dict[token.key_base] = token

		sxcmd_list.append(sxcmd)

		sxcmd = SXcmd(); sxcmd.name = "sxgui_cter"; sxcmd.subname = ""; sxcmd.mode = ""; sxcmd.subset_config = ""; sxcmd.label = "CTF Assessment"; sxcmd.short_info = "GUI tool to assess and sort micrographs according to their CTF parameters estimated by sxcter."; sxcmd.mpi_support = False; sxcmd.mpi_add_flag = False; sxcmd.category = "sxc_cter"; sxcmd.role = "sxr_pipe"; sxcmd.is_submittable = False
		token = SXcmd_token(); token.key_base = "cter_ctf_file"; token.key_prefix = ""; token.label = "File containing CTF parameters"; token.help = "This file is produced by sxcter and normally called partres.txt. "; token.group = "main"; token.is_required = False; token.is_locked = False; token.is_reversed = False; token.dependency_group = [['', '', '']]; token.default = "none"; token.restore = "none"; token.type = "params_cter_txt"; sxcmd.token_list.append(token); sxcmd.token_dict[token.key_base] = token

		sxcmd_list.append(sxcmd)

		sxcmd = SXcmd(); sxcmd.name = "sxpipe"; sxcmd.subname = "resample_micrographs"; sxcmd.mode = ""; sxcmd.subset_config = ""; sxcmd.label = "Resample Micrographs"; sxcmd.short_info = "Resample micrographs in input directory specified by input micrograph pattern with user-specified ratio. This operation changes the image dimensitions and the pixel size. Mainly, it is designed to reduce the demensions and pixel size of micrographs taken with the super resolution mode of the K2 direct electron detector."; sxcmd.mpi_support = True; sxcmd.mpi_add_flag = False; sxcmd.category = "sxc_cter"; sxcmd.role = "sxr_alt"; sxcmd.is_submittable = True
		...
		sxcmd = SXcmd(); sxcmd.name = "sxpipe"; sxcmd.subname = "organize_micrographs"; sxcmd.mode = ""; sxcmd.subset_config = ""; sxcmd.label = "Organize Micrographs/Movies"; sxcmd.short_info = "Organize micrographs/movies by moving micrographs/movies listed in a selecting file from a source directory (specified by source micrographs/movies pattern) to a destination directory."; sxcmd.mpi_support = False; sxcmd.mpi_add_flag = False; sxcmd.category = "sxc_cter"; sxcmd.role = "sxr_util"; sxcmd.is_submittable = True
		...
		sxcmd = SXcmd(); sxcmd.name = "sxctf_refine"; sxcmd.subname = "meridien"; sxcmd.mode = ""; sxcmd.subset_config = ""; sxcmd.label = "CTF refine"; sxcmd.short_info = "Refine the defocus per particle"; sxcmd.mpi_support = False; sxcmd.mpi_add_flag = False; sxcmd.category = "sxc_cter"; sxcmd.role = "sxr_util"; sxcmd.is_submittable = True
		token = SXcmd_token(); token.key_base = "path_to_input_stack"; token.key_prefix = ""; token.label = "Input stack path"; token.help = "Path to input stack. "; token.group = "main"; token.is_required = False; token.is_locked = False; token.is_reversed = False; token.dependency_group = [['', '', '']]; token.default = "none"; token.restore = "none"; token.type = "bdb2d_stack"; sxcmd.token_list.append(token); sxcmd.token_dict[token.key_base] = token
		token = SXcmd_token(); token.key_base = "output_directory"; token.key_prefix = ""; token.label = "Output directory"; token.help = "Folder to output files etc. "; token.group = "main"; token.is_required = False; token.is_locked = False; token.is_reversed = False; token.dependency_group = [['', '', '']]; token.default = "none"; token.restore = "none"; token.type = "output"; sxcmd.token_list.append(token); sxcmd.token_dict[token.key_base] = token
		token = SXcmd_token(); token.key_base = "output_stackname"; token.key_prefix = ""; token.label = "Output stackname"; token.help = "Name to output stack (without bdb:). "; token.group = "main"; token.is_required = True; token.is_locked = False; token.is_reversed = False; token.dependency_group = [['', '', '']]; token.default = ""; token.restore = ""; token.type = "output"; sxcmd.token_list.append(token); sxcmd.token_dict[token.key_base] = token
		token = SXcmd_token(); token.key_base = "refinement_dir"; token.key_prefix = ""; token.label = "Meridien directory"; token.help = "Path to Merdien directory.  "; token.group = "main"; token.is_required = True; token.is_locked = False; token.is_reversed = False; token.dependency_group = [['', '', '']]; token.default = ""; token.restore = ""; token.type = "dir"; sxcmd.token_list.append(token); sxcmd.token_dict[token.key_base] = token
		...
		token = SXcmd_token(); token.key_base = "range"; token.key_prefix = "--"; token.label = "Defocus serach range [default 0.15]"; token.help = "Search range around the current defocus value. "; token.group = "advanced"; token.is_required = False; token.is_locked = False; token.is_reversed = False; token.dependency_group = [['', '', '']]; token.default = "0.15"; token.restore = "0.15"; token.type = "float"; sxcmd.token_list.append(token); sxcmd.token_dict[token.key_base] = token
		token = SXcmd_token(); token.key_base = "delta"; token.key_prefix = "--"; token.label = "Defocus search delta [default 0.0025]"; token.help = "Finest search delta. "; token.group = "advanced"; token.is_required = False; token.is_locked = False; token.is_reversed = False; token.dependency_group = [['', '', '']]; token.default = "0.0025"; token.restore = "0.0025"; token.type = "float"; sxcmd.token_list.append(token); sxcmd.token_dict[token.key_base] = token
		token = SXcmd_token(); token.key_base = "resolution"; token.key_prefix = "--"; token.label = "Nominal resolution [Angstrom]"; token.help = "Nominal resolution of the reconstruction. "; token.group = "advanced"; token.is_required = False; token.is_locked = False; token.is_reversed = False; token.dependency_group = [['', '', '']]; token.default = "None"; token.restore = "None"; token.type = "float"; sxcmd.token_list.append(token); sxcmd.token_dict[token.key_base] = token
		token = SXcmd_token(); token.key_base = "pixelsize"; token.key_prefix = "--"; token.label = "Pixelsize [Angstrom]"; token.help = "Pixelsize in Angstrom. "; token.group = "advanced"; token.is_required = False; token.is_locked = False; token.is_reversed = False; token.dependency_group = [['', '', ''], ['resolution', 'None', 'True']]; token.default = "None"; token.restore = "None"; token.type = "string"; sxcmd.token_list.append(token); sxcmd.token_dict[token.key_base] = token; sxcmd.dependency_dict.setdefault('resolution', []).append([token.key_base, 'None', 'True'])
		token = SXcmd_token(); token.key_base = "number_part"; token.key_prefix = "--"; token.label = "Number of particles"; token.help = "Number of particles to process. Mainly for debugging. "; token.group = "advanced"; token.is_required = False; token.is_locked = False; token.is_reversed = False; token.dependency_group = [['', '', '']]; token.default = "none"; token.restore = "none"; token.type = "int"; sxcmd.token_list.append(token); sxcmd.token_dict[token.key_base] = token
		...
		token = SXcmd_token(); token.key_base = "check_consistency"; token.key_prefix = "--"; token.label = "Check consistency of inputs"; token.help = "Create a text file containing the list of inconsistent Micrograph ID entries (i.e. inconsist_mic_list_file.txt). "; token.group = "advanced"; token.is_required = False; token.is_locked = False; token.is_reversed = False; token.dependency_group = [['', '', '']]; token.default = False; token.restore = False; token.type = "bool"; sxcmd.token_list.append(token); sxcmd.token_dict[token.key_base] = token
		token = SXcmd_token(); token.key_base = "filament_width"; token.key_prefix = "--"; token.label = "Filament width"; token.help = "Filament width for the creation of the rectangular mask. When -1 is selected it uses one third of the box size. "; token.group = "advanced"; token.is_required = False; token.is_locked = False; token.is_reversed = False; token.dependency_group = [['', '', '']]; token.default = "-1"; token.restore = "-1"; token.type = "int"; sxcmd.token_list.append(token); sxcmd.token_dict[token.key_base] = token
		...
		sxcmd = SXcmd(); sxcmd.name = "sxcryolo_predict"; sxcmd.subname = ""; sxcmd.mode = ""; sxcmd.subset_config = ""; sxcmd.label = "crYOLO - predict"; sxcmd.short_info = "Prediction with crYOLO, a deep learning high accuracy particle picking procedure."; sxcmd.mpi_support = False; sxcmd.mpi_add_flag = False; sxcmd.category = "sxc_window"; sxcmd.role = "sxr_pipe"; sxcmd.is_submittable = True
		...
		token = SXcmd_token(); token.key_base = "output_dir"; token.key_prefix = ""; token.label = "Output directory"; token.help = "Folder to write the box files. "; token.group = "main"; token.is_required = False; token.is_locked = False; token.is_reversed = False; token.dependency_group = [['', '', '']]; token.default = "none"; token.restore = "none"; token.type = "output"; sxcmd.token_list.append(token); sxcmd.token_dict[token.key_base] = token
		token = SXcmd_token(); token.key_base = "confidence_threshold"; token.key_prefix = "--"; token.label = "Confidence threshold [0-1]"; token.help = "Confidence threshold for picking. Particles with a confidence threshold lower than this value will be discarded. "; token.group = "advanced"; token.is_required = False; token.is_locked = False; token.is_reversed = False; token.dependency_group = [['', '', '']]; token.default = "0.3"; token.restore = "0.3"; token.type = "float"; sxcmd.token_list.append(token); sxcmd.token_dict[token.key_base] = token
		token = SXcmd_token(); token.key_base = "gpu"; token.key_prefix = "--"; token.label = "GPUs"; token.help = "List of GPUs to use. "; token.group = "advanced"; token.is_required = False; token.is_locked = False; token.is_reversed = False; token.dependency_group = [['', '', '']]; token.default = "0"; token.restore = "0"; token.type = "int"; sxcmd.token_list.append(token); sxcmd.token_dict[token.key_base] = token
		token = SXcmd_token(); token.key_base = "filament_mode"; token.key_prefix = "--"; token.label = "Filament mode [True/False]"; token.help = "Check if you want to use the filament mode. "; token.group = "advanced"; token.is_required = False; token.is_locked = False; token.is_reversed = False; token.dependency_group = [['', '', '']]; token.default = False; token.restore = False; token.type = "bool"; sxcmd.token_list.append(token); sxcmd.token_dict[token.key_base] = token
		token = SXcmd_token(); token.key_base = "filament_width"; token.key_prefix = "--"; token.label = "Filament width [Pixel]"; token.help = "Width of your filament in pixel. "; token.group = "advanced"; token.is_required = False; token.is_locked = False; token.is_reversed = False; token.dependency_group = [['', '', ''], ['filament_mode', 'True', 'False']]; token.default = "100"; token.restore = "100"; token.type = "int"; sxcmd.token_list.append(token); sxcmd.token_dict[token.key_base] = token; sxcmd.dependency_dict.setdefault('filament_mode', []).append([token.key_base, 'True', 'False'])
		token = SXcmd_token(); token.key_base = "min_box_per_filament"; token.key_prefix = "--"; token.label = "Minimum number of boxes per filament"; token.help = "Specifies the minimum number of boxes per filament. "; token.group = "advanced"; token.is_required = False; token.is_locked = False; token.is_reversed = False; token.dependency_group = [['', '', ''], ['filament_mode', 'True', 'False']]; token.default = "6"; token.restore = "6"; token.type = "int"; sxcmd.token_list.append(token); sxcmd.token_dict[token.key_base] = token; sxcmd.dependency_dict.setdefault('filament_mode', []).append([token.key_base, 'True', 'False'])
		token = SXcmd_token(); token.key_base = "box_distance"; token.key_prefix = "--"; token.label = "Box distance"; token.help = "Distance between two boxes in pixel. "; token.group = "advanced"; token.is_required = False; token.is_locked = False; token.is_reversed = False; token.dependency_group = [['', '', ''], ['filament_mode', 'True', 'False']]; token.default = "20"; token.restore = "20"; token.type = "box"; sxcmd.token_list.append(token); sxcmd.token_dict[token.key_base] = token; sxcmd.dependency_dict.setdefault('filament_mode', []).append([token.key_base, 'True', 'False'])
		...
		token = SXcmd_token(); token.key_base = "invert"; token.key_prefix = "--"; token.label = "Invert input contrast"; token.help = "Preferably, particles should be brigt on a dark background. "; token.group = "main"; token.is_required = False; token.is_locked = False; token.is_reversed = False; token.dependency_group = [['', '', '']]; token.default = False; token.restore = False; token.type = "bool"; sxcmd.token_list.append(token); sxcmd.token_dict[token.key_base] = token
		...
		token = SXcmd_token(); token.key_base = "output_directory"; token.key_prefix = ""; token.label = "Output directory"; token.help = "The results will be written here. It cannot be an existing one. "; token.group = "main"; token.is_required = True; token.is_locked = False; token.is_reversed = False; token.dependency_group = [['', '', '']]; token.default = ""; token.restore = ""; token.type = "output"; sxcmd.token_list.append(token); sxcmd.token_dict[token.key_base] = token
		token = SXcmd_token(); token.key_base = "selection_list"; token.key_prefix = "--"; token.label = "Micrograph/Movie selection file"; token.help = "Specify path to text file containing a list of selected micrograph/movie names or paths. The particles associated with the micrographs/movies in this list will be processed. The file extension must be .txt. The directory path of each entry will be ignored if there are any. "; token.group = "main"; token.is_required = False; token.is_locked = False; token.is_reversed = False; token.dependency_group = [['', '', '']]; token.default = "none"; token.restore = "none"; token.type = "select_mic_stack"; sxcmd.token_list.append(token); sxcmd.token_dict[token.key_base] = token
		...
		sxcmd = SXcmd(); sxcmd.name = "sxcryolo_train"; sxcmd.subname = ""; sxcmd.mode = ""; sxcmd.subset_config = ""; sxcmd.label = "crYOLO - training"; sxcmd.short_info = "Training of crYOLO, a deep learning high accuracy particle picking procedure."; sxcmd.mpi_support = False; sxcmd.mpi_add_flag = False; sxcmd.category = "sxc_window"; sxcmd.role = "sxr_alt"; sxcmd.is_submittable = True
		...
		token = SXcmd_token(); token.key_base = "architecture"; token.key_prefix = "--"; token.label = "Network architecture"; token.help = "Type of network that is trained.  "; token.group = "advanced"; token.is_required = False; token.is_locked = False; token.is_reversed = False; token.dependency_group = [['', '', '']]; token.default = "YOLO"; token.restore = "YOLO"; token.type = "string"; sxcmd.token_list.append(token); sxcmd.token_dict[token.key_base] = token
		token = SXcmd_token(); token.key_base = "input_size"; token.key_prefix = "--"; token.label = "Input image dimension [Pixel]"; token.help = "Dimension of the image used as input to network. "; token.group = "advanced"; token.is_required = False; token.is_locked = False; token.is_reversed = False; token.dependency_group = [['', '', '']]; token.default = "768"; token.restore = "768"; token.type = "int"; sxcmd.token_list.append(token); sxcmd.token_dict[token.key_base] = token
		token = SXcmd_token(); token.key_base = "num_patches"; token.key_prefix = "--"; token.label = "Number of patches"; token.help = "The number of patches (e.g 2x2) the image is divided and classified separately. "; token.group = "advanced"; token.is_required = False; token.is_locked = False; token.is_reversed = False; token.dependency_group = [['', '', '']]; token.default = "2"; token.restore = "2"; token.type = "int"; sxcmd.token_list.append(token); sxcmd.token_dict[token.key_base] = token
		token = SXcmd_token(); token.key_base = "overlap_patches"; token.key_prefix = "--"; token.label = "Patch overlap [Pixel]"; token.help = "The amount of overlap the patches will overlap "; token.group = "advanced"; token.is_required = False; token.is_locked = False; token.is_reversed = False; token.dependency_group = [['', '', '']]; token.default = "200"; token.restore = "200"; token.type = "int"; sxcmd.token_list.append(token); sxcmd.token_dict[token.key_base] = token
		token = SXcmd_token(); token.key_base = "train_times"; token.key_prefix = "--"; token.label = "Repeat images"; token.help = "How often a images is augmented and repeadet in one epoch. "; token.group = "advanced"; token.is_required = False; token.is_locked = False; token.is_reversed = False; token.dependency_group = [['', '', '']]; token.default = "10"; token.restore = "10"; token.type = "int"; sxcmd.token_list.append(token); sxcmd.token_dict[token.key_base] = token
		token = SXcmd_token(); token.key_base = "weights_name"; token.key_prefix = "--"; token.label = "Weights name"; token.help = "Name of the model "; token.group = "advanced"; token.is_required = False; token.is_locked = False; token.is_reversed = False; token.dependency_group = [['', '', '']]; token.default = "cryolo_model.h5"; token.restore = "cryolo_model.h5"; token.type = "string"; sxcmd.token_list.append(token); sxcmd.token_dict[token.key_base] = token
		token = SXcmd_token(); token.key_base = "batch_size"; token.key_prefix = "--"; token.label = "Batch size"; token.help = "How many patches are processed in parallel. "; token.group = "advanced"; token.is_required = False; token.is_locked = False; token.is_reversed = False; token.dependency_group = [['', '', '']]; token.default = "6"; token.restore = "6"; token.type = "int"; sxcmd.token_list.append(token); sxcmd.token_dict[token.key_base] = token
		token = SXcmd_token(); token.key_base = "learning_rate"; token.key_prefix = "--"; token.label = "Learning rate"; token.help = "Learning rate used during training. "; token.group = "advanced"; token.is_required = False; token.is_locked = False; token.is_reversed = False; token.dependency_group = [['', '', '']]; token.default = "0.0001"; token.restore = "0.0001"; token.type = "float"; sxcmd.token_list.append(token); sxcmd.token_dict[token.key_base] = token
		token = SXcmd_token(); token.key_base = "np_epoch"; token.key_prefix = "--"; token.label = "Number of epochs"; token.help = "Maximum number of epochs. "; token.group = "advanced"; token.is_required = False; token.is_locked = False; token.is_reversed = False; token.dependency_group = [['', '', '']]; token.default = "100"; token.restore = "100"; token.type = "int"; sxcmd.token_list.append(token); sxcmd.token_dict[token.key_base] = token
		token = SXcmd_token(); token.key_base = "object_scale"; token.key_prefix = "--"; token.label = "Object loss scale"; token.help = "Loss scale for object. "; token.group = "advanced"; token.is_required = False; token.is_locked = False; token.is_reversed = False; token.dependency_group = [['', '', '']]; token.default = "5.0"; token.restore = "5.0"; token.type = "float"; sxcmd.token_list.append(token); sxcmd.token_dict[token.key_base] = token
		...
		token = SXcmd_token(); token.key_base = "warmup"; token.key_prefix = "--"; token.label = "Warm up epochs"; token.help = "Number of warmup epochs. "; token.group = "advanced"; token.is_required = False; token.is_locked = False; token.is_reversed = False; token.dependency_group = [['', '', '']]; token.default = "5"; token.restore = "5"; token.type = "int"; sxcmd.token_list.append(token); sxcmd.token_dict[token.key_base] = token
		token = SXcmd_token(); token.key_base = "gpu"; token.key_prefix = "--"; token.label = "GPUs"; token.help = "List of GPUs to use. "; token.group = "advanced"; token.is_required = False; token.is_locked = False; token.is_reversed = False; token.dependency_group = [['', '', '']]; token.default = "0"; token.restore = "0"; token.type = "int"; sxcmd.token_list.append(token); sxcmd.token_dict[token.key_base] = token
		...
		sxcmd = SXcmd(); sxcmd.name = "sxcryolo_boxmanager"; sxcmd.subname = ""; sxcmd.mode = ""; sxcmd.subset_config = ""; sxcmd.label = "crYOLO - boxmanager"; sxcmd.short_info = "Displays boxfiles on images. Allows creation of new training data for crYOLO."; sxcmd.mpi_support = False; sxcmd.mpi_add_flag = False; sxcmd.category = "sxc_window"; sxcmd.role = "sxr_util"; sxcmd.is_submittable = False
		...
		token = SXcmd_token(); token.key_base = "output_directory"; token.key_prefix = ""; token.label = "Output directory"; token.help = "General ISAC output directory to store all results. If the directory already exists ISC will only run in continuation mode (see advanced parameter restart). "; token.group = "main"; token.is_required = True; token.is_locked = False; token.is_reversed = False; token.dependency_group = [['', '', '']]; token.default = ""; token.restore = ""; token.type = "output_continue"; sxcmd.token_list.append(token); sxcmd.token_dict[token.key_base] = token
		...
		token = SXcmd_token(); token.key_base = "img_per_grp"; token.key_prefix = "--"; token.label = "Images per class"; token.help = "Ideally the number of images per. In practice this value determines the number of classes K = N / img_per_grp, where N is the total number of images in the input stack. "; token.group = "main"; token.is_required = False; token.is_locked = False; token.is_reversed = False; token.dependency_group = [['', '', '']]; token.default = "200"; token.restore = "200"; token.type = "int"; sxcmd.token_list.append(token); sxcmd.token_dict[token.key_base] = token
		token = SXcmd_token(); token.key_base = "CTF"; token.key_prefix = "--"; token.label = "CTF phase flipping"; token.help = "Use for cryo datasets. If set to True the data will be phase-flipped using CTF information included in the image headers. Cannot be used together with the VPP option. "; token.group = "main"; token.is_required = False; token.is_locked = False; token.is_reversed = False; token.dependency_group = [['', '', ''], ['VPP', 'False', 'False']]; token.default = False; token.restore = False; token.type = "bool"; sxcmd.token_list.append(token); sxcmd.token_dict[token.key_base] = token; sxcmd.dependency_dict.setdefault('VPP', []).append([token.key_base, 'False', 'False'])
		token = SXcmd_token(); token.key_base = "VPP"; token.key_prefix = "--"; token.label = "Phase Plate data"; token.help = "Use this option if the dataset is taken with phase plate. Cannot be used togehter with the CTF option. "; token.group = "main"; token.is_required = False; token.is_locked = False; token.is_reversed = False; token.dependency_group = [['', '', ''], ['CTF', 'False', 'False']]; token.default = False; token.restore = False; token.type = "bool"; sxcmd.token_list.append(token); sxcmd.token_dict[token.key_base] = token; sxcmd.dependency_dict.setdefault('CTF', []).append([token.key_base, 'False', 'False'])
		token = SXcmd_token(); token.key_base = "filament_width"; token.key_prefix = "--"; token.label = "Filament width [Pixels]"; token.help = "When this is set to a non-default value ISAC assumes helical data in which case particle images will be subjected to rectangular masking of the given filament_width value. "; token.group = "main"; token.is_required = False; token.is_locked = False; token.is_reversed = False; token.dependency_group = [['', '', '']]; token.default = "-1"; token.restore = "-1"; token.type = "int"; sxcmd.token_list.append(token); sxcmd.token_dict[token.key_base] = token
		...
		sxcmd = SXcmd(); sxcmd.name = "sxcompute_isac_avg"; sxcmd.subname = ""; sxcmd.mode = ""; sxcmd.subset_config = ""; sxcmd.label = "Beautifier"; sxcmd.short_info = "Perform local 2D alignment of ISAC2 2D clustering results using the original pixel size and full CTF correction."; sxcmd.mpi_support = True; sxcmd.mpi_add_flag = False; sxcmd.category = "sxc_isac"; sxcmd.role = "sxr_pipe"; sxcmd.is_submittable = True
		...
		token = SXcmd_token(); token.key_base = "output_dir"; token.key_prefix = "--"; token.label = "Output directory"; token.help = "The automatically-created output directory will contain results. By default, the program uses sharpen_DATA_AND_TIME for the name. If this is the same as ISAC2 run directory, the program automatically creates sharpen subdirectory under the ISAC2 run directory. "; token.group = "main"; token.is_required = False; token.is_locked = False; token.is_reversed = False; token.dependency_group = [['', '', '']]; token.default = "none"; token.restore = "none"; token.type = "output"; sxcmd.token_list.append(token); sxcmd.token_dict[token.key_base] = token
		...
		token = SXcmd_token(); token.key_base = "xr"; token.key_prefix = "--"; token.label = "Local search range [Pixels]"; token.help = "Translational search range for local alignment. "; token.group = "advanced"; token.is_required = False; token.is_locked = False; token.is_reversed = False; token.dependency_group = [['', '', ''], ['local_alignment', 'True', 'False']]; token.default = "-1.0"; token.restore = "-1.0"; token.type = "float"; sxcmd.token_list.append(token); sxcmd.token_dict[token.key_base] = token; sxcmd.dependency_dict.setdefault('local_alignment', []).append([token.key_base, 'True', 'False'])
		...
		token = SXcmd_token(); token.key_base = "list"; token.key_prefix = "--"; token.label = "Image selection file"; token.help = "Input selection text file containing a list of selected image IDs (or indexes of the data subset) to create a new virtual bdb image stack from an existed stack or virtual stack. "; token.group = "main"; token.is_required = False; token.is_locked = False; token.is_reversed = False; token.dependency_group = [['', '', ''], ['exlist', 'none', 'False'], ['step', '0,1', 'False']]; token.default = "none"; token.restore = "none"; token.type = "select_data2d_stack"; sxcmd.token_list.append(token); sxcmd.token_dict[token.key_base] = token; sxcmd.dependency_dict.setdefault('exlist', []).append([token.key_base, 'none', 'False']); sxcmd.dependency_dict.setdefault('step', []).append([token.key_base, '0,1', 'False'])
		token = SXcmd_token(); token.key_base = "exlist"; token.key_prefix = "--"; token.label = "Image exclusion file"; token.help = "Input exclusion text file containing a list of excluded image IDs (or indexes of the data subset) to create a new virtual bdb image stacks from an existed stack or virtual stack. "; token.group = "main"; token.is_required = False; token.is_locked = False; token.is_reversed = False; token.dependency_group = [['', '', ''], ['list', 'none', 'False'], ['step', '0,1', 'False']]; token.default = "none"; token.restore = "none"; token.type = "string"; sxcmd.token_list.append(token); sxcmd.token_dict[token.key_base] = token; sxcmd.dependency_dict.setdefault('list', []).append([token.key_base, 'none', 'False']); sxcmd.dependency_dict.setdefault('step', []).append([token.key_base, '0,1', 'False'])
		token = SXcmd_token(); token.key_base = "step"; token.key_prefix = "--"; token.label = "Processes only subset"; token.help = "Specify &lt;init&gt;,&lt;step&gt;[,&lt;max&gt;]. Process only a subset of the input data. For example, 0,2 would process only the even numbered particles. "; token.group = "main"; token.is_required = False; token.is_locked = False; token.is_reversed = False; token.dependency_group = [['', '', ''], ['list', 'none', 'False'], ['exlist', 'none', 'False']]; token.default = "0,1"; token.restore = "0,1"; token.type = "string"; sxcmd.token_list.append(token); sxcmd.token_dict[token.key_base] = token; sxcmd.dependency_dict.setdefault('list', []).append([token.key_base, 'none', 'False']); sxcmd.dependency_dict.setdefault('exlist', []).append([token.key_base, 'none', 'False'])
		...
		sxcmd = SXcmd(); sxcmd.name = "sxrviper"; sxcmd.subname = ""; sxcmd.mode = ""; sxcmd.subset_config = ""; sxcmd.label = "Initial 3D Model - RVIPER"; sxcmd.short_info = "Reproducible ab initio 3D structure determination. The program determines a validated initial intermediate resolution structure using a subset of class averages produced by ISAC2."; sxcmd.mpi_support = True; sxcmd.mpi_add_flag = False; sxcmd.category = "sxc_viper"; sxcmd.role = "sxr_pipe"; sxcmd.is_submittable = True
		...
		token = SXcmd_token(); token.key_base = "n_v_runs"; token.key_prefix = "--"; token.label = "Minimun number of VIPER runs per RVIPER iterations"; token.help = "Corresponds to run### output directory. "; token.group = "advanced"; token.is_required = False; token.is_locked = False; token.is_reversed = False; token.dependency_group = [['', '', '']]; token.default = "3"; token.restore = "3"; token.type = "int"; sxcmd.token_list.append(token); sxcmd.token_dict[token.key_base] = token
		token = SXcmd_token(); token.key_base = "criterion_name"; token.key_prefix = "--"; token.label = "Stable projection criterion"; token.help = "Used to decide if the solution is stable, i.e., whether projection images adopt similar orientations in independent runs of the program. Valid options are: '80th percentile',  or 'fastest increase in the last quartile'. "; token.group = "advanced"; token.is_required = False; token.is_locked = False; token.is_reversed = False; token.dependency_group = [['', '', '']]; token.default = "80th percentile"; token.restore = "80th percentile"; token.type = "string"; sxcmd.token_list.append(token); sxcmd.token_dict[token.key_base] = token
		token = SXcmd_token(); token.key_base = "outlier_index_threshold_method"; token.key_prefix = "--"; token.label = "Outlier selection method"; token.help = "Used to decide which images to keep. Valid options are: 'discontinuity_in_derivative', 'percentile', or 'angle_measure'. "; token.group = "advanced"; token.is_required = False; token.is_locked = False; token.is_reversed = False; token.dependency_group = [['', '', '']]; token.default = "discontinuity_in_derivative"; token.restore = "discontinuity_in_derivative"; token.type = "string"; sxcmd.token_list.append(token); sxcmd.token_dict[token.key_base] = token
		...
		token = SXcmd_token(); token.key_base = "maxit1"; token.key_prefix = "--"; token.label = "Maximum iterations - GA step"; token.help = "Maximum number of iterations for GA step. "; token.group = "advanced"; token.is_required = False; token.is_locked = False; token.is_reversed = False; token.dependency_group = [['', '', '']]; token.default = "400"; token.restore = "400"; token.type = "int"; sxcmd.token_list.append(token); sxcmd.token_dict[token.key_base] = token
		...
		token = SXcmd_token(); token.key_base = "mask3D"; token.key_prefix = "--"; token.label = "3D mask"; token.help = "Path to 3D mask file. "; token.group = "advanced"; token.is_required = False; token.is_locked = False; token.is_reversed = False; token.dependency_group = [['', '', '']]; token.default = "sphere"; token.restore = "sphere"; token.type = "data3d_one"; sxcmd.token_list.append(token); sxcmd.token_dict[token.key_base] = token
		token = SXcmd_token(); token.key_base = "L2threshold"; token.key_prefix = "--"; token.label = "GA stop threshold"; token.help = "Defines the maximum relative dispersion of structures' L2 norms. "; token.group = "advanced"; token.is_required = False; token.is_locked = False; token.is_reversed = False; token.dependency_group = [['', '', '']]; token.default = "0.03"; token.restore = "0.03"; token.type = "float"; sxcmd.token_list.append(token); sxcmd.token_dict[token.key_base] = token
		...
		sxcmd = SXcmd(); sxcmd.name = "sxpipe"; sxcmd.subname = "moon_eliminator"; sxcmd.mode = ""; sxcmd.subset_config = ""; sxcmd.label = "Volume Adjustment"; sxcmd.short_info = "Eliminate moons or remove dusts from the background of a 3D density map based on the expected molecular mass."; sxcmd.mpi_support = False; sxcmd.mpi_add_flag = False; sxcmd.category = "sxc_viper"; sxcmd.role = "sxr_pipe"; sxcmd.is_submittable = True
		...
		token = SXcmd_token(); token.key_base = "aa"; token.key_prefix = "--"; token.label = "Low-pass filter fall-off [1/Pixels]"; token.help = "Low-pass filter fall-off in absolute frequency. The program applies this low-pass filter before the moon elimination. Effective only when --fl &gt; 0.0. "; token.group = "advanced"; token.is_required = False; token.is_locked = False; token.is_reversed = False; token.dependency_group = [['', '', ''], ['fl', '-1.0', 'True']]; token.default = "0.1"; token.restore = "0.1"; token.type = "float"; sxcmd.token_list.append(token); sxcmd.token_dict[token.key_base] = token; sxcmd.dependency_dict.setdefault('fl', []).append([token.key_base, '-1.0', 'True'])
		token = SXcmd_token(); token.key_base = "debug"; token.key_prefix = "--"; token.label = "Run with debug mode"; token.help = "Mainly for developer. "; token.group = "advanced"; token.is_required = False; token.is_locked = False; token.is_reversed = False; token.dependency_group = [['', '', '']]; token.default = False; token.restore = False; token.type = "bool"; sxcmd.token_list.append(token); sxcmd.token_dict[token.key_base] = token

		sxcmd_list.append(sxcmd)

		sxcmd = SXcmd(); sxcmd.name = "sxmask"; sxcmd.subname = ""; sxcmd.mode = ""; sxcmd.subset_config = ""; sxcmd.label = "Masking"; sxcmd.short_info = "Mask creation tool for 2D or 3D masks."; sxcmd.mpi_support = False; sxcmd.mpi_add_flag = False; sxcmd.category = "sxc_viper"; sxcmd.role = "sxr_pipe"; sxcmd.is_submittable = True
		...
		token = SXcmd_token(); token.key_base = "prefix"; token.key_prefix = "--"; token.label = "Output prefix"; token.help = "Prefix of the produced files "; token.group = "main"; token.is_required = False; token.is_locked = False; token.is_reversed = False; token.dependency_group = [['', '', '']]; token.default = "sxmask"; token.restore = "sxmask"; token.type = "string"; sxcmd.token_list.append(token); sxcmd.token_dict[token.key_base] = token
		...
		token = SXcmd_token(); token.key_base = "use_mol_mass"; token.key_prefix = "--"; token.label = "Use molecular mass"; token.help = "GUI OPTION ONLY - Define if one want to use the molecular mass option as a masking threshold. "; token.group = "main"; token.is_required = False; token.is_locked = False; token.is_reversed = False; token.dependency_group = [['', '', ''], ['threshold', 'none', 'False'], ['nsigma', 'none', 'False']]; token.default = False; token.restore = False; token.type = "bool_ignore"; sxcmd.token_list.append(token); sxcmd.token_dict[token.key_base] = token; sxcmd.dependency_dict.setdefault('threshold', []).append([token.key_base, 'none', 'False']); sxcmd.dependency_dict.setdefault('nsigma', []).append([token.key_base, 'none', 'False'])
		token = SXcmd_token(); token.key_base = "mol_mass"; token.key_prefix = "--"; token.label = "Molecular mass [kDa]"; token.help = "The estimated molecular mass of the target particle in kilodalton. This is used to calculate the binarization threshold automatically. "; token.group = "main"; token.is_required = False; token.is_locked = False; token.is_reversed = False; token.dependency_group = [['', '', ''], ['use_mol_mass', 'True', 'False']]; token.default = "none"; token.restore = "none"; token.type = "mass"; sxcmd.token_list.append(token); sxcmd.token_dict[token.key_base] = token; sxcmd.dependency_dict.setdefault('use_mol_mass', []).append([token.key_base, 'True', 'False'])
		token = SXcmd_token(); token.key_base = "threshold"; token.key_prefix = "--"; token.label = "Binarization threshold"; token.help = "Defines the threshold used in the first step of the processing to generate a binary version of the input structure. If the value is lower-equal than the default, the option will be ignored and the threshold will be set according to nsigma method above. "; token.group = "main"; token.is_required = False; token.is_locked = False; token.is_reversed = False; token.dependency_group = [['', '', ''], ['nsigma', 'none', 'False'], ['use_mol_mass', 'False', 'False']]; token.default = "none"; token.restore = "none"; token.type = "string"; sxcmd.token_list.append(token); sxcmd.token_dict[token.key_base] = token; sxcmd.dependency_dict.setdefault('nsigma', []).append([token.key_base, 'none', 'False']); sxcmd.dependency_dict.setdefault('use_mol_mass', []).append([token.key_base, 'False', 'False'])
		token = SXcmd_token(); token.key_base = "nsigma"; token.key_prefix = "--"; token.label = "Density standard deviation threshold"; token.help = "Defines the threshold used in the first step of the processing to generate a binary version of the structure. The threshold is set to &lt;= mean + (nsigma x standard deviations). This option will not be used if the option threshold is none. "; token.group = "main"; token.is_required = False; token.is_locked = False; token.is_reversed = False; token.dependency_group = [['', '', ''], ['threshold', 'none', 'False'], ['use_mol_mass', 'False', 'False']]; token.default = "none"; token.restore = "none"; token.type = "string"; sxcmd.token_list.append(token); sxcmd.token_dict[token.key_base] = token; sxcmd.dependency_dict.setdefault('threshold', []).append([token.key_base, 'none', 'False']); sxcmd.dependency_dict.setdefault('use_mol_mass', []).append([token.key_base, 'False', 'False'])
		token = SXcmd_token(); token.key_base = "ndilation"; token.key_prefix = "--"; token.label = "Number of dilations"; token.help = "The pixel width to dilate the 3D binary volume corresponding to the specified molecular mass or density threshold prior to softening the edge. One circle of dilation will add about 2 pixels to the mask. "; token.group = "main"; token.is_required = False; token.is_locked = False; token.is_reversed = False; token.dependency_group = [['', '', '']]; token.default = "3"; token.restore = "3"; token.type = "int"; sxcmd.token_list.append(token); sxcmd.token_dict[token.key_base] = token
		token = SXcmd_token(); token.key_base = "nerosion"; token.key_prefix = "--"; token.label = "Number of erosions"; token.help = "Number of times to erode binarized volume. One circle of erosion will remove about 2 pixels from the mask. "; token.group = "main"; token.is_required = False; token.is_locked = False; token.is_reversed = False; token.dependency_group = [['', '', '']]; token.default = "0"; token.restore = "0"; token.type = "int"; sxcmd.token_list.append(token); sxcmd.token_dict[token.key_base] = token
		token = SXcmd_token(); token.key_base = "edge_width"; token.key_prefix = "--"; token.label = "Soft-edge width [Pixels]"; token.help = "The pixel width of transition area for soft-edged masking. If the width is 0, a binary mask is returned. "; token.group = "main"; token.is_required = False; token.is_locked = False; token.is_reversed = False; token.dependency_group = [['', '', '']]; token.default = "5"; token.restore = "5"; token.type = "int"; sxcmd.token_list.append(token); sxcmd.token_dict[token.key_base] = token
		token = SXcmd_token(); token.key_base = "edge_type"; token.key_prefix = "--"; token.label = "Soft-edge type"; token.help = "The type of soft-edge. Available methods are (1) \'cosine\' for cosine soft-edged (used in PostRefiner) and (2) \'gaussian\' for gaussian soft-edge. "; token.group = "main"; token.is_required = False; token.is_locked = False; token.is_reversed = False; token.dependency_group = [['', '', ''], ['edge_width', '0', 'True']]; token.default = "cosine"; token.restore = "cosine"; token.type = "string"; sxcmd.token_list.append(token); sxcmd.token_dict[token.key_base] = token; sxcmd.dependency_dict.setdefault('edge_width', []).append([token.key_base, '0', 'True'])
		token = SXcmd_token(); token.key_base = "allow_disconnected"; token.key_prefix = "--"; token.label = "Allow disconnected regions"; token.help = "Allow disconnected region in the mask. "; token.group = "main"; token.is_required = False; token.is_locked = False; token.is_reversed = False; token.dependency_group = [['', '', '']]; token.default = False; token.restore = False; token.type = "bool"; sxcmd.token_list.append(token); sxcmd.token_dict[token.key_base] = token
		token = SXcmd_token(); token.key_base = "fill_mask"; token.key_prefix = "--"; token.label = "Fill mask"; token.help = "Fills empty spaces inside a map. "; token.group = "main"; token.is_required = False; token.is_locked = False; token.is_reversed = False; token.dependency_group = [['', '', '']]; token.default = False; token.restore = False; token.type = "bool"; sxcmd.token_list.append(token); sxcmd.token_dict[token.key_base] = token
		token = SXcmd_token(); token.key_base = "do_old"; token.key_prefix = "--"; token.label = "Old behaviour"; token.help = "Restore the old masking behaviour, which is a bit less smooth. "; token.group = "advanced"; token.is_required = False; token.is_locked = False; token.is_reversed = False; token.dependency_group = [['', '', ''], ['edge_width', '0', 'True']]; token.default = False; token.restore = False; token.type = "bool"; sxcmd.token_list.append(token); sxcmd.token_dict[token.key_base] = token; sxcmd.dependency_dict.setdefault('edge_width', []).append([token.key_base, '0', 'True'])
		token = SXcmd_token(); token.key_base = "low_pass_filter_resolution"; token.key_prefix = "--"; token.label = "Low pass filter resolution [A]"; token.help = "Low pass filter resolution in angstrom. If set, the volume will be filtered prior to create a mask. "; token.group = "advanced"; token.is_required = False; token.is_locked = False; token.is_reversed = False; token.dependency_group = [['', '', '']]; token.default = "none"; token.restore = "none"; token.type = "string"; sxcmd.token_list.append(token); sxcmd.token_dict[token.key_base] = token
		token = SXcmd_token(); token.key_base = "low_pass_filter_falloff"; token.key_prefix = "--"; token.label = "Low pass filter falloff [1/Pixel]"; token.help = "Low pass filter falloff in absolute frequencies. If set, the volume will be filtered prior to create a mask. "; token.group = "advanced"; token.is_required = False; token.is_locked = False; token.is_reversed = False; token.dependency_group = [['', '', ''], ['low_pass_filter_resolution', 'none', 'True']]; token.default = "0.01"; token.restore = "0.01"; token.type = "float"; sxcmd.token_list.append(token); sxcmd.token_dict[token.key_base] = token; sxcmd.dependency_dict.setdefault('low_pass_filter_resolution', []).append([token.key_base, 'none', 'True'])
		token = SXcmd_token(); token.key_base = "pixel_size"; token.key_prefix = "--"; token.label = "Pixel size [A/px]"; token.help = "Pixel size of the volume. Used for filtering. "; token.group = "advanced"; token.is_required = False; token.is_locked = False; token.is_reversed = False; token.dependency_group = [['', '', ''], ['low_pass_filter_resolution', 'none', 'True']]; token.default = "1.0"; token.restore = "1.0"; token.type = "apix"; sxcmd.token_list.append(token); sxcmd.token_dict[token.key_base] = token; sxcmd.dependency_dict.setdefault('low_pass_filter_resolution', []).append([token.key_base, 'none', 'True'])
		token = SXcmd_token(); token.key_base = "use_second_mask"; token.key_prefix = "--"; token.label = "Use a second mask"; token.help = "ONLY A GUI OPTION. The second mask can be used to mask the first one after creation. This is useful to create soft edged regions of the mask. "; token.group = "advanced"; token.is_required = False; token.is_locked = False; token.is_reversed = False; token.dependency_group = [['', '', '']]; token.default = False; token.restore = False; token.type = "bool_ignore"; sxcmd.token_list.append(token); sxcmd.token_dict[token.key_base] = token
		token = SXcmd_token(); token.key_base = "second_mask"; token.key_prefix = "--"; token.label = "Second mask path"; token.help = "Path to the second mask used for masking the mask. "; token.group = "advanced"; token.is_required = False; token.is_locked = False; token.is_reversed = False; token.dependency_group = [['', '', ''], ['use_second_mask', 'True', 'False'], ['second_mask_shape', 'none', 'False']]; token.default = "none"; token.restore = "none"; token.type = "data3d_one"; sxcmd.token_list.append(token); sxcmd.token_dict[token.key_base] = token; sxcmd.dependency_dict.setdefault('use_second_mask', []).append([token.key_base, 'True', 'False']); sxcmd.dependency_dict.setdefault('second_mask_shape', []).append([token.key_base, 'none', 'False'])
		token = SXcmd_token(); token.key_base = "second_mask_shape"; token.key_prefix = "--"; token.label = "Second mask shape"; token.help = "Shape of the second mask. Possible values: sphere, cylinder, cube. "; token.group = "advanced"; token.is_required = False; token.is_locked = False; token.is_reversed = False; token.dependency_group = [['', '', ''], ['use_second_mask', 'True', 'False'], ['second_mask', 'none', 'False']]; token.default = "none"; token.restore = "none"; token.type = "data3d_one"; sxcmd.token_list.append(token); sxcmd.token_dict[token.key_base] = token; sxcmd.dependency_dict.setdefault('use_second_mask', []).append([token.key_base, 'True', 'False']); sxcmd.dependency_dict.setdefault('second_mask', []).append([token.key_base, 'none', 'False'])
		token = SXcmd_token(); token.key_base = "s_radius"; token.key_prefix = "--"; token.label = "Second - Radius of the mask"; token.help = "The estimated molecular mass of the target particle in kilodalton. This is used to calculate the binarization threshold automatically. "; token.group = "advanced"; token.is_required = False; token.is_locked = False; token.is_reversed = False; token.dependency_group = [['', '', ''], ['second_mask_shape', 'none', 'True'], ['second_mask_shape', 'cube', 'True'], ['use_second_mask', 'True', 'False']]; token.default = "none"; token.restore = "none"; token.type = "string"; sxcmd.token_list.append(token); sxcmd.token_dict[token.key_base] = token; sxcmd.dependency_dict.setdefault('second_mask_shape', []).append([token.key_base, 'none', 'True']); sxcmd.dependency_dict.setdefault('second_mask_shape', []).append([token.key_base, 'cube', 'True']); sxcmd.dependency_dict.setdefault('use_second_mask', []).append([token.key_base, 'True', 'False'])
		token = SXcmd_token(); token.key_base = "s_nx"; token.key_prefix = "--"; token.label = "Second - X dimension of the mask"; token.help = "The estimated molecular mass of the target particle in kilodalton. This is used to calculate the binarization threshold automatically. "; token.group = "advanced"; token.is_required = False; token.is_locked = False; token.is_reversed = False; token.dependency_group = [['', '', ''], ['second_mask_shape', 'none', 'True'], ['use_second_mask', 'True', 'False']]; token.default = "none"; token.restore = "none"; token.type = "string"; sxcmd.token_list.append(token); sxcmd.token_dict[token.key_base] = token; sxcmd.dependency_dict.setdefault('second_mask_shape', []).append([token.key_base, 'none', 'True']); sxcmd.dependency_dict.setdefault('use_second_mask', []).append([token.key_base, 'True', 'False'])
		token = SXcmd_token(); token.key_base = "s_ny"; token.key_prefix = "--"; token.label = "Second - Y dimension of the mask"; token.help = "The estimated molecular mass of the target particle in kilodalton. This is used to calculate the binarization threshold automatically. "; token.group = "advanced"; token.is_required = False; token.is_locked = False; token.is_reversed = False; token.dependency_group = [['', '', ''], ['second_mask_shape', 'none', 'True'], ['use_second_mask', 'True', 'False']]; token.default = "none"; token.restore = "none"; token.type = "string"; sxcmd.token_list.append(token); sxcmd.token_dict[token.key_base] = token; sxcmd.dependency_dict.setdefault('second_mask_shape', []).append([token.key_base, 'none', 'True']); sxcmd.dependency_dict.setdefault('use_second_mask', []).append([token.key_base, 'True', 'False'])
		token = SXcmd_token(); token.key_base = "s_nz"; token.key_prefix = "--"; token.label = "Second - Z dimension of the mask"; token.help = "The estimated molecular mass of the target particle in kilodalton. This is used to calculate the binarization threshold automatically. "; token.group = "advanced"; token.is_required = False; token.is_locked = False; token.is_reversed = False; token.dependency_group = [['', '', ''], ['second_mask_shape', 'none', 'True'], ['use_second_mask', 'True', 'False']]; token.default = "none"; token.restore = "none"; token.type = "string"; sxcmd.token_list.append(token); sxcmd.token_dict[token.key_base] = token; sxcmd.dependency_dict.setdefault('second_mask_shape', []).append([token.key_base, 'none', 'True']); sxcmd.dependency_dict.setdefault('use_second_mask', []).append([token.key_base, 'True', 'False'])
		token = SXcmd_token(); token.key_base = "s_use_mol_mass"; token.key_prefix = "--"; token.label = "Second - Use molecular mass"; token.help = "GUI OPTION ONLY - Define if one want to use the molecular mass option as a masking threshold. "; token.group = "advanced"; token.is_required = False; token.is_locked = False; token.is_reversed = False; token.dependency_group = [['', '', ''], ['s_threshold', 'none', 'False'], ['s_nsigma', 'none', 'False'], ['use_second_mask', 'True', 'False'], ['second_mask', 'none', 'True']]; token.default = False; token.restore = False; token.type = "bool_ignore"; sxcmd.token_list.append(token); sxcmd.token_dict[token.key_base] = token; sxcmd.dependency_dict.setdefault('s_threshold', []).append([token.key_base, 'none', 'False']); sxcmd.dependency_dict.setdefault('s_nsigma', []).append([token.key_base, 'none', 'False']); sxcmd.dependency_dict.setdefault('use_second_mask', []).append([token.key_base, 'True', 'False']); sxcmd.dependency_dict.setdefault('second_mask', []).append([token.key_base, 'none', 'True'])
		token = SXcmd_token(); token.key_base = "s_mol_mass"; token.key_prefix = "--"; token.label = "Second - Molecular mass [kDa]"; token.help = "The estimated molecular mass of the target particle in kilodalton. This is used to calculate the binarization threshold automatically. "; token.group = "advanced"; token.is_required = False; token.is_locked = False; token.is_reversed = False; token.dependency_group = [['', '', ''], ['s_use_mol_mass', 'True', 'False'], ['use_second_mask', 'True', 'False'], ['second_mask', 'none', 'True']]; token.default = "none"; token.restore = "none"; token.type = "string"; sxcmd.token_list.append(token); sxcmd.token_dict[token.key_base] = token; sxcmd.dependency_dict.setdefault('s_use_mol_mass', []).append([token.key_base, 'True', 'False']); sxcmd.dependency_dict.setdefault('use_second_mask', []).append([token.key_base, 'True', 'False']); sxcmd.dependency_dict.setdefault('second_mask', []).append([token.key_base, 'none', 'True'])
		token = SXcmd_token(); token.key_base = "s_threshold"; token.key_prefix = "--"; token.label = "Second - Binarization threshold"; token.help = "Defines the threshold used in the first step of the processing to generate a binary version of the input structure. If the value is lower-equal than the default, the option will be ignored and the threshold will be set according to nsigma method above. "; token.group = "advanced"; token.is_required = False; token.is_locked = False; token.is_reversed = False; token.dependency_group = [['', '', ''], ['s_nsigma', 'none', 'False'], ['s_use_mol_mass', 'False', 'False'], ['use_second_mask', 'True', 'False'], ['second_mask', 'none', 'True']]; token.default = "none"; token.restore = "none"; token.type = "string"; sxcmd.token_list.append(token); sxcmd.token_dict[token.key_base] = token; sxcmd.dependency_dict.setdefault('s_nsigma', []).append([token.key_base, 'none', 'False']); sxcmd.dependency_dict.setdefault('s_use_mol_mass', []).append([token.key_base, 'False', 'False']); sxcmd.dependency_dict.setdefault('use_second_mask', []).append([token.key_base, 'True', 'False']); sxcmd.dependency_dict.setdefault('second_mask', []).append([token.key_base, 'none', 'True'])
		token = SXcmd_token(); token.key_base = "s_nsigma"; token.key_prefix = "--"; token.label = "Second - Density standard deviation threshold"; token.help = "Defines the threshold used in the first step of the processing to generate a binary version of the structure. The threshold is set to &lt;= mean + (nsigma x standard deviations). This option will not be used if the option threshold is none. "; token.group = "advanced"; token.is_required = False; token.is_locked = False; token.is_reversed = False; token.dependency_group = [['', '', ''], ['s_threshold', 'none', 'False'], ['s_use_mol_mass', 'False', 'False'], ['use_second_mask', 'True', 'False'], ['second_mask', 'none', 'True']]; token.default = "none"; token.restore = "none"; token.type = "string"; sxcmd.token_list.append(token); sxcmd.token_dict[token.key_base] = token; sxcmd.dependency_dict.setdefault('s_threshold', []).append([token.key_base, 'none', 'False']); sxcmd.dependency_dict.setdefault('s_use_mol_mass', []).append([token.key_base, 'False', 'False']); sxcmd.dependency_dict.setdefault('use_second_mask', []).append([token.key_base, 'True', 'False']); sxcmd.dependency_dict.setdefault('second_mask', []).append([token.key_base, 'none', 'True'])
		token = SXcmd_token(); token.key_base = "s_ndilation"; token.key_prefix = "--"; token.label = "Second - Number of dilations"; token.help = "The pixel width to dilate the 3D binary volume corresponding to the specified molecular mass or density threshold prior to softening the edge. One round of erosion will add about 2 pixels to the mask "; token.group = "advanced"; token.is_required = False; token.is_locked = False; token.is_reversed = False; token.dependency_group = [['', '', ''], ['use_second_mask', 'True', 'False']]; token.default = "3"; token.restore = "3"; token.type = "int"; sxcmd.token_list.append(token); sxcmd.token_dict[token.key_base] = token; sxcmd.dependency_dict.setdefault('use_second_mask', []).append([token.key_base, 'True', 'False'])
		token = SXcmd_token(); token.key_base = "s_nerosion"; token.key_prefix = "--"; token.label = "Second - Number of erosions"; token.help = "Number of times to erode binarized volume. One round of erosion will remove about 2 pixels from the mask "; token.group = "advanced"; token.is_required = False; token.is_locked = False; token.is_reversed = False; token.dependency_group = [['', '', ''], ['use_second_mask', 'True', 'False']]; token.default = "0"; token.restore = "0"; token.type = "int"; sxcmd.token_list.append(token); sxcmd.token_dict[token.key_base] = token; sxcmd.dependency_dict.setdefault('use_second_mask', []).append([token.key_base, 'True', 'False'])
		token = SXcmd_token(); token.key_base = "s_edge_width"; token.key_prefix = "--"; token.label = "Second - Soft-edge width [Pixels]"; token.help = "The pixel width of transition area for soft-edged masking."; token.group = "advanced"; token.is_required = False; token.is_locked = False; token.is_reversed = False; token.dependency_group = [['', '', ''], ['use_second_mask', 'True', 'False']]; token.default = "5"; token.restore = "5"; token.type = "int"; sxcmd.token_list.append(token); sxcmd.token_dict[token.key_base] = token; sxcmd.dependency_dict.setdefault('use_second_mask', []).append([token.key_base, 'True', 'False'])
		token = SXcmd_token(); token.key_base = "s_edge_type"; token.key_prefix = "--"; token.label = "Second - Soft-edge type"; token.help = "The type of soft-edge for the 3D mask. Available methods are (1) \'cosine\' for cosine soft-edged (used in PostRefiner) and (2) \'gaussian\' for gaussian soft-edge. "; token.group = "advanced"; token.is_required = False; token.is_locked = False; token.is_reversed = False; token.dependency_group = [['', '', ''], ['use_second_mask', 'True', 'False'], ['s_edge_width', '0', 'True']]; token.default = "cosine"; token.restore = "cosine"; token.type = "string"; sxcmd.token_list.append(token); sxcmd.token_dict[token.key_base] = token; sxcmd.dependency_dict.setdefault('use_second_mask', []).append([token.key_base, 'True', 'False']); sxcmd.dependency_dict.setdefault('s_edge_width', []).append([token.key_base, '0', 'True'])
		token = SXcmd_token(); token.key_base = "s_do_old"; token.key_prefix = "--"; token.label = "Second - Old behaviour"; token.help = "Restore the old masking behaviour, which is a bit less smooth. "; token.group = "advanced"; token.is_required = False; token.is_locked = False; token.is_reversed = False; token.dependency_group = [['', '', ''], ['use_second_mask', 'True', 'False'], ['s_edge_width', '0', 'True']]; token.default = False; token.restore = False; token.type = "bool"; sxcmd.token_list.append(token); sxcmd.token_dict[token.key_base] = token; sxcmd.dependency_dict.setdefault('use_second_mask', []).append([token.key_base, 'True', 'False']); sxcmd.dependency_dict.setdefault('s_edge_width', []).append([token.key_base, '0', 'True'])
		token = SXcmd_token(); token.key_base = "s_allow_disconnected"; token.key_prefix = "--"; token.label = "Second - Allow disconnected regions"; token.help = "Allow disconnected region in the mask. "; token.group = "advanced"; token.is_required = False; token.is_locked = False; token.is_reversed = False; token.dependency_group = [['', '', ''], ['use_second_mask', 'True', 'False']]; token.default = False; token.restore = False; token.type = "bool"; sxcmd.token_list.append(token); sxcmd.token_dict[token.key_base] = token; sxcmd.dependency_dict.setdefault('use_second_mask', []).append([token.key_base, 'True', 'False'])
		...
		sxcmd = SXcmd(); sxcmd.name = "sxproj_compare"; sxcmd.subname = ""; sxcmd.mode = ""; sxcmd.subset_config = ""; sxcmd.label = "Compare Re-projections"; sxcmd.short_info = "Compare re-projections to class averages."; sxcmd.mpi_support = False; sxcmd.mpi_add_flag = False; sxcmd.category = "sxc_viper"; sxcmd.role = "sxr_util"; sxcmd.is_submittable = True
		token = SXcmd_token(); token.key_base = "stack"; token.key_prefix = ""; token.label = "Input images stack"; token.help = "Set of 2D images to be compared. "; token.group = "main"; token.is_required = True; token.is_locked = False; token.is_reversed = False; token.dependency_group = [['', '', '']]; token.default = ""; token.restore = ""; token.type = "data2d_one"; sxcmd.token_list.append(token); sxcmd.token_dict[token.key_base] = token
		token = SXcmd_token(); token.key_base = "input_volume"; token.key_prefix = ""; token.label = "Input volume"; token.help = "Reconstruction for which re-projections will be computed. In RVIPER, this file is of the form main003/run002/rotated_volume.hdf. "; token.group = "main"; token.is_required = True; token.is_locked = False; token.is_reversed = False; token.dependency_group = [['', '', '']]; token.default = ""; token.restore = ""; token.type = "data3d_one"; sxcmd.token_list.append(token); sxcmd.token_dict[token.key_base] = token
		...
		token = SXcmd_token(); token.key_base = "mode"; token.key_prefix = "--"; token.label = "Comparison method"; token.help = "Choices are: viper, projmatch, and meridien. "; token.group = "main"; token.is_required = False; token.is_locked = False; token.is_reversed = False; token.dependency_group = [['', '', '']]; token.default = "viper"; token.restore = "viper"; token.type = "string"; sxcmd.token_list.append(token); sxcmd.token_dict[token.key_base] = token
		token = SXcmd_token(); token.key_base = "classangles"; token.key_prefix = "--"; token.label = "VIPER - Projection parameter file"; token.help = "Import parameters containing projection angles. Not required if the projection parameters are stored in the header of the input images, which for ISAC2 is generally not the case. In RVIPER, this file is of the form main003/run002/rotated_reduced_params.txt. This file is not required if the angles have already been written to the header. "; token.group = "main"; token.is_required = False; token.is_locked = False; token.is_reversed = False; token.dependency_group = [['', '', ''], ['mode', 'viper', 'False']]; token.default = "None"; token.restore = "None"; token.type = "params_proj_txt"; sxcmd.token_list.append(token); sxcmd.token_dict[token.key_base] = token; sxcmd.dependency_dict.setdefault('mode', []).append([token.key_base, 'viper', 'False'])
		token = SXcmd_token(); token.key_base = "classselect"; token.key_prefix = "--"; token.label = "VIPER - Image selection file"; token.help = "Input selection containing list of images to be included from the input stack.  For instance, RVIPER, if it finds a stable solution, may exclude some images, and thus their projection angles will be excluded from the parameters file.  The file containing the list of included images will have a name like main003/index_keep_image.txt. "; token.group = "main"; token.is_required = False; token.is_locked = False; token.is_reversed = False; token.dependency_group = [['', '', ''], ['mode', 'viper', 'False']]; token.default = "None"; token.restore = "None"; token.type = "select_data2d_stack"; sxcmd.token_list.append(token); sxcmd.token_dict[token.key_base] = token; sxcmd.dependency_dict.setdefault('mode', []).append([token.key_base, 'viper', 'False'])
		token = SXcmd_token(); token.key_base = "delta"; token.key_prefix = "--"; token.label = "ProjMatch - Sampling angle"; token.help = "Angular-sampling for reference projections. "; token.group = "main"; token.is_required = False; token.is_locked = False; token.is_reversed = False; token.dependency_group = [['', '', ''], ['mode', 'projmatch', 'False']]; token.default = "7.5"; token.restore = "7.5"; token.type = "float"; sxcmd.token_list.append(token); sxcmd.token_dict[token.key_base] = token; sxcmd.dependency_dict.setdefault('mode', []).append([token.key_base, 'projmatch', 'False'])
		token = SXcmd_token(); token.key_base = "symmetry"; token.key_prefix = "--"; token.label = "ProjMatch - Symmetry"; token.help = "To limit angular projections. "; token.group = "main"; token.is_required = False; token.is_locked = False; token.is_reversed = False; token.dependency_group = [['', '', ''], ['mode', 'projmatch', 'False']]; token.default = "c1"; token.restore = "c1"; token.type = "sym"; sxcmd.token_list.append(token); sxcmd.token_dict[token.key_base] = token; sxcmd.dependency_dict.setdefault('mode', []).append([token.key_base, 'projmatch', 'False'])
		token = SXcmd_token(); token.key_base = "partangles"; token.key_prefix = "--"; token.label = "MERIDIEN - Alignment parameter file"; token.help = "Input refinement parameters. "; token.group = "main"; token.is_required = False; token.is_locked = False; token.is_reversed = False; token.dependency_group = [['', '', ''], ['mode', 'meridien', 'False']]; token.default = "None"; token.restore = "None"; token.type = "params_proj_txt"; sxcmd.token_list.append(token); sxcmd.token_dict[token.key_base] = token; sxcmd.dependency_dict.setdefault('mode', []).append([token.key_base, 'meridien', 'False'])
		token = SXcmd_token(); token.key_base = "partselect"; token.key_prefix = "--"; token.label = "MERIDIEN - Particle selection file"; token.help = "Input substack selection file if particles removed before refinement (e.g., Substack/isac_substack_particle_id_list.txt). "; token.group = "main"; token.is_required = False; token.is_locked = False; token.is_reversed = False; token.dependency_group = [['', '', ''], ['mode', 'meridien', 'False']]; token.default = "None"; token.restore = "None"; token.type = "select_data2d_stack"; sxcmd.token_list.append(token); sxcmd.token_dict[token.key_base] = token; sxcmd.dependency_dict.setdefault('mode', []).append([token.key_base, 'meridien', 'False'])
		token = SXcmd_token(); token.key_base = "outliers"; token.key_prefix = "--"; token.label = "MERIDIEN - Outlier angle"; token.help = "Particles differing from average Euler angle by more than this threshold (in degrees) will be excluded from average calculation, by default keeps all. "; token.group = "main"; token.is_required = False; token.is_locked = False; token.is_reversed = False; token.dependency_group = [['', '', ''], ['mode', 'meridien', 'False']]; token.default = "None"; token.restore = "None"; token.type = "string"; sxcmd.token_list.append(token); sxcmd.token_dict[token.key_base] = token; sxcmd.dependency_dict.setdefault('mode', []).append([token.key_base, 'meridien', 'False'])
		token = SXcmd_token(); token.key_base = "prjmethod"; token.key_prefix = "--"; token.label = "Interpolation method"; token.help = "Valid choices are trilinear, gridding, and nn. "; token.group = "advanced"; token.is_required = False; token.is_locked = False; token.is_reversed = False; token.dependency_group = [['', '', '']]; token.default = "trilinear"; token.restore = "trilinear"; token.type = "string"; sxcmd.token_list.append(token); sxcmd.token_dict[token.key_base] = token
		token = SXcmd_token(); token.key_base = "display"; token.key_prefix = "--"; token.label = "e2display"; token.help = "Automatically pops up a window with the output normalized montage. "; token.group = "advanced"; token.is_required = False; token.is_locked = False; token.is_reversed = False; token.dependency_group = [['', '', '']]; token.default = False; token.restore = False; token.type = "bool"; sxcmd.token_list.append(token); sxcmd.token_dict[token.key_base] = token
		token = SXcmd_token(); token.key_base = "verbose"; token.key_prefix = "--"; token.label = "verbose"; token.help = "Writes additional messages to the terminal during execution. "; token.group = "advanced"; token.is_required = False; token.is_locked = False; token.is_reversed = False; token.dependency_group = [['', '', '']]; token.default = False; token.restore = False; token.type = "bool"; sxcmd.token_list.append(token); sxcmd.token_dict[token.key_base] = token
		token = SXcmd_token(); token.key_base = "matchshift"; token.key_prefix = "--"; token.label = "ProjMatch - Maximum shift"; token.help = "Maximum shift to allow during translation alignment. "; token.group = "advanced"; token.is_required = False; token.is_locked = False; token.is_reversed = False; token.dependency_group = [['', '', ''], ['mode', 'projmatch', 'False']]; token.default = "2"; token.restore = "2"; token.type = "int"; sxcmd.token_list.append(token); sxcmd.token_dict[token.key_base] = token; sxcmd.dependency_dict.setdefault('mode', []).append([token.key_base, 'projmatch', 'False'])
		token = SXcmd_token(); token.key_base = "matchrad"; token.key_prefix = "--"; token.label = "ProjMatch - Outer radius"; token.help = "Outer alignment radius, defaults to automatically-deteremined. "; token.group = "advanced"; token.is_required = False; token.is_locked = False; token.is_reversed = False; token.dependency_group = [['', '', ''], ['mode', 'projmatch', 'False']]; token.default = "None"; token.restore = "None"; token.type = "string"; sxcmd.token_list.append(token); sxcmd.token_dict[token.key_base] = token; sxcmd.dependency_dict.setdefault('mode', []).append([token.key_base, 'projmatch', 'False'])
		token = SXcmd_token(); token.key_base = "matchstep"; token.key_prefix = "--"; token.label = "ProjMatch - Radius step size"; token.help = "Alignment radius step size. "; token.group = "advanced"; token.is_required = False; token.is_locked = False; token.is_reversed = False; token.dependency_group = [['', '', ''], ['mode', 'projmatch', 'False']]; token.default = "1"; token.restore = "1"; token.type = "int"; sxcmd.token_list.append(token); sxcmd.token_dict[token.key_base] = token; sxcmd.dependency_dict.setdefault('mode', []).append([token.key_base, 'projmatch', 'False'])
		token = SXcmd_token(); token.key_base = "refinerad"; token.key_prefix = "--"; token.label = "MERIDIEN - Outer radius"; token.help = "Outer alignment radius, by default uses whole image. "; token.group = "advanced"; token.is_required = False; token.is_locked = False; token.is_reversed = False; token.dependency_group = [['', '', ''], ['mode', 'meridien', 'False']]; token.default = "None"; token.restore = "None"; token.type = "string"; sxcmd.token_list.append(token); sxcmd.token_dict[token.key_base] = token; sxcmd.dependency_dict.setdefault('mode', []).append([token.key_base, 'meridien', 'False'])
		token = SXcmd_token(); token.key_base = "refineshift"; token.key_prefix = "--"; token.label = "MERIDIEN - Maximum shift"; token.help = "Maximum shift to allow during translation alignment. "; token.group = "advanced"; token.is_required = False; token.is_locked = False; token.is_reversed = False; token.dependency_group = [['', '', ''], ['mode', 'meridien', 'False']]; token.default = "2"; token.restore = "2"; token.type = "int"; sxcmd.token_list.append(token); sxcmd.token_dict[token.key_base] = token; sxcmd.dependency_dict.setdefault('mode', []).append([token.key_base, 'meridien', 'False'])
		token = SXcmd_token(); token.key_base = "refinestep"; token.key_prefix = "--"; token.label = "MERIDIEN - Radius step size"; token.help = "Alignment radius step size. "; token.group = "advanced"; token.is_required = False; token.is_locked = False; token.is_reversed = False; token.dependency_group = [['', '', ''], ['mode', 'meridien', 'False']]; token.default = "1"; token.restore = "1"; token.type = "int"; sxcmd.token_list.append(token); sxcmd.token_dict[token.key_base] = token; sxcmd.dependency_dict.setdefault('mode', []).append([token.key_base, 'meridien', 'False'])
		token = SXcmd_token(); token.key_base = "align"; token.key_prefix = "--"; token.label = "MERIDIEN - Alignment method"; token.help = "Valid choices are apsh and scf. "; token.group = "advanced"; token.is_required = False; token.is_locked = False; token.is_reversed = False; token.dependency_group = [['', '', ''], ['mode', 'meridien', 'False']]; token.default = "apsh"; token.restore = "apsh"; token.type = "string"; sxcmd.token_list.append(token); sxcmd.token_dict[token.key_base] = token; sxcmd.dependency_dict.setdefault('mode', []).append([token.key_base, 'meridien', 'False'])

		sxcmd_list.append(sxcmd)

		sxcmd = SXcmd(); sxcmd.name = "sxpipe"; sxcmd.subname = "angular_distribution"; sxcmd.mode = ""; sxcmd.subset_config = ""; sxcmd.label = "Angular Distribution"; sxcmd.short_info = "Generate a chimera .bild file for the visual representation of the resulting projection parameters."; sxcmd.mpi_support = False; sxcmd.mpi_add_flag = False; sxcmd.category = "sxc_viper"; sxcmd.role = "sxr_util"; sxcmd.is_submittable = True
		...
		sxcmd = SXcmd(); sxcmd.name = "sxmeridien"; sxcmd.subname = ""; sxcmd.mode = ""; sxcmd.subset_config = "new"; sxcmd.label = "3D Refinement"; sxcmd.short_info = "Performs 3D structure refinement using a quasi-Maximum Likelihood approach."; sxcmd.mpi_support = True; sxcmd.mpi_add_flag = False; sxcmd.category = "sxc_meridien"; sxcmd.role = "sxr_pipe"; sxcmd.is_submittable = True
		...
		token = SXcmd_token(); token.key_base = "ccfpercentage"; token.key_prefix = "--"; token.label = "Correlation peaks to be included [%]"; token.help = "Percentage of correlation peaks to be included. 0.0 corresponds to hard matching. Ignored in final reconstruction. "; token.group = "advanced"; token.is_required = False; token.is_locked = False; token.is_reversed = False; token.dependency_group = [['', '', '']]; token.default = "99.9"; token.restore = "99.9"; token.type = "float"; sxcmd.token_list.append(token); sxcmd.token_dict[token.key_base] = token
		...
		token = SXcmd_token(); token.key_base = "pixel_size"; token.key_prefix = "--"; token.label = "Pixel size [A]"; token.help = "Pixel size of input data. "; token.group = "main"; token.is_required = False; token.is_locked = False; token.is_reversed = False; token.dependency_group = [['', '', '']]; token.default = "0.0"; token.restore = "0.0"; token.type = "apix"; sxcmd.token_list.append(token); sxcmd.token_dict[token.key_base] = token
		token = SXcmd_token(); token.key_base = "mask"; token.key_prefix = "--"; token.label = "3D mask file"; token.help = "Path to user-provided mask. "; token.group = "main"; token.is_required = False; token.is_locked = False; token.is_reversed = False; token.dependency_group = [['', '', ''], ['do_adaptive_mask', 'False', 'False']]; token.default = "none"; token.restore = "none"; token.type = "data3d_one"; sxcmd.token_list.append(token); sxcmd.token_dict[token.key_base] = token; sxcmd.dependency_dict.setdefault('do_adaptive_mask', []).append([token.key_base, 'False', 'False'])
		token = SXcmd_token(); token.key_base = "do_adaptive_mask"; token.key_prefix = "--"; token.label = "Apply adaptive mask"; token.help = "Program creates mask adaptively with given density threshold. "; token.group = "main"; token.is_required = False; token.is_locked = False; token.is_reversed = False; token.dependency_group = [['', '', ''], ['mask', 'none', 'False']]; token.default = False; token.restore = False; token.type = "bool"; sxcmd.token_list.append(token); sxcmd.token_dict[token.key_base] = token; sxcmd.dependency_dict.setdefault('mask', []).append([token.key_base, 'none', 'False'])
		token = SXcmd_token(); token.key_base = "use_mol_mass"; token.key_prefix = "--"; token.label = "Use molecular mass"; token.help = "GUI OPTION ONLY - Define if one want to use the molecular mass option as a masking threshold. "; token.group = "advanced"; token.is_required = False; token.is_locked = False; token.is_reversed = False; token.dependency_group = [['', '', ''], ['threshold', '-9999.0', 'False'], ['nsigma', '1.0', 'False'], ['do_adaptive_mask', 'True', 'False']]; token.default = False; token.restore = False; token.type = "bool_ignore"; sxcmd.token_list.append(token); sxcmd.token_dict[token.key_base] = token; sxcmd.dependency_dict.setdefault('threshold', []).append([token.key_base, '-9999.0', 'False']); sxcmd.dependency_dict.setdefault('nsigma', []).append([token.key_base, '1.0', 'False']); sxcmd.dependency_dict.setdefault('do_adaptive_mask', []).append([token.key_base, 'True', 'False'])
		token = SXcmd_token(); token.key_base = "mol_mass"; token.key_prefix = "--"; token.label = "Molecular mass [kDa]"; token.help = "The estimated molecular mass of the target particle in kilodalton. "; token.group = "advanced"; token.is_required = False; token.is_locked = False; token.is_reversed = False; token.dependency_group = [['', '', ''], ['use_mol_mass', 'True', 'False']]; token.default = "none"; token.restore = "none"; token.type = "mass"; sxcmd.token_list.append(token); sxcmd.token_dict[token.key_base] = token; sxcmd.dependency_dict.setdefault('use_mol_mass', []).append([token.key_base, 'True', 'False'])
		token = SXcmd_token(); token.key_base = "threshold"; token.key_prefix = "--"; token.label = "Binarization threshold"; token.help = "Defines the threshold used in the first step of the processing to generate a binary version of the input structure. If the value is lower-equal than the default, the option will be ignored and the threshold will be set according to nsigma method above. "; token.group = "main"; token.is_required = False; token.is_locked = False; token.is_reversed = False; token.dependency_group = [['', '', ''], ['nsigma', '1.0', 'False'], ['use_mol_mass', 'False', 'False'], ['do_adaptive_mask', 'True', 'False']]; token.default = "-9999.0"; token.restore = "-9999.0"; token.type = "float"; sxcmd.token_list.append(token); sxcmd.token_dict[token.key_base] = token; sxcmd.dependency_dict.setdefault('nsigma', []).append([token.key_base, '1.0', 'False']); sxcmd.dependency_dict.setdefault('use_mol_mass', []).append([token.key_base, 'False', 'False']); sxcmd.dependency_dict.setdefault('do_adaptive_mask', []).append([token.key_base, 'True', 'False'])
		token = SXcmd_token(); token.key_base = "nsigma"; token.key_prefix = "--"; token.label = "Density standard deviation threshold"; token.help = "Defines the threshold used in the first step of the processing to generate a binary version of the structure. The threshold is set to &lt;= mean + (nsigma x standard deviations). This option will not be used if the option threshold is larger than -9999.0. "; token.group = "advanced"; token.is_required = False; token.is_locked = False; token.is_reversed = False; token.dependency_group = [['', '', ''], ['threshold', '-9999.0', 'False'], ['use_mol_mass', 'False', 'False'], ['do_adaptive_mask', 'True', 'False']]; token.default = "1.0"; token.restore = "1.0"; token.type = "float"; sxcmd.token_list.append(token); sxcmd.token_dict[token.key_base] = token; sxcmd.dependency_dict.setdefault('threshold', []).append([token.key_base, '-9999.0', 'False']); sxcmd.dependency_dict.setdefault('use_mol_mass', []).append([token.key_base, 'False', 'False']); sxcmd.dependency_dict.setdefault('do_adaptive_mask', []).append([token.key_base, 'True', 'False'])
		token = SXcmd_token(); token.key_base = "edge_width"; token.key_prefix = "--"; token.label = "Soft-edge width [Pixels]"; token.help = "The pixel width of transition area for soft-edged masking."; token.group = "main"; token.is_required = False; token.is_locked = False; token.is_reversed = False; token.dependency_group = [['', '', ''], ['do_adaptive_mask', 'True', 'False']]; token.default = "5"; token.restore = "5"; token.type = "int"; sxcmd.token_list.append(token); sxcmd.token_dict[token.key_base] = token; sxcmd.dependency_dict.setdefault('do_adaptive_mask', []).append([token.key_base, 'True', 'False'])
		token = SXcmd_token(); token.key_base = "edge_type"; token.key_prefix = "--"; token.label = "Soft-edge type"; token.help = "The type of soft-edge for moon-eliminator 3D mask and a moon-eliminated soft-edged 3D mask. Available methods are (1) \'cosine\' for cosine soft-edged (used in PostRefiner) and (2) \'gauss\' for gaussian soft-edge. "; token.group = "advanced"; token.is_required = False; token.is_locked = False; token.is_reversed = False; token.dependency_group = [['', '', ''], ['do_adaptive_mask', 'True', 'False']]; token.default = "cosine"; token.restore = "cosine"; token.type = "string"; sxcmd.token_list.append(token); sxcmd.token_dict[token.key_base] = token; sxcmd.dependency_dict.setdefault('do_adaptive_mask', []).append([token.key_base, 'True', 'False'])
		...
		token = SXcmd_token(); token.key_base = "aa"; token.key_prefix = "--"; token.label = "Low-pass filter fall-off [1/Pixels]"; token.help = "Low-pass filter fall-off. Effective only when --fl option is not -1.0. "; token.group = "advanced"; token.is_required = False; token.is_locked = False; token.is_reversed = False; token.dependency_group = [['', '', ''], ['fl', '-1.0', 'True']]; token.default = "0.01"; token.restore = "0.01"; token.type = "float"; sxcmd.token_list.append(token); sxcmd.token_dict[token.key_base] = token; sxcmd.dependency_dict.setdefault('fl', []).append([token.key_base, '-1.0', 'True'])
		token = SXcmd_token(); token.key_base = "output"; token.key_prefix = "--"; token.label = "Output file name"; token.help = "File name of output final post-refined structure. "; token.group = "advanced"; token.is_required = False; token.is_locked = False; token.is_reversed = False; token.dependency_group = [['', '', '']]; token.default = "vol_combined.hdf"; token.restore = "vol_combined.hdf"; token.type = "output"; sxcmd.token_list.append(token); sxcmd.token_dict[token.key_base] = token

		sxcmd_list.append(sxcmd)

		sxcmd = SXcmd(); sxcmd.name = "sxheader"; sxcmd.subname = ""; sxcmd.mode = "import"; sxcmd.subset_config = ""; sxcmd.label = "Import Projection Parameters"; sxcmd.short_info = "Import projection orientation parameters to the header of the input stack. (Five columns: phi, theta, pshi, sx, sy). These parameters are required by 'Local Refinement from Stack' mode."; sxcmd.mpi_support = False; sxcmd.mpi_add_flag = False; sxcmd.category = "sxc_meridien"; sxcmd.role = "sxr_alt"; sxcmd.is_submittable = True
		...
		token = SXcmd_token(); token.key_base = "stack"; token.key_prefix = ""; token.label = "Input image stack"; token.help = "The stack must 3D orientation parameters (xform.projection) in image headers. They can be imporeted using sxheader.py."; token.group = "main"; token.is_required = True; token.is_locked = False; token.is_reversed = False; token.dependency_group = [['', '', '']]; token.default = ""; token.restore = ""; token.type = "bdb2d_stack"; sxcmd.token_list.append(token); sxcmd.token_dict[token.key_base] = token
		token = SXcmd_token(); token.key_base = "output_directory"; token.key_prefix = ""; token.label = "Output directory"; token.help = "The results will be written here. If not given, the program will use name master_DATA_AND_TIME. For standard continuation run, local refinement from iteration, and final reconstruction only, the directory must exist and further iterations will be written to this directory. "; token.group = "main"; token.is_required = False; token.is_locked = False; token.is_reversed = False; token.dependency_group = [['', '', '']]; token.default = "none"; token.restore = "none"; token.type = "output_continue"; sxcmd.token_list.append(token); sxcmd.token_dict[token.key_base] = token
		token = SXcmd_token(); token.key_base = "radius"; token.key_prefix = "--"; token.label = "Particle radius [Pixels]"; token.help = "Outer particle radius in pixels &lt; int(boxsize/2)-1. Ignored in final reconstruction. "; token.group = "main"; token.is_required = False; token.is_locked = False; token.is_reversed = False; token.dependency_group = [['', '', '']]; token.default = "-1"; token.restore = "-1"; token.type = "radius"; sxcmd.token_list.append(token); sxcmd.token_dict[token.key_base] = token
		token = SXcmd_token(); token.key_base = "mask3D"; token.key_prefix = "--"; token.label = "3D mask file"; token.help = "A mask applied to half-map during iterations of the program. If not given, a hard sphere of radius boxsize/2-1 will be used. Ignored in final reconstruction. "; token.group = "main"; token.is_required = False; token.is_locked = False; token.is_reversed = False; token.dependency_group = [['', '', '']]; token.default = "none"; token.restore = "none"; token.type = "data3d_one"; sxcmd.token_list.append(token); sxcmd.token_dict[token.key_base] = token
		token = SXcmd_token(); token.key_base = "symmetry"; token.key_prefix = "--"; token.label = "Point-group symmetry"; token.help = "Point-group symmetry of the refined structure. Supported point groups symmetries are: cn and dn, where n is multiplicity, oct, tet, and icos. Ignored in final reconstruction. "; token.group = "main"; token.is_required = False; token.is_locked = False; token.is_reversed = False; token.dependency_group = [['', '', '']]; token.default = "c1"; token.restore = "c1"; token.type = "sym"; sxcmd.token_list.append(token); sxcmd.token_dict[token.key_base] = token
		token = SXcmd_token(); token.key_base = "inires"; token.key_prefix = "--"; token.label = "Starting resolution [A]"; token.help = "Resolution of the initial_volume structure. For local refinement, the program automatically calculates the initial resolution using provided orientation parameters."; token.group = "main"; token.is_required = False; token.is_locked = False; token.is_reversed = False; token.dependency_group = [['', '', '']]; token.default = "-1.0"; token.restore = "-1.0"; token.type = "float"; sxcmd.token_list.append(token); sxcmd.token_dict[token.key_base] = token
		...
		sxcmd = SXcmd(); sxcmd.name = "sxmeridien"; sxcmd.subname = ""; sxcmd.mode = "local_refinement"; sxcmd.subset_config = "iteration"; sxcmd.label = "Restart Local Refinement"; sxcmd.short_info = "Restart local refinement after the last fully finished iteration of meridien run or local refinement run. One can change some parameters, but MPI settings have to be the same as in the original run."; sxcmd.mpi_support = True; sxcmd.mpi_add_flag = False; sxcmd.category = "sxc_meridien"; sxcmd.role = "sxr_alt"; sxcmd.is_submittable = True
		token = SXcmd_token(); token.key_base = "local_refinement"; token.key_prefix = "--"; token.label = "Perform local refinement"; token.help = "Perform local refinement starting from user-provided orientation parameters stored in the header of input image stack. "; token.group = "main"; token.is_required = True; token.is_locked = True; token.is_reversed = False; token.dependency_group = [['', '', '']]; token.default = True; token.restore = True; token.type = "bool"; sxcmd.token_list.append(token); sxcmd.token_dict[token.key_base] = token
		...
		sxcmd = SXcmd(); sxcmd.name = "sxmeridien"; sxcmd.subname = ""; sxcmd.mode = ""; sxcmd.subset_config = "restart"; sxcmd.label = "3D Refinement Restart"; sxcmd.short_info = "Restart 3D refinement after the last fully finished iteration of meridien run or local refinement run. One can change some parameters, but MPI settings have to be the same."; sxcmd.mpi_support = True; sxcmd.mpi_add_flag = False; sxcmd.category = "sxc_meridien"; sxcmd.role = "sxr_alt"; sxcmd.is_submittable = True
		...
		token = SXcmd_token(); token.key_base = "symmetry"; token.key_prefix = "--"; token.label = "Point-group symmetry"; token.help = "Point-group symmetry of the refined structure. Supported point groups symmetries are: cn and dn, where n is multiplicity, oct, tet, and icos. Ignored in final reconstruction. "; token.group = "advanced"; token.is_required = False; token.is_locked = False; token.is_reversed = False; token.dependency_group = [['', '', '']]; token.default = "c1"; token.restore = "c1"; token.type = "string"; sxcmd.token_list.append(token); sxcmd.token_dict[token.key_base] = token
		...
		sxcmd = SXcmd(); sxcmd.name = "sxmeridien"; sxcmd.subname = ""; sxcmd.mode = "do_final"; sxcmd.subset_config = ""; sxcmd.label = "Final 3D Reconstruction Only"; sxcmd.short_info = "Compute a final 3D reconstruction using either select or best resolution iteration of meridien."; sxcmd.mpi_support = True; sxcmd.mpi_add_flag = False; sxcmd.category = "sxc_meridien"; sxcmd.role = "sxr_alt"; sxcmd.is_submittable = True
		...
		sxcmd = SXcmd(); sxcmd.name = "sxmask"; sxcmd.subname = ""; sxcmd.mode = ""; sxcmd.subset_config = ""; sxcmd.label = "Masking"; sxcmd.short_info = "Mask creation tool for 2D or 3D masks."; sxcmd.mpi_support = False; sxcmd.mpi_add_flag = False; sxcmd.category = "sxc_meridien"; sxcmd.role = "sxr_util"; sxcmd.is_submittable = True
		token = SXcmd_token(); token.key_base = "input_volume"; token.key_prefix = ""; token.label = "Input image"; token.help = "Path to the 2D image or 3D Volume "; token.group = "main"; token.is_required = True; token.is_locked = False; token.is_reversed = False; token.dependency_group = [['', '', '']]; token.default = ""; token.restore = ""; token.type = "data3d_one"; sxcmd.token_list.append(token); sxcmd.token_dict[token.key_base] = token
		token = SXcmd_token(); token.key_base = "output_directory"; token.key_prefix = ""; token.label = "Output directory"; token.help = "Output direcory path "; token.group = "main"; token.is_required = True; token.is_locked = False; token.is_reversed = False; token.dependency_group = [['', '', '']]; token.default = ""; token.restore = ""; token.type = "dir"; sxcmd.token_list.append(token); sxcmd.token_dict[token.key_base] = token
		token = SXcmd_token(); token.key_base = "prefix"; token.key_prefix = "--"; token.label = "Output prefix"; token.help = "Prefix of the produced files "; token.group = "main"; token.is_required = False; token.is_locked = False; token.is_reversed = False; token.dependency_group = [['', '', '']]; token.default = "sxmask"; token.restore = "sxmask"; token.type = "string"; sxcmd.token_list.append(token); sxcmd.token_dict[token.key_base] = token
		token = SXcmd_token(); token.key_base = "overwrite"; token.key_prefix = "--"; token.label = "Overwrite outputs"; token.help = "Overwrite the output mask in case it exists already. "; token.group = "main"; token.is_required = False; token.is_locked = False; token.is_reversed = False; token.dependency_group = [['', '', '']]; token.default = False; token.restore = False; token.type = "bool"; sxcmd.token_list.append(token); sxcmd.token_dict[token.key_base] = token
		...
		sxcmd = SXcmd(); sxcmd.name = "sxprocess"; sxcmd.subname = ""; sxcmd.mode = "balance_angular_distribution"; sxcmd.subset_config = ""; sxcmd.label = "Balance Angular Distribution"; sxcmd.short_info = "Balance angular distribution of projection directions by removing excess particles, as determined by their angular histogram on a coarser grid, as specified by the angular_step option. "; sxcmd.mpi_support = False; sxcmd.mpi_add_flag = False; sxcmd.category = "sxc_meridien"; sxcmd.role = "sxr_util"; sxcmd.is_submittable = True
		...
		sxcmd = SXcmd(); sxcmd.name = "sxctf_refine"; sxcmd.subname = "meridien"; sxcmd.mode = ""; sxcmd.subset_config = ""; sxcmd.label = "CTF refine"; sxcmd.short_info = "Refine the defocus per particle"; sxcmd.mpi_support = False; sxcmd.mpi_add_flag = False; sxcmd.category = "sxc_meridien"; sxcmd.role = "sxr_util"; sxcmd.is_submittable = True
		token = SXcmd_token(); token.key_base = "path_to_input_stack"; token.key_prefix = ""; token.label = "Input stack path"; token.help = "Path to input stack. "; token.group = "main"; token.is_required = False; token.is_locked = False; token.is_reversed = False; token.dependency_group = [['', '', '']]; token.default = "none"; token.restore = "none"; token.type = "bdb2d_stack"; sxcmd.token_list.append(token); sxcmd.token_dict[token.key_base] = token
		token = SXcmd_token(); token.key_base = "output_directory"; token.key_prefix = ""; token.label = "Output directory"; token.help = "Folder to output files etc. "; token.group = "main"; token.is_required = False; token.is_locked = False; token.is_reversed = False; token.dependency_group = [['', '', '']]; token.default = "none"; token.restore = "none"; token.type = "output"; sxcmd.token_list.append(token); sxcmd.token_dict[token.key_base] = token
		token = SXcmd_token(); token.key_base = "output_stackname"; token.key_prefix = ""; token.label = "Output stackname"; token.help = "Name to output stack (without bdb:). "; token.group = "main"; token.is_required = True; token.is_locked = False; token.is_reversed = False; token.dependency_group = [['', '', '']]; token.default = ""; token.restore = ""; token.type = "output"; sxcmd.token_list.append(token); sxcmd.token_dict[token.key_base] = token
		token = SXcmd_token(); token.key_base = "refinement_dir"; token.key_prefix = ""; token.label = "Meridien directory"; token.help = "Path to Merdien directory.  "; token.group = "main"; token.is_required = True; token.is_locked = False; token.is_reversed = False; token.dependency_group = [['', '', '']]; token.default = ""; token.restore = ""; token.type = "dir"; sxcmd.token_list.append(token); sxcmd.token_dict[token.key_base] = token
		...
		token = SXcmd_token(); token.key_base = "refinement_dir"; token.key_prefix = "--"; token.label = "Meridien refinement directory"; token.help = "A string with meridien 3D refinement directory whose content will be used for sorting (iteration mode of sort3d). "; token.group = "main"; token.is_required = True; token.is_locked = False; token.is_reversed = False; token.dependency_group = [['', '', '']]; token.default = ""; token.restore = ""; token.type = "dir"; sxcmd.token_list.append(token); sxcmd.token_dict[token.key_base] = token
		token = SXcmd_token(); token.key_base = "output_dir"; token.key_prefix = "--"; token.label = "Output directory"; token.help = "A string with name of output directory. It can be either existing or new. By default, the program uses sort3d_DATA_AND_TIME as the output directory name. "; token.group = "main"; token.is_required = False; token.is_locked = False; token.is_reversed = False; token.dependency_group = [['', '', '']]; token.default = "none"; token.restore = "none"; token.type = "output_continue"; sxcmd.token_list.append(token); sxcmd.token_dict[token.key_base] = token
		token = SXcmd_token(); token.key_base = "niter_for_sorting"; token.key_prefix = "--"; token.label = "Iteration number of 3D meridien refinement for importing data"; token.help = "By default, the program uses the iteration at which refinement achieved the highest resolution. The user is strongly advised NOT to use last four or five iterations of meridien. Option is valid only for meridien iteration mode. "; token.group = "main"; token.is_required = False; token.is_locked = False; token.is_reversed = False; token.dependency_group = [['', '', '']]; token.default = "-1"; token.restore = "-1"; token.type = "int"; sxcmd.token_list.append(token); sxcmd.token_dict[token.key_base] = token
		token = SXcmd_token(); token.key_base = "mask3D"; token.key_prefix = "--"; token.label = "3D mask"; token.help = "A string with file name of the global 3D mask for clustering. Imported from 3D refinement unless user wishes a different one in meridien iteration mode. "; token.group = "main"; token.is_required = False; token.is_locked = False; token.is_reversed = False; token.dependency_group = [['', '', '']]; token.default = "none"; token.restore = "none"; token.type = "data3d_one"; sxcmd.token_list.append(token); sxcmd.token_dict[token.key_base] = token
		token = SXcmd_token(); token.key_base = "focus"; token.key_prefix = "--"; token.label = "Focus 3D mask"; token.help = "A string with file name of a binary 3D mask for focused clustering. "; token.group = "main"; token.is_required = False; token.is_locked = False; token.is_reversed = False; token.dependency_group = [['', '', '']]; token.default = "none"; token.restore = "none"; token.type = "data3d_one"; sxcmd.token_list.append(token); sxcmd.token_dict[token.key_base] = token
		...
		token = SXcmd_token(); token.key_base = "img_per_grp"; token.key_prefix = "--"; token.label = "Number of images per group"; token.help = "User expected group size in integer. "; token.group = "main"; token.is_required = False; token.is_locked = False; token.is_reversed = False; token.dependency_group = [['', '', '']]; token.default = "1000"; token.restore = "1000"; token.type = "int"; sxcmd.token_list.append(token); sxcmd.token_dict[token.key_base] = token
		token = SXcmd_token(); token.key_base = "img_per_grp_split_rate"; token.key_prefix = "--"; token.label = "Group splitting rate"; token.help = "An integer value denotes split rate of the group size(--img_per_grp). "; token.group = "advanced"; token.is_required = False; token.is_locked = False; token.is_reversed = False; token.dependency_group = [['', '', '']]; token.default = "1"; token.restore = "1"; token.type = "int"; sxcmd.token_list.append(token); sxcmd.token_dict[token.key_base] = token
		token = SXcmd_token(); token.key_base = "minimum_grp_size"; token.key_prefix = "--"; token.label = "Minimum size of reproducible class"; token.help = "The minimum size of selected or accounted clusters as well as the minimum group size constraint in MGSKmeans. However this value must be smaller than the number of images per a group (img_per_grp). It is recommended to use at least img_per_grp/4 and the program will stop if smaller value is used.  Use option override to use smaller numbrs.  "; token.group = "main"; token.is_required = False; token.is_locked = False; token.is_reversed = False; token.dependency_group = [['', '', '']]; token.default = "-1"; token.restore = "-1"; token.type = "int"; sxcmd.token_list.append(token); sxcmd.token_dict[token.key_base] = token
		token = SXcmd_token(); token.key_base = "do_swap_au"; token.key_prefix = "--"; token.label = "Swap flag"; token.help = "A boolean flag to control random swapping a certain number of accounted elements per cluster with the unaccounted elements. If the processing with the default values are extremely slow or stalled, please use this --do_swap_au option and set --swap_ratio to a large value (15.0[%] is a good start point). "; token.group = "advanced"; token.is_required = False; token.is_locked = False; token.is_reversed = False; token.dependency_group = [['', '', '']]; token.default = False; token.restore = False; token.type = "bool"; sxcmd.token_list.append(token); sxcmd.token_dict[token.key_base] = token
		token = SXcmd_token(); token.key_base = "swap_ratio"; token.key_prefix = "--"; token.label = "Swap percentage [%]"; token.help = "the percentage of images for swapping ranges between 0.0[%] and 50.0[%]. Option valid only with --do_swap_au. Without --do_swap_au, the program automatically sets --swap_ratio to 0.0. If the processing with the default values are extremely slow or stalled, please use --do_swap_au and set this --swap_ratio option to a large value (15.0[%] is a good start point). "; token.group = "advanced"; token.is_required = False; token.is_locked = False; token.is_reversed = False; token.dependency_group = [['', '', ''], ['do_swap_au', 'True', 'False']]; token.default = "1.0"; token.restore = "1.0"; token.type = "float"; sxcmd.token_list.append(token); sxcmd.token_dict[token.key_base] = token; sxcmd.dependency_dict.setdefault('do_swap_au', []).append([token.key_base, 'True', 'False'])
		token = SXcmd_token(); token.key_base = "memory_per_node"; token.key_prefix = "--"; token.label = "Memory per node [GB]"; token.help = "User provided size of available memory per node in GB (NOT per CPU). It will be used to evaluate the number of CPUs per node from MPI setting. By default, we assume 2GB * (number of CPUs per node). "; token.group = "main"; token.is_required = False; token.is_locked = False; token.is_reversed = False; token.dependency_group = [['', '', '']]; token.default = "-1.0"; token.restore = "-1.0"; token.type = "float"; sxcmd.token_list.append(token); sxcmd.token_dict[token.key_base] = token
		token = SXcmd_token(); token.key_base = "override"; token.key_prefix = "--"; token.label = "Override checks"; token.help = "A boolean flag that, if checked, will make the program bypass sanity checks of input parmeters. "; token.group = "advanced"; token.is_required = False; token.is_locked = False; token.is_reversed = False; token.dependency_group = [['', '', '']]; token.default = False; token.restore = False; token.type = "bool"; sxcmd.token_list.append(token); sxcmd.token_dict[token.key_base] = token
		...
		token = SXcmd_token(); token.key_base = "nsmear"; token.key_prefix = "--"; token.label = "Number of orientations for sorting"; token.help = "Should be set to 1 to turn of usage of meridien projection orientation probabilities. "; token.group = "advanced"; token.is_required = False; token.is_locked = False; token.is_reversed = False; token.dependency_group = [['', '', '']]; token.default = "-1"; token.restore = "-1"; token.type = "int"; sxcmd.token_list.append(token); sxcmd.token_dict[token.key_base] = token
		token = SXcmd_token(); token.key_base = "orientation_cones"; token.key_prefix = "--"; token.label = "Number of orientation cones"; token.help = "Number of orientation cones in an asymmetric unit. "; token.group = "advanced"; token.is_required = False; token.is_locked = False; token.is_reversed = False; token.dependency_group = [['', '', '']]; token.default = "20"; token.restore = "20"; token.type = "int"; sxcmd.token_list.append(token); sxcmd.token_dict[token.key_base] = token
		...
		token = SXcmd_token(); token.key_base = "num_core_set"; token.key_prefix = "--"; token.label = "Size of core set"; token.help = "Core set images will not be reconstructed if the total core set number is less than this. By default, the program will choose the maximum number between minimum group size and 100 as num_core_set. "; token.group = "advanced"; token.is_required = False; token.is_locked = False; token.is_reversed = False; token.dependency_group = [['', '', '']]; token.default = "-1"; token.restore = "-1"; token.type = "int"; sxcmd.token_list.append(token); sxcmd.token_dict[token.key_base] = token
		token = SXcmd_token(); token.key_base = "compute_on_the_fly"; token.key_prefix = "--"; token.label = "Compute on the fly"; token.help = "A boolean flag controls the number of pre-calculated smearing images to avoid memory overflow. By default, program calculates smearing images for 3D reconstruction prior constrained Kmeans. "; token.group = "advanced"; token.is_required = False; token.is_locked = False; token.is_reversed = False; token.dependency_group = [['', '', '']]; token.default = False; token.restore = False; token.type = "bool"; sxcmd.token_list.append(token); sxcmd.token_dict[token.key_base] = token
		token = SXcmd_token(); token.key_base = "check_smearing"; token.key_prefix = "--"; token.label = "Check smearing"; token.help = "A boolean flag to turn on Printing out average smearing of all iterations of meridien refinement. By default, program will not print. "; token.group = "advanced"; token.is_required = False; token.is_locked = False; token.is_reversed = False; token.dependency_group = [['', '', '']]; token.default = False; token.restore = False; token.type = "bool"; sxcmd.token_list.append(token); sxcmd.token_dict[token.key_base] = token
		...
		token = SXcmd_token(); token.key_base = "instack"; token.key_prefix = "--"; token.label = "Input images stack"; token.help = "A string with input particle stack to be used for sorting (stack mode of sort3d). "; token.group = "main"; token.is_required = True; token.is_locked = False; token.is_reversed = False; token.dependency_group = [['', '', '']]; token.default = ""; token.restore = ""; token.type = "bdb2d_stack"; sxcmd.token_list.append(token); sxcmd.token_dict[token.key_base] = token
		token = SXcmd_token(); token.key_base = "output_dir"; token.key_prefix = "--"; token.label = "Output directory"; token.help = "A string with name of output directory. It can be either existing or new. By default, the program uses sort3d_DATA_AND_TIME as the output directory name. "; token.group = "main"; token.is_required = False; token.is_locked = False; token.is_reversed = False; token.dependency_group = [['', '', '']]; token.default = "none"; token.restore = "none"; token.type = "output_continue"; sxcmd.token_list.append(token); sxcmd.token_dict[token.key_base] = token
		token = SXcmd_token(); token.key_base = "nxinit"; token.key_prefix = "--"; token.label = "Initial image size"; token.help = "Image size used for MGSKmeans in case of starting sorting from a data stack. By default, the program determines window size automatically. Option is valid only for stack mode. "; token.group = "main"; token.is_required = False; token.is_locked = False; token.is_reversed = False; token.dependency_group = [['', '', '']]; token.default = "-1"; token.restore = "-1"; token.type = "int"; sxcmd.token_list.append(token); sxcmd.token_dict[token.key_base] = token
		token = SXcmd_token(); token.key_base = "mask3D"; token.key_prefix = "--"; token.label = "3D mask"; token.help = "A string with file name of the global 3D mask for clustering. Imported from 3D refinement unless user wishes a different one in meridien iteration mode. "; token.group = "main"; token.is_required = False; token.is_locked = False; token.is_reversed = False; token.dependency_group = [['', '', '']]; token.default = "none"; token.restore = "none"; token.type = "data3d_one"; sxcmd.token_list.append(token); sxcmd.token_dict[token.key_base] = token
		token = SXcmd_token(); token.key_base = "focus"; token.key_prefix = "--"; token.label = "Focus 3D mask"; token.help = "A string with file name of a binary 3D mask for focused clustering. "; token.group = "main"; token.is_required = False; token.is_locked = False; token.is_reversed = False; token.dependency_group = [['', '', '']]; token.default = "none"; token.restore = "none"; token.type = "data3d_one"; sxcmd.token_list.append(token); sxcmd.token_dict[token.key_base] = token
		token = SXcmd_token(); token.key_base = "radius"; token.key_prefix = "--"; token.label = "Estimated particle radius [Pixels]"; token.help = "A integer value that is smaller than half of the box size. Imported from refinement unless user wishes a different one in meridien iteration mode. "; token.group = "main"; token.is_required = False; token.is_locked = False; token.is_reversed = False; token.dependency_group = [['', '', '']]; token.default = "-1"; token.restore = "-1"; token.type = "radius"; sxcmd.token_list.append(token); sxcmd.token_dict[token.key_base] = token
		token = SXcmd_token(); token.key_base = "sym"; token.key_prefix = "--"; token.label = "Point-group symmetry"; token.help = "A string denotes point group symmetry of the macromolecular structure. Imported from refinement unless the user wishes a different one in meridien iteration mode. Require specification in stack mode. "; token.group = "main"; token.is_required = False; token.is_locked = False; token.is_reversed = False; token.dependency_group = [['', '', '']]; token.default = "c1"; token.restore = "c1"; token.type = "sym"; sxcmd.token_list.append(token); sxcmd.token_dict[token.key_base] = token
		...
		sxcmd = SXcmd(); sxcmd.name = "sxmask"; sxcmd.subname = ""; sxcmd.mode = ""; sxcmd.subset_config = ""; sxcmd.label = "Masking"; sxcmd.short_info = "Mask creation tool for 2D or 3D masks."; sxcmd.mpi_support = False; sxcmd.mpi_add_flag = False; sxcmd.category = "sxc_sort3d"; sxcmd.role = "sxr_util"; sxcmd.is_submittable = True
		token = SXcmd_token(); token.key_base = "input_volume"; token.key_prefix = ""; token.label = "Input image"; token.help = "Path to the 2D image or 3D Volume "; token.group = "main"; token.is_required = True; token.is_locked = False; token.is_reversed = False; token.dependency_group = [['', '', '']]; token.default = ""; token.restore = ""; token.type = "data3d_one"; sxcmd.token_list.append(token); sxcmd.token_dict[token.key_base] = token
		token = SXcmd_token(); token.key_base = "output_directory"; token.key_prefix = ""; token.label = "Output directory"; token.help = "Output direcory path "; token.group = "main"; token.is_required = True; token.is_locked = False; token.is_reversed = False; token.dependency_group = [['', '', '']]; token.default = ""; token.restore = ""; token.type = "dir"; sxcmd.token_list.append(token); sxcmd.token_dict[token.key_base] = token
		token = SXcmd_token(); token.key_base = "prefix"; token.key_prefix = "--"; token.label = "Output prefix"; token.help = "Prefix of the produced files "; token.group = "main"; token.is_required = False; token.is_locked = False; token.is_reversed = False; token.dependency_group = [['', '', '']]; token.default = "sxmask"; token.restore = "sxmask"; token.type = "string"; sxcmd.token_list.append(token); sxcmd.token_dict[token.key_base] = token
		token = SXcmd_token(); token.key_base = "overwrite"; token.key_prefix = "--"; token.label = "Overwrite outputs"; token.help = "Overwrite the output mask in case it exists already. "; token.group = "main"; token.is_required = False; token.is_locked = False; token.is_reversed = False; token.dependency_group = [['', '', '']]; token.default = False; token.restore = False; token.type = "bool"; sxcmd.token_list.append(token); sxcmd.token_dict[token.key_base] = token
		...
		token = SXcmd_token(); token.key_base = "radius"; token.key_prefix = "--"; token.label = "Mask radius [Pixels]"; token.help = "In case no mask is provided, a hard sphere will be used. Use radius of the particle. "; token.group = "main"; token.is_required = False; token.is_locked = False; token.is_reversed = False; token.dependency_group = [['', '', '']]; token.default = "-1"; token.restore = "-1"; token.type = "radius"; sxcmd.token_list.append(token); sxcmd.token_dict[token.key_base] = token
		...
		sxcmd = SXcmd(); sxcmd.name = "sxmask"; sxcmd.subname = ""; sxcmd.mode = ""; sxcmd.subset_config = ""; sxcmd.label = "Masking"; sxcmd.short_info = "Mask creation tool for 2D or 3D masks."; sxcmd.mpi_support = False; sxcmd.mpi_add_flag = False; sxcmd.category = "sxc_localres"; sxcmd.role = "sxr_util"; sxcmd.is_submittable = True
		token = SXcmd_token(); token.key_base = "input_volume"; token.key_prefix = ""; token.label = "Input image"; token.help = "Path to the 2D image or 3D Volume "; token.group = "main"; token.is_required = True; token.is_locked = False; token.is_reversed = False; token.dependency_group = [['', '', '']]; token.default = ""; token.restore = ""; token.type = "data3d_one"; sxcmd.token_list.append(token); sxcmd.token_dict[token.key_base] = token
		token = SXcmd_token(); token.key_base = "output_directory"; token.key_prefix = ""; token.label = "Output directory"; token.help = "Output direcory path "; token.group = "main"; token.is_required = True; token.is_locked = False; token.is_reversed = False; token.dependency_group = [['', '', '']]; token.default = ""; token.restore = ""; token.type = "dir"; sxcmd.token_list.append(token); sxcmd.token_dict[token.key_base] = token
		token = SXcmd_token(); token.key_base = "prefix"; token.key_prefix = "--"; token.label = "Output prefix"; token.help = "Prefix of the produced files "; token.group = "main"; token.is_required = False; token.is_locked = False; token.is_reversed = False; token.dependency_group = [['', '', '']]; token.default = "sxmask"; token.restore = "sxmask"; token.type = "string"; sxcmd.token_list.append(token); sxcmd.token_dict[token.key_base] = token
		token = SXcmd_token(); token.key_base = "overwrite"; token.key_prefix = "--"; token.label = "Overwrite outputs"; token.help = "Overwrite the output mask in case it exists already. "; token.group = "main"; token.is_required = False; token.is_locked = False; token.is_reversed = False; token.dependency_group = [['', '', '']]; token.default = False; token.restore = False; token.type = "bool"; sxcmd.token_list.append(token); sxcmd.token_dict[token.key_base] = token
		...
		sxcmd = SXcmd(); sxcmd.name = "sxunblur"; sxcmd.subname = ""; sxcmd.mode = ""; sxcmd.subset_config = ""; sxcmd.label = "Unblur cisTEM"; sxcmd.short_info = "Align frames of micrograph movies with Unblur."; sxcmd.mpi_support = False; sxcmd.mpi_add_flag = False; sxcmd.category = "sxc_movie"; sxcmd.role = "sxr_pipe"; sxcmd.is_submittable = True
		...
		token = SXcmd_token(); token.key_base = "output_directory"; token.key_prefix = ""; token.label = "Output directory"; token.help = "The results will be written here. It cannot be an existing one. (This argument is specific to SPHIRE, and not directly used by Unblur and Summovie executables.) "; token.group = "main"; token.is_required = True; token.is_locked = False; token.is_reversed = False; token.dependency_group = [['', '', '']]; token.default = ""; token.restore = ""; token.type = "output"; sxcmd.token_list.append(token); sxcmd.token_dict[token.key_base] = token
		token = SXcmd_token(); token.key_base = "selection_file"; token.key_prefix = "--"; token.label = "Movie selection file"; token.help = "Specify a name of micrograph movie selection list text file. The file extension must be '.txt'. If this is not provided, all files matched with the micrograph movie name pattern will be processed. (This option is specific to SPHIRE, and not directly used by Unblur and Summovie executables.) "; token.group = "main"; token.is_required = False; token.is_locked = False; token.is_reversed = False; token.dependency_group = [['', '', '']]; token.default = "none"; token.restore = "none"; token.type = "string"; sxcmd.token_list.append(token); sxcmd.token_dict[token.key_base] = token
		token = SXcmd_token(); token.key_base = "pixel_size"; token.key_prefix = "--"; token.label = "Pixel size [A]"; token.help = "The pixel size of input micrographs. "; token.group = "main"; token.is_required = False; token.is_locked = False; token.is_reversed = False; token.dependency_group = [['', '', '']]; token.default = "1.0"; token.restore = "1.0"; token.type = "apix"; sxcmd.token_list.append(token); sxcmd.token_dict[token.key_base] = token
		token = SXcmd_token(); token.key_base = "bin_factor"; token.key_prefix = "--"; token.label = "Bin factor"; token.help = "Output bin factor. "; token.group = "main"; token.is_required = True; token.is_locked = False; token.is_reversed = False; token.dependency_group = [['', '', '']]; token.default = ""; token.restore = ""; token.type = "float"; sxcmd.token_list.append(token); sxcmd.token_dict[token.key_base] = token
		token = SXcmd_token(); token.key_base = "voltage"; token.key_prefix = "--"; token.label = "Microscope voltage [kV]"; token.help = "The acceleration voltage of microscope used for imaging. "; token.group = "main"; token.is_required = False; token.is_locked = False; token.is_reversed = False; token.dependency_group = [['', '', ''], ['skip_dose_adjustment', 'True', 'False']]; token.default = "300.0"; token.restore = "300.0"; token.type = "float"; sxcmd.token_list.append(token); sxcmd.token_dict[token.key_base] = token; sxcmd.dependency_dict.setdefault('skip_dose_adjustment', []).append([token.key_base, 'True', 'False'])
		token = SXcmd_token(); token.key_base = "exposure_per_frame"; token.key_prefix = "--"; token.label = "Per frame exposure [e/A^2]"; token.help = "The electron dose per frame in e/A^2. "; token.group = "main"; token.is_required = False; token.is_locked = False; token.is_reversed = False; token.dependency_group = [['', '', ''], ['skip_dose_adjustment', 'True', 'False']]; token.default = "1.0"; token.restore = "1.0"; token.type = "float"; sxcmd.token_list.append(token); sxcmd.token_dict[token.key_base] = token; sxcmd.dependency_dict.setdefault('skip_dose_adjustment', []).append([token.key_base, 'True', 'False'])
		token = SXcmd_token(); token.key_base = "pre_exposure"; token.key_prefix = "--"; token.label = "Pre-exposure [e/A^2]"; token.help = "The electron does in e/A^2 used for exposure prior to imaging. "; token.group = "main"; token.is_required = False; token.is_locked = False; token.is_reversed = False; token.dependency_group = [['', '', ''], ['skip_dose_adjustment', 'True', 'False']]; token.default = "0.0"; token.restore = "0.0"; token.type = "float"; sxcmd.token_list.append(token); sxcmd.token_dict[token.key_base] = token; sxcmd.dependency_dict.setdefault('skip_dose_adjustment', []).append([token.key_base, 'True', 'False'])
		token = SXcmd_token(); token.key_base = "additional_dose_unadjusted"; token.key_prefix = "--"; token.label = "Create unadjusted sums in addition"; token.help = "Run unblur twice to also create dose unadjusted sums. "; token.group = "main"; token.is_required = False; token.is_locked = False; token.is_reversed = False; token.dependency_group = [['', '', '']]; token.default = False; token.restore = False; token.type = "bool"; sxcmd.token_list.append(token); sxcmd.token_dict[token.key_base] = token
		token = SXcmd_token(); token.key_base = "gain_file"; token.key_prefix = "--"; token.label = "Gain file"; token.help = "Gain file in case of gain uncorrected movies. "; token.group = "main"; token.is_required = False; token.is_locked = False; token.is_reversed = False; token.dependency_group = [['', '', '']]; token.default = "none"; token.restore = "none"; token.type = "string"; sxcmd.token_list.append(token); sxcmd.token_dict[token.key_base] = token
		token = SXcmd_token(); token.key_base = "skip_dose_adjustment"; token.key_prefix = "--"; token.label = "Apply dose filter"; token.help = "Indicate if dose filter should be applied or not. By default, apply dose filter. "; token.group = "advanced"; token.is_required = False; token.is_locked = False; token.is_reversed = False; token.dependency_group = [['', '', '']]; token.default = True; token.restore = True; token.type = "bool"; sxcmd.token_list.append(token); sxcmd.token_dict[token.key_base] = token
		token = SXcmd_token(); token.key_base = "min_shift_initial"; token.key_prefix = "--"; token.label = "Minimum shift for initial search [A]"; token.help = "Minimum shift for initial search [A] "; token.group = "advanced"; token.is_required = False; token.is_locked = False; token.is_reversed = False; token.dependency_group = [['', '', '']]; token.default = "2.0"; token.restore = "2.0"; token.type = "float"; sxcmd.token_list.append(token); sxcmd.token_dict[token.key_base] = token
		token = SXcmd_token(); token.key_base = "outer_radius"; token.key_prefix = "--"; token.label = "Outer radius shift limit [A]"; token.help = "Outer radius shift limit "; token.group = "advanced"; token.is_required = False; token.is_locked = False; token.is_reversed = False; token.dependency_group = [['', '', '']]; token.default = "20.0"; token.restore = "20.0"; token.type = "float"; sxcmd.token_list.append(token); sxcmd.token_dict[token.key_base] = token
		token = SXcmd_token(); token.key_base = "b_factor"; token.key_prefix = "--"; token.label = "Apply B-factor to images [A^2]"; token.help = "Effective only when --expert_mode option is used. "; token.group = "advanced"; token.is_required = False; token.is_locked = False; token.is_reversed = False; token.dependency_group = [['', '', '']]; token.default = "1500.0"; token.restore = "1500.0"; token.type = "float"; sxcmd.token_list.append(token); sxcmd.token_dict[token.key_base] = token
		token = SXcmd_token(); token.key_base = "half_width_vert"; token.key_prefix = "--"; token.label = "Vertical Fourier central mask size"; token.help = "The half-width of central vertical line of Fourier mask. "; token.group = "advanced"; token.is_required = False; token.is_locked = False; token.is_reversed = False; token.dependency_group = [['', '', '']]; token.default = "1"; token.restore = "1"; token.type = "int"; sxcmd.token_list.append(token); sxcmd.token_dict[token.key_base] = token
		token = SXcmd_token(); token.key_base = "half_width_hor"; token.key_prefix = "--"; token.label = "Horizontal Fourier central mask size"; token.help = "The half-width of central horizontal line of Fourier mask. "; token.group = "advanced"; token.is_required = False; token.is_locked = False; token.is_reversed = False; token.dependency_group = [['', '', '']]; token.default = "1"; token.restore = "1"; token.type = "int"; sxcmd.token_list.append(token); sxcmd.token_dict[token.key_base] = token
		token = SXcmd_token(); token.key_base = "termination"; token.key_prefix = "--"; token.label = "Termination shift threshold"; token.help = "Termination shift threshold. "; token.group = "advanced"; token.is_required = False; token.is_locked = False; token.is_reversed = False; token.dependency_group = [['', '', '']]; token.default = "1"; token.restore = "1"; token.type = "int"; sxcmd.token_list.append(token); sxcmd.token_dict[token.key_base] = token
		token = SXcmd_token(); token.key_base = "max_iterations"; token.key_prefix = "--"; token.label = "Maximum iterations"; token.help = "Maximum iterations. "; token.group = "advanced"; token.is_required = False; token.is_locked = False; token.is_reversed = False; token.dependency_group = [['', '', '']]; token.default = "20"; token.restore = "20"; token.type = "int"; sxcmd.token_list.append(token); sxcmd.token_dict[token.key_base] = token
		token = SXcmd_token(); token.key_base = "dont_restore_noise_power"; token.key_prefix = "--"; token.label = "Restore noise power"; token.help = "Indicate if noise power should be restored after dose adjustment or not. By default, restore noise power. "; token.group = "advanced"; token.is_required = False; token.is_locked = False; token.is_reversed = False; token.dependency_group = [['', '', '']]; token.default = True; token.restore = True; token.type = "bool"; sxcmd.token_list.append(token); sxcmd.token_dict[token.key_base] = token
		token = SXcmd_token(); token.key_base = "first_frame"; token.key_prefix = "--"; token.label = "First frame"; token.help = "First frame to use for sum. "; token.group = "advanced"; token.is_required = False; token.is_locked = False; token.is_reversed = False; token.dependency_group = [['', '', '']]; token.default = "1"; token.restore = "1"; token.type = "int"; sxcmd.token_list.append(token); sxcmd.token_dict[token.key_base] = token
		token = SXcmd_token(); token.key_base = "last_frame"; token.key_prefix = "--"; token.label = "Last frame"; token.help = "Last frame to use for sum. "; token.group = "advanced"; token.is_required = False; token.is_locked = False; token.is_reversed = False; token.dependency_group = [['', '', '']]; token.default = "0"; token.restore = "0"; token.type = "int"; sxcmd.token_list.append(token); sxcmd.token_dict[token.key_base] = token
		token = SXcmd_token(); token.key_base = "distortion_angle"; token.key_prefix = "--"; token.label = "Distortion Angle [deg]"; token.help = "Distortion Angle in degrees. "; token.group = "advanced"; token.is_required = False; token.is_locked = False; token.is_reversed = False; token.dependency_group = [['', '', '']]; token.default = "0.0"; token.restore = "0.0"; token.type = "float"; sxcmd.token_list.append(token); sxcmd.token_dict[token.key_base] = token
		token = SXcmd_token(); token.key_base = "major_scale"; token.key_prefix = "--"; token.label = "Major scale"; token.help = "Major scale. "; token.group = "advanced"; token.is_required = False; token.is_locked = False; token.is_reversed = False; token.dependency_group = [['', '', '']]; token.default = "1.0"; token.restore = "1.0"; token.type = "float"; sxcmd.token_list.append(token); sxcmd.token_dict[token.key_base] = token
		token = SXcmd_token(); token.key_base = "minor_scale"; token.key_prefix = "--"; token.label = "Minor scale"; token.help = "Minor scale. "; token.group = "advanced"; token.is_required = False; token.is_locked = False; token.is_reversed = False; token.dependency_group = [['', '', '']]; token.default = "1.0"; token.restore = "1.0"; token.type = "float"; sxcmd.token_list.append(token); sxcmd.token_dict[token.key_base] = token
		...
		token = SXcmd_token(); token.key_base = "inputfile"; token.key_prefix = ""; token.label = "Shift files"; token.help = "A wild card (*) can be used to process multiple shift files. "; token.group = "main"; token.is_required = False; token.is_locked = False; token.is_reversed = False; token.dependency_group = [['', '', '']]; token.default = "none"; token.restore = "none"; token.type = "params_drift_txt"; sxcmd.token_list.append(token); sxcmd.token_dict[token.key_base] = token
		token = SXcmd_token(); token.key_base = "input_shift_list_file"; token.key_prefix = ""; token.label = "Input shift list file"; token.help = "Extension of input shift list file must be '.txt'. If this is not provided, all files matched with the micrograph name pattern will be processed. "; token.group = "main"; token.is_required = False; token.is_locked = False; token.is_reversed = False; token.dependency_group = [['', '', '']]; token.default = "none"; token.restore = "none"; token.type = "select_drift_params"; sxcmd.token_list.append(token); sxcmd.token_dict[token.key_base] = token

		sxcmd_list.append(sxcmd)

		sxcmd = SXcmd(); sxcmd.name = "sxunblur_old"; sxcmd.subname = ""; sxcmd.mode = ""; sxcmd.subset_config = ""; sxcmd.label = "Unblur 1.0.2 (Pre cisTEM)"; sxcmd.short_info = "Align frames of micrograph movies with Unblur & Summovie."; sxcmd.mpi_support = False; sxcmd.mpi_add_flag = False; sxcmd.category = "sxc_movie"; sxcmd.role = "sxr_alt"; sxcmd.is_submittable = True
		token = SXcmd_token(); token.key_base = "unblur_path"; token.key_prefix = ""; token.label = "Unblur executable path"; token.help = "Specify the file path of Unblur executable. (This argument is specific to SPHIRE, and not directly used by Unblur and Summovie executables.) "; token.group = "main"; token.is_required = True; token.is_locked = False; token.is_reversed = False; token.dependency_group = [['', '', '']]; token.default = ""; token.restore = ""; token.type = "exe"; sxcmd.token_list.append(token); sxcmd.token_dict[token.key_base] = token
		token = SXcmd_token(); token.key_base = "input_micrograph_pattern"; token.key_prefix = ""; token.label = "Input movie path pattern"; token.help = "Specify path pattern of input micrograph movies with a wild card (*).. The path pattern must be enclosed by single quotes (') or double quotes ('). (Note: sxgui.py automatically adds single quotes (')). bdb files cannot be selected as input micrograph movies. (This argument is specific to SPHIRE, and not directly used by Unblur and Summovie executables.) "; token.group = "main"; token.is_required = True; token.is_locked = False; token.is_reversed = False; token.dependency_group = [['', '', '']]; token.default = ""; token.restore = ""; token.type = "mic_stack"; sxcmd.token_list.append(token); sxcmd.token_dict[token.key_base] = token
		token = SXcmd_token(); token.key_base = "output_directory"; token.key_prefix = ""; token.label = "Output directory"; token.help = "The results will be written here. It cannot be an existing one. (This argument is specific to SPHIRE, and not directly used by Unblur and Summovie executables.) "; token.group = "main"; token.is_required = True; token.is_locked = False; token.is_reversed = False; token.dependency_group = [['', '', '']]; token.default = ""; token.restore = ""; token.type = "output"; sxcmd.token_list.append(token); sxcmd.token_dict[token.key_base] = token
		...
		token = SXcmd_token(); token.key_base = "pixel_size"; token.key_prefix = "--"; token.label = "Pixel size [A]"; token.help = "The pixel size of input micrographs. "; token.group = "main"; token.is_required = True; token.is_locked = False; token.is_reversed = False; token.dependency_group = [['', '', '']]; token.default = ""; token.restore = ""; token.type = "apix"; sxcmd.token_list.append(token); sxcmd.token_dict[token.key_base] = token
		token = SXcmd_token(); token.key_base = "voltage"; token.key_prefix = "--"; token.label = "Microscope voltage [kV]"; token.help = "The acceleration voltage of microscope used for imaging. Will be ignored when --skip_dose_filter option is used. "; token.group = "main"; token.is_required = False; token.is_locked = False; token.is_reversed = False; token.dependency_group = [['', '', ''], ['skip_dose_filter', 'True', 'False']]; token.default = "300.0"; token.restore = "300.0"; token.type = "float"; sxcmd.token_list.append(token); sxcmd.token_dict[token.key_base] = token; sxcmd.dependency_dict.setdefault('skip_dose_filter', []).append([token.key_base, 'True', 'False'])
		token = SXcmd_token(); token.key_base = "exposure_per_frame"; token.key_prefix = "--"; token.label = "Per frame exposure [e/A^2]"; token.help = "The electron dose per frame in e/A^2. Will be ignored when --skip_dose_filter option is used. "; token.group = "main"; token.is_required = False; token.is_locked = False; token.is_reversed = False; token.dependency_group = [['', '', ''], ['skip_dose_filter', 'True', 'False']]; token.default = "2.0"; token.restore = "2.0"; token.type = "float"; sxcmd.token_list.append(token); sxcmd.token_dict[token.key_base] = token; sxcmd.dependency_dict.setdefault('skip_dose_filter', []).append([token.key_base, 'True', 'False'])
		token = SXcmd_token(); token.key_base = "pre_exposure"; token.key_prefix = "--"; token.label = "Pre-exposure [e/A^2]"; token.help = "The electron does in e/A^2 used for exposure prior to imaging. Will be ignored when --skip_dose_filter option is used. "; token.group = "main"; token.is_required = False; token.is_locked = False; token.is_reversed = False; token.dependency_group = [['', '', ''], ['skip_dose_filter', 'True', 'False']]; token.default = "0.0"; token.restore = "0.0"; token.type = "float"; sxcmd.token_list.append(token); sxcmd.token_dict[token.key_base] = token; sxcmd.dependency_dict.setdefault('skip_dose_filter', []).append([token.key_base, 'True', 'False'])
		...
		token = SXcmd_token(); token.key_base = "shift_initial"; token.key_prefix = "--"; token.label = "Minimum shift for initial search [A]"; token.help = "Effective only when --expert_mode option is used. "; token.group = "advanced"; token.is_required = False; token.is_locked = False; token.is_reversed = False; token.dependency_group = [['', '', ''], ['expert_mode', 'True', 'False']]; token.default = "2.0"; token.restore = "2.0"; token.type = "float"; sxcmd.token_list.append(token); sxcmd.token_dict[token.key_base] = token; sxcmd.dependency_dict.setdefault('expert_mode', []).append([token.key_base, 'True', 'False'])
		token = SXcmd_token(); token.key_base = "shift_radius"; token.key_prefix = "--"; token.label = "Outer radius shift limit [A]"; token.help = "Effective only when --expert_mode option is used. "; token.group = "advanced"; token.is_required = False; token.is_locked = False; token.is_reversed = False; token.dependency_group = [['', '', ''], ['expert_mode', 'True', 'False']]; token.default = "200.0"; token.restore = "200.0"; token.type = "float"; sxcmd.token_list.append(token); sxcmd.token_dict[token.key_base] = token; sxcmd.dependency_dict.setdefault('expert_mode', []).append([token.key_base, 'True', 'False'])
		token = SXcmd_token(); token.key_base = "b_factor"; token.key_prefix = "--"; token.label = "Apply B-factor to images [A^2]"; token.help = "Effective only when --expert_mode option is used. "; token.group = "advanced"; token.is_required = False; token.is_locked = False; token.is_reversed = False; token.dependency_group = [['', '', ''], ['expert_mode', 'True', 'False']]; token.default = "1500.0"; token.restore = "1500.0"; token.type = "float"; sxcmd.token_list.append(token); sxcmd.token_dict[token.key_base] = token; sxcmd.dependency_dict.setdefault('expert_mode', []).append([token.key_base, 'True', 'False'])
		token = SXcmd_token(); token.key_base = "fourier_vertical"; token.key_prefix = "--"; token.label = "Vertical Fourier central mask size"; token.help = "The half-width of central vertical line of Fourier mask. Effective only when --expert_mode option is used. "; token.group = "advanced"; token.is_required = False; token.is_locked = False; token.is_reversed = False; token.dependency_group = [['', '', ''], ['expert_mode', 'True', 'False']]; token.default = "1"; token.restore = "1"; token.type = "int"; sxcmd.token_list.append(token); sxcmd.token_dict[token.key_base] = token; sxcmd.dependency_dict.setdefault('expert_mode', []).append([token.key_base, 'True', 'False'])
		...
		token = SXcmd_token(); token.key_base = "shift_threshold"; token.key_prefix = "--"; token.label = "Termination shift threshold"; token.help = "Effective only when --expert_mode option is used. "; token.group = "advanced"; token.is_required = False; token.is_locked = False; token.is_reversed = False; token.dependency_group = [['', '', ''], ['expert_mode', 'True', 'False']]; token.default = "0.1"; token.restore = "0.1"; token.type = "float"; sxcmd.token_list.append(token); sxcmd.token_dict[token.key_base] = token; sxcmd.dependency_dict.setdefault('expert_mode', []).append([token.key_base, 'True', 'False'])
		token = SXcmd_token(); token.key_base = "iterations"; token.key_prefix = "--"; token.label = "Maximum iterations"; token.help = "Effective only when --expert_mode option is used. "; token.group = "advanced"; token.is_required = False; token.is_locked = False; token.is_reversed = False; token.dependency_group = [['', '', ''], ['expert_mode', 'True', 'False']]; token.default = "10"; token.restore = "10"; token.type = "int"; sxcmd.token_list.append(token); sxcmd.token_dict[token.key_base] = token; sxcmd.dependency_dict.setdefault('expert_mode', []).append([token.key_base, 'True', 'False'])
		token = SXcmd_token(); token.key_base = "dont_restore_noise"; token.key_prefix = "--"; token.label = "Restore noise power"; token.help = "Indicate if noise power should be restored or not. By default, restore noise power. Effective only when --expert_mode option is used. "; token.group = "advanced"; token.is_required = False; token.is_locked = False; token.is_reversed = False; token.dependency_group = [['', '', ''], ['expert_mode', 'True', 'False']]; token.default = True; token.restore = True; token.type = "bool"; sxcmd.token_list.append(token); sxcmd.token_dict[token.key_base] = token; sxcmd.dependency_dict.setdefault('expert_mode', []).append([token.key_base, 'True', 'False'])
		token = SXcmd_token(); token.key_base = "verbose"; token.key_prefix = "--"; token.label = "Verbose"; token.help = "Effective only when --expert_mode option is used. "; token.group = "advanced"; token.is_required = False; token.is_locked = False; token.is_reversed = False; token.dependency_group = [['', '', ''], ['expert_mode', 'True', 'False']]; token.default = False; token.restore = False; token.type = "bool"; sxcmd.token_list.append(token); sxcmd.token_dict[token.key_base] = token; sxcmd.dependency_dict.setdefault('expert_mode', []).append([token.key_base, 'True', 'False'])
		...
		token = SXcmd_token(); token.key_base = "input_shift_pattern"; token.key_prefix = ""; token.label = "Input drift shift path pattern"; token.help = "Specify path pattern of input drift shift parameters files with a wild card (*).. The path pattern must be enclosed by single quotes (') or double quotes ('). (Note: sxgui.py automatically adds single quotes (')). The substring at the variable part must be same between the associated pair of input micrograph and shift file. (This argument is specific to SPHIRE, and not directly used by Summovie executable.) "; token.group = "main"; token.is_required = True; token.is_locked = False; token.is_reversed = False; token.dependency_group = [['', '', '']]; token.default = ""; token.restore = ""; token.type = "params_drift_txt"; sxcmd.token_list.append(token); sxcmd.token_dict[token.key_base] = token
		token = SXcmd_token(); token.key_base = "output_directory"; token.key_prefix = ""; token.label = "Output directory"; token.help = "The results will be written here. It cannot be an existing one. (This argument is specific to SPHIRE, and not directly used by Summovie executable.) "; token.group = "main"; token.is_required = True; token.is_locked = False; token.is_reversed = False; token.dependency_group = [['', '', '']]; token.default = ""; token.restore = ""; token.type = "output"; sxcmd.token_list.append(token); sxcmd.token_dict[token.key_base] = token
		token = SXcmd_token(); token.key_base = "selection_list"; token.key_prefix = "--"; token.label = "Movie selection file"; token.help = "Specify a name of micrograph movie selection list text file. The file extension must be '.txt'. If this is not provided, all files matched with the micrograph movie name pattern will be processed. (This option is specific to SPHIRE, and not directly used by Summovie executable.) "; token.group = "main"; token.is_required = False; token.is_locked = False; token.is_reversed = False; token.dependency_group = [['', '', '']]; token.default = "none"; token.restore = "none"; token.type = "select_mic_stack"; sxcmd.token_list.append(token); sxcmd.token_dict[token.key_base] = token
		token = SXcmd_token(); token.key_base = "nr_frames"; token.key_prefix = "--"; token.label = "Number of movie frames"; token.help = "The number of movie frames in each input micrograph. "; token.group = "main"; token.is_required = False; token.is_locked = False; token.is_reversed = False; token.dependency_group = [['', '', '']]; token.default = "3"; token.restore = "3"; token.type = "int"; sxcmd.token_list.append(token); sxcmd.token_dict[token.key_base] = token
		token = SXcmd_token(); token.key_base = "first"; token.key_prefix = "--"; token.label = "First movie frame"; token.help = "First movie frame for summing. "; token.group = "main"; token.is_required = False; token.is_locked = False; token.is_reversed = False; token.dependency_group = [['', '', '']]; token.default = "1"; token.restore = "1"; token.type = "int"; sxcmd.token_list.append(token); sxcmd.token_dict[token.key_base] = token
		token = SXcmd_token(); token.key_base = "last"; token.key_prefix = "--"; token.label = "Last movie frame"; token.help = "Last movie frame for summing. "; token.group = "main"; token.is_required = False; token.is_locked = False; token.is_reversed = False; token.dependency_group = [['', '', '']]; token.default = "-1"; token.restore = "-1"; token.type = "int"; sxcmd.token_list.append(token); sxcmd.token_dict[token.key_base] = token
		token = SXcmd_token(); token.key_base = "pixel_size"; token.key_prefix = "--"; token.label = "Pixel size [A]"; token.help = "The pixel size of input micrographs. "; token.group = "main"; token.is_required = True; token.is_locked = False; token.is_reversed = False; token.dependency_group = [['', '', '']]; token.default = ""; token.restore = ""; token.type = "apix"; sxcmd.token_list.append(token); sxcmd.token_dict[token.key_base] = token
		...
		token = SXcmd_token(); token.key_base = "voltage"; token.key_prefix = "--"; token.label = "Microscope voltage [kV]"; token.help = "The acceleration voltage of microscope used for imaging. Effective only when --apply_dose_filter option is used. "; token.group = "advanced"; token.is_required = False; token.is_locked = False; token.is_reversed = False; token.dependency_group = [['', '', ''], ['apply_dose_filter', 'True', 'False']]; token.default = "300.0"; token.restore = "300.0"; token.type = "float"; sxcmd.token_list.append(token); sxcmd.token_dict[token.key_base] = token; sxcmd.dependency_dict.setdefault('apply_dose_filter', []).append([token.key_base, 'True', 'False'])
		token = SXcmd_token(); token.key_base = "exposure_per_frame"; token.key_prefix = "--"; token.label = "Per frame exposure [e/A^2]"; token.help = "The electron dose per frame in e/A^2. Effective only when --apply_dose_filter option is used. "; token.group = "advanced"; token.is_required = False; token.is_locked = False; token.is_reversed = False; token.dependency_group = [['', '', ''], ['apply_dose_filter', 'True', 'False']]; token.default = "2.0"; token.restore = "2.0"; token.type = "float"; sxcmd.token_list.append(token); sxcmd.token_dict[token.key_base] = token; sxcmd.dependency_dict.setdefault('apply_dose_filter', []).append([token.key_base, 'True', 'False'])
		token = SXcmd_token(); token.key_base = "pre_exposure"; token.key_prefix = "--"; token.label = "Pre-exposure [e/A^2]"; token.help = "The electron does in e/A^2 used for exposure prior to imaging. Effective only when --apply_dose_filter option is used. "; token.group = "advanced"; token.is_required = False; token.is_locked = False; token.is_reversed = False; token.dependency_group = [['', '', ''], ['apply_dose_filter', 'True', 'False']]; token.default = "0.0"; token.restore = "0.0"; token.type = "float"; sxcmd.token_list.append(token); sxcmd.token_dict[token.key_base] = token; sxcmd.dependency_dict.setdefault('apply_dose_filter', []).append([token.key_base, 'True', 'False'])
		...
		token = SXcmd_token(); token.key_base = "params_2d_file"; token.key_prefix = "--"; token.label = "2D params file"; token.help = "2D alignment parameters. "; token.group = "main"; token.is_required = False; token.is_locked = False; token.is_reversed = False; token.dependency_group = [['', '', ''], ['particle_stack', 'none', 'True'], ['params_3d_file', 'none', 'False']]; token.default = "none"; token.restore = "none"; token.type = "params_any_txt"; sxcmd.token_list.append(token); sxcmd.token_dict[token.key_base] = token; sxcmd.dependency_dict.setdefault('particle_stack', []).append([token.key_base, 'none', 'True']); sxcmd.dependency_dict.setdefault('params_3d_file', []).append([token.key_base, 'none', 'False'])
		token = SXcmd_token(); token.key_base = "params_3d_file"; token.key_prefix = "--"; token.label = "3D params file"; token.help = "3D projection parameters. "; token.group = "main"; token.is_required = False; token.is_locked = False; token.is_reversed = False; token.dependency_group = [['', '', ''], ['particle_stack', 'none', 'True'], ['params_2d_file', 'none', 'False']]; token.default = "none"; token.restore = "none"; token.type = "params_any_txt"; sxcmd.token_list.append(token); sxcmd.token_dict[token.key_base] = token; sxcmd.dependency_dict.setdefault('particle_stack', []).append([token.key_base, 'none', 'True']); sxcmd.dependency_dict.setdefault('params_2d_file', []).append([token.key_base, 'none', 'False'])
		token = SXcmd_token(); token.key_base = "params_3d_index_file"; token.key_prefix = "--"; token.label = "3D params index file"; token.help = "Index file for the 3d params. Used to find the associated particle stack entry in the params file. In the meridien directories, this file is either called chunk or index."; token.group = "main"; token.is_required = False; token.is_locked = False; token.is_reversed = False; token.dependency_group = [['', '', ''], ['particle_stack', 'none', 'True'], ['params_3d_file', 'none', 'True']]; token.default = "none"; token.restore = "none"; token.type = "params_any_txt"; sxcmd.token_list.append(token); sxcmd.token_dict[token.key_base] = token; sxcmd.dependency_dict.setdefault('particle_stack', []).append([token.key_base, 'none', 'True']); sxcmd.dependency_dict.setdefault('params_3d_file', []).append([token.key_base, 'none', 'True'])
		token = SXcmd_token(); token.key_base = "params_3d_chunk_file_0"; token.key_prefix = "--"; token.label = "First 3D params chunk file"; token.help = "First chunk file for the 3d params. Used to extract the _rlnRandomSubset information. In the meridien directories, this file is called chunk. "; token.group = "main"; token.is_required = False; token.is_locked = False; token.is_reversed = False; token.dependency_group = [['', '', ''], ['particle_stack', 'none', 'True'], ['params_3d_file', 'none', 'True']]; token.default = "none"; token.restore = "none"; token.type = "params_any_txt"; sxcmd.token_list.append(token); sxcmd.token_dict[token.key_base] = token; sxcmd.dependency_dict.setdefault('particle_stack', []).append([token.key_base, 'none', 'True']); sxcmd.dependency_dict.setdefault('params_3d_file', []).append([token.key_base, 'none', 'True'])
		token = SXcmd_token(); token.key_base = "params_3d_chunk_file_1"; token.key_prefix = "--"; token.label = "Second 3D params chunk file"; token.help = "Second chunk file for the 3d params. Used to extract the _rlnRandomSubset information. In the meridien directories, this file is called chunk. "; token.group = "main"; token.is_required = False; token.is_locked = False; token.is_reversed = False; token.dependency_group = [['', '', ''], ['particle_stack', 'none', 'True'], ['params_3d_file', 'none', 'True']]; token.default = "none"; token.restore = "none"; token.type = "params_any_txt"; sxcmd.token_list.append(token); sxcmd.token_dict[token.key_base] = token; sxcmd.dependency_dict.setdefault('particle_stack', []).append([token.key_base, 'none', 'True']); sxcmd.dependency_dict.setdefault('params_3d_file', []).append([token.key_base, 'none', 'True'])
		token = SXcmd_token(); token.key_base = "force"; token.key_prefix = "--"; token.label = "Force"; token.help = "Overwrite existing star file. "; token.group = "advanced"; token.is_required = False; token.is_locked = False; token.is_reversed = False; token.dependency_group = [['', '', '']]; token.default = False; token.restore = False; token.type = "bool"; sxcmd.token_list.append(token); sxcmd.token_dict[token.key_base] = token
		token = SXcmd_token(); token.key_base = "list"; token.key_prefix = "--"; token.label = "Include particle list"; token.help = "List of particles to include. Requires --particle_stack. Cannot be used together with --exlist. "; token.group = "advanced"; token.is_required = False; token.is_locked = False; token.is_reversed = False; token.dependency_group = [['', '', ''], ['particle_stack', 'None', 'True'], ['exlist', 'None', 'False']]; token.default = "None"; token.restore = "None"; token.type = "select_data2d_stack"; sxcmd.token_list.append(token); sxcmd.token_dict[token.key_base] = token; sxcmd.dependency_dict.setdefault('particle_stack', []).append([token.key_base, 'None', 'True']); sxcmd.dependency_dict.setdefault('exlist', []).append([token.key_base, 'None', 'False'])
		token = SXcmd_token(); token.key_base = "exlist"; token.key_prefix = "--"; token.label = "Exclude particle list"; token.help = "List of particles to exclude. Requires --particle_stack. Cannot be used together with --list. "; token.group = "advanced"; token.is_required = False; token.is_locked = False; token.is_reversed = False; token.dependency_group = [['', '', ''], ['particle_stack', 'None', 'True'], ['list', 'None', 'False']]; token.default = "None"; token.restore = "None"; token.type = "string"; sxcmd.token_list.append(token); sxcmd.token_dict[token.key_base] = token; sxcmd.dependency_dict.setdefault('particle_stack', []).append([token.key_base, 'None', 'True']); sxcmd.dependency_dict.setdefault('list', []).append([token.key_base, 'None', 'False'])

		sxcmd_list.append(sxcmd)

		sxcmd = SXcmd(); sxcmd.name = "sxproj_compare"; sxcmd.subname = ""; sxcmd.mode = ""; sxcmd.subset_config = ""; sxcmd.label = "Compare Re-projections"; sxcmd.short_info = "Compare re-projections to class averages."; sxcmd.mpi_support = False; sxcmd.mpi_add_flag = False; sxcmd.category = "sxc_utilities"; sxcmd.role = "sxr_util"; sxcmd.is_submittable = True
		token = SXcmd_token(); token.key_base = "stack"; token.key_prefix = ""; token.label = "Input images stack"; token.help = "Set of 2D images to be compared. "; token.group = "main"; token.is_required = True; token.is_locked = False; token.is_reversed = False; token.dependency_group = [['', '', '']]; token.default = ""; token.restore = ""; token.type = "data2d_one"; sxcmd.token_list.append(token); sxcmd.token_dict[token.key_base] = token
		token = SXcmd_token(); token.key_base = "input_volume"; token.key_prefix = ""; token.label = "Input volume"; token.help = "Reconstruction for which re-projections will be computed. In RVIPER, this file is of the form main003/run002/rotated_volume.hdf. "; token.group = "main"; token.is_required = True; token.is_locked = False; token.is_reversed = False; token.dependency_group = [['', '', '']]; token.default = ""; token.restore = ""; token.type = "data3d_one"; sxcmd.token_list.append(token); sxcmd.token_dict[token.key_base] = token
		token = SXcmd_token(); token.key_base = "outdir"; token.key_prefix = ""; token.label = "Output directory"; token.help = "Directory where outputs will be written. "; token.group = "main"; token.is_required = True; token.is_locked = False; token.is_reversed = False; token.dependency_group = [['', '', '']]; token.default = ""; token.restore = ""; token.type = "output"; sxcmd.token_list.append(token); sxcmd.token_dict[token.key_base] = token
		token = SXcmd_token(); token.key_base = "mode"; token.key_prefix = "--"; token.label = "Comparison method"; token.help = "Choices are: viper, projmatch, and meridien. "; token.group = "main"; token.is_required = False; token.is_locked = False; token.is_reversed = False; token.dependency_group = [['', '', '']]; token.default = "viper"; token.restore = "viper"; token.type = "string"; sxcmd.token_list.append(token); sxcmd.token_dict[token.key_base] = token
		...
		sxcmd = SXcmd(); sxcmd.name = "sxmask"; sxcmd.subname = ""; sxcmd.mode = ""; sxcmd.subset_config = ""; sxcmd.label = "Masking"; sxcmd.short_info = "Mask creation tool for 2D or 3D masks."; sxcmd.mpi_support = False; sxcmd.mpi_add_flag = False; sxcmd.category = "sxc_utilities"; sxcmd.role = "sxr_util"; sxcmd.is_submittable = True
		token = SXcmd_token(); token.key_base = "input_volume"; token.key_prefix = ""; token.label = "Input image"; token.help = "Path to the 2D image or 3D Volume "; token.group = "main"; token.is_required = True; token.is_locked = False; token.is_reversed = False; token.dependency_group = [['', '', '']]; token.default = ""; token.restore = ""; token.type = "data3d_one"; sxcmd.token_list.append(token); sxcmd.token_dict[token.key_base] = token
		token = SXcmd_token(); token.key_base = "output_directory"; token.key_prefix = ""; token.label = "Output directory"; token.help = "Output direcory path "; token.group = "main"; token.is_required = True; token.is_locked = False; token.is_reversed = False; token.dependency_group = [['', '', '']]; token.default = ""; token.restore = ""; token.type = "dir"; sxcmd.token_list.append(token); sxcmd.token_dict[token.key_base] = token
		token = SXcmd_token(); token.key_base = "prefix"; token.key_prefix = "--"; token.label = "Output prefix"; token.help = "Prefix of the produced files "; token.group = "main"; token.is_required = False; token.is_locked = False; token.is_reversed = False; token.dependency_group = [['', '', '']]; token.default = "sxmask"; token.restore = "sxmask"; token.type = "string"; sxcmd.token_list.append(token); sxcmd.token_dict[token.key_base] = token
		token = SXcmd_token(); token.key_base = "overwrite"; token.key_prefix = "--"; token.label = "Overwrite outputs"; token.help = "Overwrite the output mask in case it exists already. "; token.group = "main"; token.is_required = False; token.is_locked = False; token.is_reversed = False; token.dependency_group = [['', '', '']]; token.default = False; token.restore = False; token.type = "bool"; sxcmd.token_list.append(token); sxcmd.token_dict[token.key_base] = token
		...
		token = SXcmd_token(); token.key_base = "input_stack"; token.key_prefix = ""; token.label = "Input image or volume"; token.help = "Input image or volume."; token.group = "main"; token.is_required = True; token.is_locked = False; token.is_reversed = False; token.dependency_group = [['', '', '']]; token.default = ""; token.restore = ""; token.type = "data2d3d_both"; sxcmd.token_list.append(token); sxcmd.token_dict[token.key_base] = token
		...
		token = SXcmd_token(); token.key_base = "output_file"; token.key_prefix = ""; token.label = "Output windowed volume"; token.help = "Path to output windowed (clipped/padded) volume file."; token.group = "main"; token.is_required = True; token.is_locked = False; token.is_reversed = False; token.dependency_group = [['', '', '']]; token.default = ""; token.restore = ""; token.type = "output"; sxcmd.token_list.append(token); sxcmd.token_dict[token.key_base] = token
		...
		token = SXcmd_token(); token.key_base = "stack"; token.key_prefix = ""; token.label = "Input image stack"; token.help = "Path to input image stack. The stack can be either bdb or hdf. However, the GUI supports only bdb. "; token.group = "main"; token.is_required = True; token.is_locked = False; token.is_reversed = False; token.dependency_group = [['', '', '']]; token.default = ""; token.restore = ""; token.type = "bdb2d_stack"; sxcmd.token_list.append(token); sxcmd.token_dict[token.key_base] = token
		token = SXcmd_token(); token.key_base = "params"; token.key_prefix = "--"; token.label = "Target parameters"; token.help = "List of parameters names (i.e. image header entry keys) to perform operations on (e.g. 'parm1 parm2 ...'). "; token.group = "main"; token.is_required = True; token.is_locked = False; token.is_reversed = False; token.dependency_group = [['', '', '']]; token.default = ""; token.restore = ""; token.type = "string"; sxcmd.token_list.append(token); sxcmd.token_dict[token.key_base] = token
		token = SXcmd_token(); token.key_base = "import"; token.key_prefix = "--"; token.label = "Import parameters"; token.help = "Import parameters from file. "; token.group = "main"; token.is_required = False; token.is_locked = False; token.is_reversed = False; token.dependency_group = [['', '', '']]; token.default = "none"; token.restore = "none"; token.type = "params_any_txt"; sxcmd.token_list.append(token); sxcmd.token_dict[token.key_base] = token
		...
		token = SXcmd_token(); token.key_base = "delete"; token.key_prefix = "--"; token.label = "Delete all"; token.help = "Delete all parameters. "; token.group = "main"; token.is_required = False; token.is_locked = False; token.is_reversed = False; token.dependency_group = [['', '', '']]; token.default = False; token.restore = False; token.type = "bool"; sxcmd.token_list.append(token); sxcmd.token_dict[token.key_base] = token
		token = SXcmd_token(); token.key_base = "zero"; token.key_prefix = "--"; token.label = "Set to zero"; token.help = "Set all parameters to zero. "; token.group = "advanced"; token.is_required = False; token.is_locked = False; token.is_reversed = False; token.dependency_group = [['', '', '']]; token.default = False; token.restore = False; token.type = "bool"; sxcmd.token_list.append(token); sxcmd.token_dict[token.key_base] = token
		...
		token = SXcmd_token(); token.key_base = "print"; token.key_prefix = "--"; token.label = "Print to screen"; token.help = "Print parameters to screen. "; token.group = "advanced"; token.is_required = False; token.is_locked = False; token.is_reversed = False; token.dependency_group = [['', '', '']]; token.default = False; token.restore = False; token.type = "bool"; sxcmd.token_list.append(token); sxcmd.token_dict[token.key_base] = token
		token = SXcmd_token(); token.key_base = "backup"; token.key_prefix = "--"; token.label = "Backup all"; token.help = "Backup all parameters. "; token.group = "advanced"; token.is_required = False; token.is_locked = False; token.is_reversed = False; token.dependency_group = [['', '', '']]; token.default = False; token.restore = False; token.type = "bool"; sxcmd.token_list.append(token); sxcmd.token_dict[token.key_base] = token
		token = SXcmd_token(); token.key_base = "restore"; token.key_prefix = "--"; token.label = "Restore all"; token.help = "Restore all parameters. "; token.group = "advanced"; token.is_required = False; token.is_locked = False; token.is_reversed = False; token.dependency_group = [['', '', '']]; token.default = False; token.restore = False; token.type = "bool"; sxcmd.token_list.append(token); sxcmd.token_dict[token.key_base] = token
		token = SXcmd_token(); token.key_base = "suffix"; token.key_prefix = "--"; token.label = "Suffix for backup"; token.help = "Suffix for xform name in backup. This will be added to the name of a parameter or removed during restore. "; token.group = "advanced"; token.is_required = False; token.is_locked = False; token.is_reversed = False; token.dependency_group = [['', '', '']]; token.default = "_backup"; token.restore = "_backup"; token.type = "string"; sxcmd.token_list.append(token); sxcmd.token_dict[token.key_base] = token
		...
		sxcmd = SXcmd(); sxcmd.name = "sxctf_refine"; sxcmd.subname = "meridien"; sxcmd.mode = ""; sxcmd.subset_config = ""; sxcmd.label = "CTF refine"; sxcmd.short_info = "Refine the defocus per particle"; sxcmd.mpi_support = False; sxcmd.mpi_add_flag = False; sxcmd.category = "sxc_utilities"; sxcmd.role = "sxr_util"; sxcmd.is_submittable = True
		token = SXcmd_token(); token.key_base = "path_to_input_stack"; token.key_prefix = ""; token.label = "Input stack path"; token.help = "Path to input stack. "; token.group = "main"; token.is_required = False; token.is_locked = False; token.is_reversed = False; token.dependency_group = [['', '', '']]; token.default = "none"; token.restore = "none"; token.type = "bdb2d_stack"; sxcmd.token_list.append(token); sxcmd.token_dict[token.key_base] = token
		token = SXcmd_token(); token.key_base = "output_directory"; token.key_prefix = ""; token.label = "Output directory"; token.help = "Folder to output files etc. "; token.group = "main"; token.is_required = False; token.is_locked = False; token.is_reversed = False; token.dependency_group = [['', '', '']]; token.default = "none"; token.restore = "none"; token.type = "output"; sxcmd.token_list.append(token); sxcmd.token_dict[token.key_base] = token
		token = SXcmd_token(); token.key_base = "output_stackname"; token.key_prefix = ""; token.label = "Output stackname"; token.help = "Name to output stack (without bdb:). "; token.group = "main"; token.is_required = True; token.is_locked = False; token.is_reversed = False; token.dependency_group = [['', '', '']]; token.default = ""; token.restore = ""; token.type = "output"; sxcmd.token_list.append(token); sxcmd.token_dict[token.key_base] = token
		token = SXcmd_token(); token.key_base = "refinement_dir"; token.key_prefix = ""; token.label = "Meridien directory"; token.help = "Path to Merdien directory.  "; token.group = "main"; token.is_required = True; token.is_locked = False; token.is_reversed = False; token.dependency_group = [['', '', '']]; token.default = ""; token.restore = ""; token.type = "dir"; sxcmd.token_list.append(token); sxcmd.token_dict[token.key_base] = token
