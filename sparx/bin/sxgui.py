...
def construct_sxcmd_list():
	...
	# @@@@@ START_INSERTION @@@@@
	sxcmd = SXcmd(); sxcmd.name = "sxunblur"; sxcmd.mode = ""; sxcmd.label = "2D Micrograph alignment"; sxcmd.short_info = "Performs 2D Micrograph alignment with Unblur."; sxcmd.mpi_support = False; sxcmd.mpi_add_flag = False; sxcmd.category = "pipe"; sxcmd.is_submittable = True
	token = SXcmd_token(); token.key_base = "unblur"; token.key_prefix = ""; token.label = "directory to unblur executable"; token.help = ""; token.group = "main"; token.is_required = True; token.default = ""; token.restore = ""; token.type = "string"; sxcmd.token_list.append(token)
	token = SXcmd_token(); token.key_base = "input_image"; token.key_prefix = ""; token.label = "a set of micrographs"; token.help = "name with wild card * to process multiple micrographs: "; token.group = "main"; token.is_required = True; token.default = ""; token.restore = ""; token.type = "any_image"; sxcmd.token_list.append(token)
	...
	sxcmd = SXcmd(); sxcmd.name = "e2boxer"; sxcmd.mode = ""; sxcmd.label = "Particle picking"; sxcmd.short_info = "Pick particles with e2boxer."; sxcmd.mpi_support = False; sxcmd.mpi_add_flag = False; sxcmd.category = "pipe"; sxcmd.is_submittable = True
	token = SXcmd_token(); token.key_base = "input"; token.key_prefix = ""; token.label = "input images"; token.help = "can not be a list of images: "; token.group = "main"; token.is_required = True; token.default = ""; token.restore = ""; token.type = "string"; sxcmd.token_list.append(token)
	token = SXcmd_token(); token.key_base = "boxsize"; token.key_prefix = "--"; token.label = "box size in pixels"; token.help = ""; token.group = "advanced"; token.is_required = False; token.default = "int"; token.restore = "int"; token.type = "box"; sxcmd.token_list.append(token)
	...
	token = SXcmd_token(); token.key_base = "format"; token.key_prefix = "--"; token.label = "format of the output particle images [HDF]."; token.help = ""; token.group = "advanced"; token.is_required = False; token.default = "string"; token.restore = "string"; token.type = "string"; sxcmd.token_list.append(token)
	token = SXcmd_token(); token.key_base = "norm"; token.key_prefix = "--"; token.label = "normalization processor to apply to written particle images"; token.help = ""; token.group = "advanced"; token.is_required = False; token.default = "string"; token.restore = "string"; token.type = "string"; sxcmd.token_list.append(token)
	...
	token = SXcmd_token(); token.key_base = "suffix"; token.key_prefix = "--"; token.label = "suffix which is appended to the names of output particle and coordinate files"; token.help = ""; token.group = "advanced"; token.is_required = False; token.default = "string"; token.restore = "string"; token.type = "string"; sxcmd.token_list.append(token)
	token = SXcmd_token(); token.key_base = "dbls"; token.key_prefix = "--"; token.label = "data base list storage, used by the workflow"; token.help = ""; token.group = "advanced"; token.is_required = False; token.default = "string"; token.restore = "string"; token.type = "string"; sxcmd.token_list.append(token)
	token = SXcmd_token(); token.key_base = "autoboxer"; token.key_prefix = "--"; token.label = "a key of the swarm_boxers dict in the local directory, used by the workflow"; token.help = ""; token.group = "advanced"; token.is_required = False; token.default = "string"; token.restore = "string"; token.type = "string"; sxcmd.token_list.append(token)
	token = SXcmd_token(); token.key_base = "ppid"; token.key_prefix = "--"; token.label = "set the PID of the parent process, used for cross platform PPID"; token.help = ""; token.group = "advanced"; token.is_required = False; token.default = "int"; token.restore = "int"; token.type = "string"; sxcmd.token_list.append(token)
	token = SXcmd_token(); token.key_base = "gui"; token.key_prefix = "--"; token.label = "dummy option; used in older version of e2boxer"; token.help = ""; token.group = "advanced"; token.is_required = False; token.default = False; token.restore = False; token.type = "bool"; sxcmd.token_list.append(token)
	token = SXcmd_token(); token.key_base = "verbose"; token.key_prefix = "--"; token.label = "verbose level [0-9], higner number means higher level of verboseness"; token.help = ""; token.group = "advanced"; token.is_required = False; token.default = "int"; token.restore = "int"; token.type = "string"; sxcmd.token_list.append(token)
	token = SXcmd_token(); token.key_base = "gauss_autoboxer"; token.key_prefix = "--"; token.label = "name of autoboxed file whose autoboxing parameters should be used for automatic boxing"; token.help = ""; token.group = "advanced"; token.is_required = False; token.default = "string"; token.restore = "string"; token.type = "string"; sxcmd.token_list.append(token)
	token = SXcmd_token(); token.key_base = "do_ctf"; token.key_prefix = "--"; token.label = "name of file whose ctf estimation parameters should be used for automatic ctf estimation"; token.help = ""; token.group = "advanced"; token.is_required = False; token.default = "string"; token.restore = "string"; token.type = "string"; sxcmd.token_list.append(token)
	token = SXcmd_token(); token.key_base = "cter"; token.key_prefix = "--"; token.label = "CTF estimation using cter"; token.help = ""; token.group = "advanced"; token.is_required = False; token.default = False; token.restore = False; token.type = "bool"; sxcmd.token_list.append(token)
	token = SXcmd_token(); token.key_base = "indir"; token.key_prefix = "--"; token.label = "directory containing micrographs to be processed"; token.help = ""; token.group = "advanced"; token.is_required = False; token.default = "string"; token.restore = "string"; token.type = "string"; sxcmd.token_list.append(token)
	token = SXcmd_token(); token.key_base = "nameroot"; token.key_prefix = "--"; token.label = "prefix of micrographs to be processed"; token.help = ""; token.group = "advanced"; token.is_required = False; token.default = "string"; token.restore = "string"; token.type = "string"; sxcmd.token_list.append(token)
	token = SXcmd_token(); token.key_base = "micsuffix"; token.key_prefix = "--"; token.label = "a string denoting micrograph type"; token.help = ""; token.group = "advanced"; token.is_required = False; token.default = "string"; token.restore = "string"; token.type = "string"; sxcmd.token_list.append(token)
	token = SXcmd_token(); token.key_base = "wn"; token.key_prefix = "--"; token.label = "size of window to use"; token.help = ""; token.group = "advanced"; token.is_required = False; token.default = "int"; token.restore = "int"; token.type = "ctfwin"; sxcmd.token_list.append(token)
	token = SXcmd_token(); token.key_base = "Cs"; token.key_prefix = "--"; token.label = "microscope Cs"; token.help = ""; token.group = "advanced"; token.is_required = False; token.default = "float"; token.restore = "float"; token.type = "string"; sxcmd.token_list.append(token)
	token = SXcmd_token(); token.key_base = "voltage"; token.key_prefix = "--"; token.label = "microscope voltage [KV]"; token.help = ""; token.group = "advanced"; token.is_required = False; token.default = "float"; token.restore = "float"; token.type = "string"; sxcmd.token_list.append(token)
	token = SXcmd_token(); token.key_base = "ac"; token.key_prefix = "--"; token.label = "Amplitude contrast"; token.help = ""; token.group = "advanced"; token.is_required = False; token.default = "float"; token.restore = "float"; token.type = "string"; sxcmd.token_list.append(token)
	token = SXcmd_token(); token.key_base = "kboot"; token.key_prefix = "--"; token.label = "kboot"; token.help = ""; token.group = "advanced"; token.is_required = False; token.default = "string"; token.restore = "string"; token.type = "string"; sxcmd.token_list.append(token)
	token = SXcmd_token(); token.key_base = "debug"; token.key_prefix = "--"; token.label = "debug mode"; token.help = ""; token.group = "advanced"; token.is_required = False; token.default = False; token.restore = False; token.type = "bool"; sxcmd.token_list.append(token)
	token = SXcmd_token(); token.key_base = "apix"; token.key_prefix = "--"; token.label = "pixel size [A]"; token.help = ""; token.group = "advanced"; token.is_required = False; token.default = "float"; token.restore = "float"; token.type = "apix"; sxcmd.token_list.append(token)

	sxcmd_list.append(sxcmd)

	sxcmd = SXcmd(); sxcmd.name = "sxwindow"; sxcmd.mode = ""; sxcmd.label = "Particle Windowing"; sxcmd.short_info = "Window out particles with known coordinates from a micrograph."; sxcmd.mpi_support = False; sxcmd.mpi_add_flag = False; sxcmd.category = "pipe"; sxcmd.is_submittable = True
	...
	sxcmd = SXcmd(); sxcmd.name = "sxisac"; sxcmd.mode = ""; sxcmd.label = "2D Clustering with ISAC"; sxcmd.short_info = "Iterative Stable Alignment and Clustering (ISAC) of a 2-D image stack."; sxcmd.mpi_support = True; sxcmd.mpi_add_flag = False; sxcmd.category = "pipe"; sxcmd.is_submittable = True
	...
	sxcmd = SXcmd(); sxcmd.name = "sxmeridien"; sxcmd.mode = ""; sxcmd.label = "3D Refinement"; sxcmd.short_info = "Performs 3D structure refinement."; sxcmd.mpi_support = True; sxcmd.mpi_add_flag = False; sxcmd.category = "pipe"; sxcmd.is_submittable = True
	...
	sxcmd = SXcmd(); sxcmd.name = "sx3dvariability"; sxcmd.mode = "symmetrize"; sxcmd.label = "3D Variability Preprocess"; sxcmd.short_info = "Prepare input stack for handling symmetry. "; sxcmd.mpi_support = False; sxcmd.mpi_add_flag = False; sxcmd.category = "pipe"; sxcmd.is_submittable = True
	...
	sxcmd = SXcmd(); sxcmd.name = "e2display"; sxcmd.mode = ""; sxcmd.label = "Visualise Images"; sxcmd.short_info = "visualise images with e2display."; sxcmd.mpi_support = False; sxcmd.mpi_add_flag = False; sxcmd.category = "util"; sxcmd.is_submittable = True
	token = SXcmd_token(); token.key_base = "input_image"; token.key_prefix = ""; token.label = "input image"; token.help = "can also be a list of images: "; token.group = "main"; token.is_required = False; token.default = "none"; token.restore = "none"; token.type = "any_image"; sxcmd.token_list.append(token)
	token = SXcmd_token(); token.key_base = "classmx"; token.key_prefix = "--"; token.label = "show particles in one class from a classification matrix"; token.help = ""; token.group = "advanced"; token.is_required = False; token.default = "string"; token.restore = "string"; token.type = "string"; sxcmd.token_list.append(token)
	token = SXcmd_token(); token.key_base = "classes"; token.key_prefix = "--"; token.label = "show particles associated class-averages"; token.help = ""; token.group = "advanced"; token.is_required = False; token.default = "string"; token.restore = "string"; token.type = "string"; sxcmd.token_list.append(token)
	token = SXcmd_token(); token.key_base = "pdb"; token.key_prefix = "--"; token.label = "show PDB structure"; token.help = ""; token.group = "advanced"; token.is_required = False; token.default = "string"; token.restore = "string"; token.type = "string"; sxcmd.token_list.append(token)
	...
	token = SXcmd_token(); token.key_base = "ppid"; token.key_prefix = "--"; token.label = "set the PID of the parent process, used for cross platform PPID"; token.help = ""; token.group = "advanced"; token.is_required = False; token.default = "int"; token.restore = "int"; token.type = "string"; sxcmd.token_list.append(token)
	token = SXcmd_token(); token.key_base = "verbose"; token.key_prefix = "--"; token.label = "verbose level [0-9], higher number means higher level of verboseness"; token.help = ""; token.group = "advanced"; token.is_required = False; token.default = "int"; token.restore = "int"; token.type = "string"; sxcmd.token_list.append(token)
