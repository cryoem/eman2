...
class SXMainWindow(QMainWindow): # class SXMainWindow(QWidget):
	...
	def construct_sxcmd_category_list(self):
		...
		token = SXcmd_token(); token.key_base = "eqkmeans_angle_step"; token.key_prefix = "--"; token.label = "EQK-means Angular sampling step"; token.help = "Sampling anglular step used for EQKmeans orientation constraints. "; token.group = "advanced"; token.is_required = False; token.is_locked = False; token.default = "15.0"; token.restore = "15.0"; token.type = "float"; sxcmd.token_list.append(token)
		token = SXcmd_token(); token.key_base = "eqkmeans_tilt1"; token.key_prefix = "--"; token.label = "EQK-means Lower tilting bound"; token.help = "Lower bound of sampling tilting angle (theta) used for EQKmeans orientation constraints. "; token.group = "advanced"; token.is_required = False; token.is_locked = False; token.default = "0.0"; token.restore = "0.0"; token.type = "float"; sxcmd.token_list.append(token)
		token = SXcmd_token(); token.key_base = "eqkmeans_tilt2"; token.key_prefix = "--"; token.label = "EQK-meansUpper tilting bound"; token.help = "Upper bound of sampling tilting angle (theta) used for EQKmeans orientation constraints. "; token.group = "advanced"; token.is_required = False; token.is_locked = False; token.default = "180.0"; token.restore = "180.0"; token.type = "float"; sxcmd.token_list.append(token)
