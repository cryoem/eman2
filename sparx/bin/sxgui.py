...
###		sxinfo = SXmenu_item(); sxinfo.name = "GUI Information"; sxinfo.label = "GUI Appliation Information"; sxinfo.short_info = "DUMMY STRING"
	...
	def construct_sxcmd_category_list(self):
		...
		token = SXcmd_token(); token.key_base = "path_to_output_stack"; token.key_prefix = ""; token.label = "Output stack"; token.help = "Path to output stack. "; token.group = "main"; token.is_required = True; token.is_locked = False; token.is_reversed = False; token.dependency_group = [['', '', '']]; token.default = ""; token.restore = ""; token.type = "output"; sxcmd.token_list.append(token); sxcmd.token_dict[token.key_base] = token
		token = SXcmd_token(); token.key_base = "output_directory"; token.key_prefix = ""; token.label = "Output directory"; token.help = "Folder to write statistics etc. "; token.group = "main"; token.is_required = False; token.is_locked = False; token.is_reversed = False; token.dependency_group = [['', '', '']]; token.default = "none"; token.restore = "none"; token.type = "output"; sxcmd.token_list.append(token); sxcmd.token_dict[token.key_base] = token
		...
		token = SXcmd_token(); token.key_base = "override"; token.key_prefix = "--"; token.label = "Override outputs"; token.help = "Override the output mask in case it exists already. "; token.group = "main"; token.is_required = False; token.is_locked = False; token.is_reversed = False; token.dependency_group = [['', '', '']]; token.default = False; token.restore = False; token.type = "bool"; sxcmd.token_list.append(token); sxcmd.token_dict[token.key_base] = token
