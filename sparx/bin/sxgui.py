...
#				sxcmd.widget.read_params(sxcmd.widget.gui_settings_file_path)
	...
	def add_sxcmd_widgets(self):
		...
		for sxcmd in self.sxcmd_category.cmd_list:
			...
			# sxcmd.btn.setCheckable(True) # NOTE: 2016/02/18 Toshio Moriya: With this setting, we cannot move the focus to the unchecked butttons... PyQt bug?
...
###		except ValueError:
###			# The text string cannot be converted to float. This must be special value of this option
...
#				self.apply_btn.setEnabled(True)
	...
	def convert_str_to_float_apix(self, apix_str):
		...
		try:
			...
			# The text string cannot be converted to float.
			return None
...
###		sxinfo = SXmenu_item(); sxinfo.name = "GUI Information"; sxinfo.label = "GUI Appliation Information"; sxinfo.short_info = "DUMMY STRING"
	...
	def construct_sxconst_set(self):
		...
		sxconst = SXconst(); sxconst.key = "config"; sxconst.label = "Imaging configurations"; sxconst.help = "Text containing a description of the imaging configurations of the project (type of microscope, detector, enegy filter, abbration corrector, phase plate, ..."; sxconst.register = "MY_MICROSCOPE"; sxconst.type = "int"; sxconst_set.list.append(sxconst); sxconst_set.dict[sxconst.key] = sxconst
	...
	def construct_sxcmd_category_list(self):
		...
		token = SXcmd_token(); token.key_base = "input_image_path"; token.key_prefix = ""; token.label = "Input micrograph path pattern"; token.help = "Specify input micrographs path pattern with a wild card (*) for any of Micrograph Modes. Images in BDB format cannot be used as input micrographs. As an advanced option, a particle stack file path can also be given when using --stack_mode. However, Stack Mode is not supported by sxgui. "; token.group = "main"; token.is_required = True; token.is_locked = False; token.is_reversed = False; token.default = ""; token.restore = ""; token.type = "mic_one"; sxcmd.token_list.append(token)
		token = SXcmd_token(); token.key_base = "output_directory"; token.key_prefix = ""; token.label = "Output directory"; token.help = "The CTF parameters (partres file), rotationally averaged power spectra (rotinf), and micrograph thumbnails (thumb files) will be written into this automatically created directory. The directoly cannnot be an existing one. "; token.group = "main"; token.is_required = True; token.is_locked = False; token.is_reversed = False; token.default = ""; token.restore = ""; token.type = "output"; sxcmd.token_list.append(token)
		...
		token = SXcmd_token(); token.key_base = "Cs"; token.key_prefix = "--"; token.label = "Microscope spherical aberration (Cs) [mm]"; token.help = "The spherical aberration (Cs) of microscope. "; token.group = "main"; token.is_required = False; token.is_locked = False; token.is_reversed = False; token.default = "2.0"; token.restore = "2.0"; token.type = "float"; sxcmd.token_list.append(token)
		token = SXcmd_token(); token.key_base = "voltage"; token.key_prefix = "--"; token.label = "Microscope voltage [kV]"; token.help = "The acceleration voltage of microscope. "; token.group = "main"; token.is_required = False; token.is_locked = False; token.is_reversed = False; token.default = "300.0"; token.restore = "300.0"; token.type = "float"; sxcmd.token_list.append(token)
		token = SXcmd_token(); token.key_base = "ac"; token.key_prefix = "--"; token.label = "Amplitude contrast [%]"; token.help = "The typical amplitude contrast is in the range of 7% - 14%. The value depends on the ice thickness, among other factors. "; token.group = "main"; token.is_required = False; token.is_locked = False; token.is_reversed = False; token.default = "10.0"; token.restore = "10.0"; token.type = "float"; sxcmd.token_list.append(token)
		token = SXcmd_token(); token.key_base = "f_start"; token.key_prefix = "--"; token.label = "Lowest resolution [A]"; token.help = "Lowest resolution used in the CTF estimation. If not given it will be determined automatically. "; token.group = "main"; token.is_required = False; token.is_locked = False; token.is_reversed = False; token.default = "-1.0"; token.restore = "-1.0"; token.type = "float"; sxcmd.token_list.append(token)
		token = SXcmd_token(); token.key_base = "f_stop"; token.key_prefix = "--"; token.label = "Highest resolution [A]"; token.help = "Highest resolution used in the CTF estimation. If not given it will be determined automatically. "; token.group = "main"; token.is_required = False; token.is_locked = False; token.is_reversed = False; token.default = "-1.0"; token.restore = "-1.0"; token.type = "float"; sxcmd.token_list.append(token)
		...
		token = SXcmd_token(); token.key_base = "edge_x"; token.key_prefix = "--"; token.label = "Edge x [pixels]"; token.help = "Defines micrograph exclusion margin in the x direction. This will be ignored in Stack Mode. "; token.group = "advanced"; token.is_required = False; token.is_locked = False; token.is_reversed = False; token.default = "0"; token.restore = "0"; token.type = "int"; sxcmd.token_list.append(token)
		token = SXcmd_token(); token.key_base = "edge_y"; token.key_prefix = "--"; token.label = "Edge y [pixels]"; token.help = "Defines micrograph exclusion margin in the y direction. This will be ignored in Stack Mode. "; token.group = "advanced"; token.is_required = False; token.is_locked = False; token.is_reversed = False; token.default = "0"; token.restore = "0"; token.type = "int"; sxcmd.token_list.append(token)
		...
		token = SXcmd_token(); token.key_base = "defocus_min"; token.key_prefix = "--"; token.label = "Minimum defocus search [um]"; token.help = "UNDER DEVELOPMENT! Applicable only with --vpp option. "; token.group = "advanced"; token.is_required = False; token.is_locked = False; token.is_reversed = False; token.default = "0.3"; token.restore = "0.3"; token.type = "float"; sxcmd.token_list.append(token)
		token = SXcmd_token(); token.key_base = "defocus_max"; token.key_prefix = "--"; token.label = "Maximum defocus search [um]"; token.help = "UNDER DEVELOPMENT! Applicable only with --vpp option. "; token.group = "advanced"; token.is_required = False; token.is_locked = False; token.is_reversed = False; token.default = "9.0"; token.restore = "9.0"; token.type = "float"; sxcmd.token_list.append(token)
		token = SXcmd_token(); token.key_base = "defocus_step"; token.key_prefix = "--"; token.label = "Defocus search step [um]"; token.help = "UNDER DEVELOPMENT! Applicable only with --vpp option. "; token.group = "advanced"; token.is_required = False; token.is_locked = False; token.is_reversed = False; token.default = "0.1"; token.restore = "0.1"; token.type = "float"; sxcmd.token_list.append(token)
		token = SXcmd_token(); token.key_base = "phase_min"; token.key_prefix = "--"; token.label = "Minimum phase search [degrees]"; token.help = "UNDER DEVELOPMENT! Applicable only with --vpp option. "; token.group = "advanced"; token.is_required = False; token.is_locked = False; token.is_reversed = False; token.default = "5.0"; token.restore = "5.0"; token.type = "float"; sxcmd.token_list.append(token)
		token = SXcmd_token(); token.key_base = "phase_max"; token.key_prefix = "--"; token.label = "Maximum phase search [degrees]"; token.help = "UNDER DEVELOPMENT! Applicable only with --vpp option. "; token.group = "advanced"; token.is_required = False; token.is_locked = False; token.is_reversed = False; token.default = "175.0"; token.restore = "175.0"; token.type = "float"; sxcmd.token_list.append(token)
		token = SXcmd_token(); token.key_base = "phase_step"; token.key_prefix = "--"; token.label = "Phase search step [degrees]"; token.help = "UNDER DEVELOPMENT! Applicable only with --vpp option. "; token.group = "advanced"; token.is_required = False; token.is_locked = False; token.is_reversed = False; token.default = "5.0"; token.restore = "5.0"; token.type = "float"; sxcmd.token_list.append(token)
		...
		sxcmd = SXcmd(); sxcmd.name = "sxpipe"; sxcmd.subname = "resample_micrographs"; sxcmd.mode = ""; sxcmd.subset_config = ""; sxcmd.label = "Resample Micrographs"; sxcmd.short_info = "Resample (change size) of micrographs in input directory specified by input micrograph pattern using a specified ratio. This operation changes image dimensions and thus the pixel size. It is designed to reduce the dimensions and thus increase the pixel size of micrographs collected n the super-resolution mode of the K2 direct electron detector."; sxcmd.mpi_support = True; sxcmd.mpi_add_flag = False; sxcmd.category = "sxc_cter"; sxcmd.role = "sxr_alt"; sxcmd.is_submittable = True
		...
		token = SXcmd_token(); token.key_base = "output_directory"; token.key_prefix = ""; token.label = "Output directory"; token.help = "The results will be written into an automatically-created directory. It cannot be an existing one. "; token.group = "main"; token.is_required = True; token.is_locked = False; token.is_reversed = False; token.default = ""; token.restore = ""; token.type = "output"; sxcmd.token_list.append(token)
		...
		token = SXcmd_token(); token.key_base = "fullrange"; token.key_prefix = "--"; token.label = "Set contrast to the full range of pixel values"; token.help = "By default option auto-contrast will restrict the displayed range of pixel values of 2D images, which may improve visibility of detail, but often gives an incorrect impression about data content/quality. "; token.group = "advanced"; token.is_required = False; token.is_locked = False; token.is_reversed = False; token.default = False; token.restore = False; token.type = "bool"; sxcmd.token_list.append(token)
		...
		sxcmd = SXcmd(); sxcmd.name = "sxpipe"; sxcmd.subname = "organize_micrographs"; sxcmd.mode = ""; sxcmd.subset_config = ""; sxcmd.label = "Organize Micrographs/Movies"; sxcmd.short_info = "Organize micrographs/movies by moving them from a source directory (specified by source micrographs/movies pattern) to a destination directory. Their names can be given in selecting file."; sxcmd.mpi_support = False; sxcmd.mpi_add_flag = False; sxcmd.category = "sxc_cter"; sxcmd.role = "sxr_util"; sxcmd.is_submittable = True
		token = SXcmd_token(); token.key_base = "source_micrograph_pattern"; token.key_prefix = ""; token.label = "Source micrograph/movies path pattern"; token.help = "Specify path pattern of source micrographs/movies with a wild card (*). The path pattern must be enclosed by single quotes (\') or double quotes (\"). (Note: sxgui.py automatically adds single quotes (\')). The substring at the variable part must be the same for each associated pair of micrograph/movie names. BDB files cannot be selected as source micrographs/movies. "; token.group = "main"; token.is_required = True; token.is_locked = False; token.is_reversed = False; token.default = ""; token.restore = ""; token.type = "mic_both"; sxcmd.token_list.append(token)
		...
		token = SXcmd_token(); token.key_base = "destination_directory"; token.key_prefix = ""; token.label = "Destination directory"; token.help = "The results will be written into an automatically-created directory. It cannot be an existing one. "; token.group = "main"; token.is_required = True; token.is_locked = False; token.is_reversed = False; token.default = ""; token.restore = ""; token.type = "dir"; sxcmd.token_list.append(token)
		...
		sxcmd = SXcmd(); sxcmd.name = "sxwindow"; sxcmd.subname = ""; sxcmd.mode = ""; sxcmd.subset_config = ""; sxcmd.label = "Particle Extraction"; sxcmd.short_info = "Window particles from micrographs using an existing file with particle coordinates."; sxcmd.mpi_support = True; sxcmd.mpi_add_flag = False; sxcmd.category = "sxc_window"; sxcmd.role = "sxr_pipe"; sxcmd.is_submittable = True
		token = SXcmd_token(); token.key_base = "input_micrograph_pattern"; token.key_prefix = ""; token.label = "Input micrograph path pattern"; token.help = "Specify path pattern of input micrographs with a wild card (*). The path pattern must be enclosed by single quotes (\') or double quotes (\"). (Note: sxgui.py automatically adds single quotes (\')). The substring at the variable part must be same for the associated pair of input micrograph and coordinates file. BDB files cannot be selected as input micrographs. "; token.group = "main"; token.is_required = True; token.is_locked = False; token.is_reversed = False; token.default = ""; token.restore = ""; token.type = "mic_one"; sxcmd.token_list.append(token)
		token = SXcmd_token(); token.key_base = "input_coordinates_pattern"; token.key_prefix = ""; token.label = "Input coordinates path pattern"; token.help = "Specify path pattern of input coordinates files with a wild card (*). The path pattern must be enclosed by single quotes (\') or double quotes (\"). (Note: sxgui.py automatically adds single quotes (\')). The substring at the variable part must be same for the associated pair of input micrograph and coordinates file. "; token.group = "main"; token.is_required = True; token.is_locked = False; token.is_reversed = False; token.default = ""; token.restore = ""; token.type = "params_coords_any"; sxcmd.token_list.append(token)
		token = SXcmd_token(); token.key_base = "input_ctf_params_source"; token.key_prefix = ""; token.label = "CTF parameters source"; token.help = "Specify the file produced by sxcter and by default called partres.txt. For negative stain data, enter pixel size [A/Pixels] instead. "; token.group = "main"; token.is_required = True; token.is_locked = False; token.is_reversed = False; token.default = ""; token.restore = ""; token.type = "params_cter_txt"; sxcmd.token_list.append(token)
		token = SXcmd_token(); token.key_base = "output_directory"; token.key_prefix = ""; token.label = "Output directory"; token.help = "The results will be written into an automatically-created directory. It cannot be an existing one. "; token.group = "main"; token.is_required = True; token.is_locked = False; token.is_reversed = False; token.default = ""; token.restore = ""; token.type = "output"; sxcmd.token_list.append(token)
		...
		token = SXcmd_token(); token.key_base = "limit_ctf"; token.key_prefix = "--"; token.label = "Use CTF limit filter"; token.help = "Frequency limit at which CTF cannot be properly represented given current pixel size. Higher, corrupted frequencies will be suppressed with a low-pass filter. This option has no effects when the CTER CTF File is not specified by the CTF paramters source argument. "; token.group = "advanced"; token.is_required = False; token.is_locked = False; token.is_reversed = False; token.default = False; token.restore = False; token.type = "bool"; sxcmd.token_list.append(token)
		...
		token = SXcmd_token(); token.key_base = "resample_ratio"; token.key_prefix = "--"; token.label = "Image size reduction factor (<1)"; token.help = "Use a value between 0.0 and 1.0 (excluding 0.0). The new pixel size will be automatically recalculated and stored in CTF parameters. "; token.group = "advanced"; token.is_required = False; token.is_locked = False; token.is_reversed = False; token.default = "1.0"; token.restore = "1.0"; token.type = "float"; sxcmd.token_list.append(token)
		token = SXcmd_token(); token.key_base = "check_consistency"; token.key_prefix = "--"; token.label = "Check consistency of inputs"; token.help = "Create a text file containing a list of inconsistent Micrograph ID entries (i.e. inconsist_mic_list_file.txt). "; token.group = "advanced"; token.is_required = False; token.is_locked = False; token.is_reversed = False; token.default = False; token.restore = False; token.type = "bool"; sxcmd.token_list.append(token)

		sxcmd_list.append(sxcmd)

		sxcmd = SXcmd(); sxcmd.name = "e2BDB"; sxcmd.subname = ""; sxcmd.mode = "makevstack"; sxcmd.subset_config = "fullset"; sxcmd.label = "Particle Stack"; sxcmd.short_info = "Create a 'virtual' BDB image stack by concatenating metainformation of one or more input stacks. "; sxcmd.mpi_support = False; sxcmd.mpi_add_flag = False; sxcmd.category = "sxc_window"; sxcmd.role = "sxr_pipe"; sxcmd.is_submittable = True
		token = SXcmd_token(); token.key_base = "makevstack"; token.key_prefix = "--"; token.label = "Output virtual image stack"; token.help = "Create a 'virtual' BDB image stack by concatenating metainformation of one or more input stacks. "; token.group = "main"; token.is_required = True; token.is_locked = False; token.is_reversed = False; token.default = ""; token.restore = ""; token.type = "output_BDB2d_stack"; sxcmd.token_list.append(token)
		...
		token = SXcmd_token(); token.key_base = "apix"; token.key_prefix = "--"; token.label = "Pixel size [A]"; token.help = "Angstroms per pixel. "; token.group = "main"; token.is_required = False; token.is_locked = False; token.is_reversed = False; token.default = "-1"; token.restore = "-1"; token.type = "apix"; sxcmd.token_list.append(token)
		...
		token = SXcmd_token(); token.key_base = "invert"; token.key_prefix = "--"; token.label = "Invert input contrast"; token.help = "If specified, inverts input contrast. Preferably, particles should be brigt on a dark background. "; token.group = "main"; token.is_required = False; token.is_locked = False; token.is_reversed = False; token.default = False; token.restore = False; token.type = "bool"; sxcmd.token_list.append(token)
		...
		token = SXcmd_token(); token.key_base = "allmicrographs"; token.key_prefix = "--"; token.label = "Include all micrographs in a directory"; token.help = "Include all images from micrographs folder. "; token.group = "advanced"; token.is_required = False; token.is_locked = False; token.is_reversed = False; token.default = False; token.restore = False; token.type = "bool"; sxcmd.token_list.append(token)
		token = SXcmd_token(); token.key_base = "unboxedonly"; token.key_prefix = "--"; token.label = "Include only unboxed micrographs"; token.help = "Include only image files that do not have existing box locations. "; token.group = "advanced"; token.is_required = False; token.is_locked = False; token.is_reversed = False; token.default = False; token.restore = False; token.type = "bool"; sxcmd.token_list.append(token)
		token = SXcmd_token(); token.key_base = "write_ptcls"; token.key_prefix = "--"; token.label = "Save selected particle"; token.help = "Extract selected particles from micrographs and write them to a disk file. "; token.group = "advanced"; token.is_required = False; token.is_locked = False; token.is_reversed = False; token.default = False; token.restore = False; token.type = "bool"; sxcmd.token_list.append(token)
		...
		token = SXcmd_token(); token.key_base = "ac"; token.key_prefix = "--"; token.label = "Amplitude contrast [%]"; token.help = "The typical amplitude contrast is in the range of 7% - 14%. The value depends on the ice thickness, among other factors. "; token.group = "advanced"; token.is_required = False; token.is_locked = False; token.is_reversed = False; token.default = "10.0"; token.restore = "10.0"; token.type = "float"; sxcmd.token_list.append(token)
		token = SXcmd_token(); token.key_base = "autopick"; token.key_prefix = "--"; token.label = "Perform automatic particle picking"; token.help = "Provide mode using a parameter string format ( auto_local:threshold=5.5). "; token.group = "advanced"; token.is_required = False; token.is_locked = False; token.is_reversed = False; token.default = "none"; token.restore = "none"; token.type = "string"; sxcmd.token_list.append(token)
		...
		token = SXcmd_token(); token.key_base = "output_directory"; token.key_prefix = ""; token.label = "Output directory"; token.help = "The results will be written into an automatically-created directory. It cannot be an existing one. "; token.group = "main"; token.is_required = True; token.is_locked = False; token.is_reversed = False; token.default = ""; token.restore = ""; token.type = "output"; sxcmd.token_list.append(token)
		token = SXcmd_token(); token.key_base = "selection_list"; token.key_prefix = "--"; token.label = "Micrograph/Movie selection file"; token.help = "Specify path of a text file containing a list of selected micrograph/movie names or paths. The particles associated with the micrographs/movies in this list will be processed. The file extension must be .txt. The directory path of each entry will be ignored if there are any. "; token.group = "main"; token.is_required = False; token.is_locked = False; token.is_reversed = False; token.default = "none"; token.restore = "none"; token.type = "select_mic_stack"; sxcmd.token_list.append(token)
		token = SXcmd_token(); token.key_base = "shift3d_x"; token.key_prefix = "--"; token.label = "3D x-shift [Pixels]"; token.help = "3D x-shift value. "; token.group = "main"; token.is_required = False; token.is_locked = False; token.is_reversed = False; token.default = "0"; token.restore = "0"; token.type = "int"; sxcmd.token_list.append(token)
		token = SXcmd_token(); token.key_base = "shift3d_y"; token.key_prefix = "--"; token.label = "3D y-shift [Pixels]"; token.help = "3D x-shift value. "; token.group = "main"; token.is_required = False; token.is_locked = False; token.is_reversed = False; token.default = "0"; token.restore = "0"; token.type = "int"; sxcmd.token_list.append(token)
		token = SXcmd_token(); token.key_base = "shift3d_z"; token.key_prefix = "--"; token.label = "3D z-shift [Pixels]"; token.help = "3D x-shift value. "; token.group = "main"; token.is_required = False; token.is_locked = False; token.is_reversed = False; token.default = "0"; token.restore = "0"; token.type = "int"; sxcmd.token_list.append(token)
		...
		token = SXcmd_token(); token.key_base = "input_rebox_pattern"; token.key_prefix = ""; token.label = "Input rebox path pattern"; token.help = "Specify path pattern of input rebox files with a wild card (*). The path pattern must be enclosed by single quotes (\') or double quotes (\"). (Note: sxgui.py automatically adds single quotes (\')). The substring at the variable part must be same between the associated input micrograph. "; token.group = "main"; token.is_required = True; token.is_locked = False; token.is_reversed = False; token.default = ""; token.restore = ""; token.type = "params_rebox_rbx"; sxcmd.token_list.append(token)
		token = SXcmd_token(); token.key_base = "output_directory"; token.key_prefix = ""; token.label = "Output directory"; token.help = "The results will be written into an automatically-created directory. It cannot be an existing one. "; token.group = "main"; token.is_required = True; token.is_locked = False; token.is_reversed = False; token.default = ""; token.restore = ""; token.type = "output"; sxcmd.token_list.append(token)
		token = SXcmd_token(); token.key_base = "selection_list"; token.key_prefix = "--"; token.label = "Micrograph selection file"; token.help = "Specify a name of micrograph selection list text file for Selected Micrographs Mode. The file extension must be '.txt'. Alternatively, the file name of a single micrograph can be specified for Single Micrograph Mode. "; token.group = "main"; token.is_required = False; token.is_locked = False; token.is_reversed = False; token.default = "none"; token.restore = "none"; token.type = "select_mic_one"; sxcmd.token_list.append(token)
		token = SXcmd_token(); token.key_base = "box_size"; token.key_prefix = "--"; token.label = "Particle box size [Pixels]"; token.help = "The x=y dimensions of square area to be windowed. When mic_resample_ratio &lt; 1.0, the box size is assumed to mean the one after resampling (increasing pixel size). "; token.group = "main"; token.is_required = False; token.is_locked = False; token.is_reversed = False; token.default = "256"; token.restore = "256"; token.type = "box"; sxcmd.token_list.append(token)
		token = SXcmd_token(); token.key_base = "skip_invert"; token.key_prefix = "--"; token.label = "Invert image contrast"; token.help = "Indicate if image contrast should be inverted or not. Do not invert for negative stain data. By default, the image contrast will be inverted for cryo data. "; token.group = "main"; token.is_required = False; token.is_locked = False; token.is_reversed = False; token.default = True; token.restore = True; token.type = "bool"; sxcmd.token_list.append(token)
		...
		token = SXcmd_token(); token.key_base = "output_directory"; token.key_prefix = ""; token.label = "Output directory"; token.help = "The results will be written into an automatically-created directory.. If the directory already exists, the program assumes it should operate in a restart/continuation mode. "; token.group = "main"; token.is_required = True; token.is_locked = False; token.is_reversed = False; token.default = ""; token.restore = ""; token.type = "output_continue"; sxcmd.token_list.append(token)
		token = SXcmd_token(); token.key_base = "radius"; token.key_prefix = "--"; token.label = "Particle radius [Pixels]"; token.help = "Radius of the particle (pixels). There is no default value and so a correct value has to be provided. "; token.group = "main"; token.is_required = True; token.is_locked = False; token.is_reversed = False; token.default = ""; token.restore = ""; token.type = "radius"; sxcmd.token_list.append(token)
		token = SXcmd_token(); token.key_base = "img_per_grp"; token.key_prefix = "--"; token.label = "Images per class"; token.help = "The desired number of images per class. The value is also used to define the initial number of classes K = N / img_per_grp, where N is the total number of input images. "; token.group = "main"; token.is_required = False; token.is_locked = False; token.is_reversed = False; token.default = "200"; token.restore = "200"; token.type = "int"; sxcmd.token_list.append(token)
		...
		token = SXcmd_token(); token.key_base = "xr"; token.key_prefix = "--"; token.label = "Translation search range [Pixels]"; token.help = "The translational search range. Default value is one pixel. "; token.group = "advanced"; token.is_required = False; token.is_locked = False; token.is_reversed = False; token.default = "1"; token.restore = "1"; token.type = "int"; sxcmd.token_list.append(token)
		...
		token = SXcmd_token(); token.key_base = "input_volume_path_2nd"; token.key_prefix = ""; token.label = "Second input volume path"; token.help = "Path to second input volume file containing the 3D density map. Use this option to create a mask from the volume combined two MERIDIEN halfset volumes. "; token.group = "main"; token.is_required = False; token.is_locked = False; token.is_reversed = False; token.default = "none"; token.restore = "none"; token.type = "data3d_one"; sxcmd.token_list.append(token)
		token = SXcmd_token(); token.key_base = "output_directory"; token.key_prefix = ""; token.label = "Output directory"; token.help = "The results will be written here. This directory will be created automatically and it must not exist previously. "; token.group = "main"; token.is_required = True; token.is_locked = False; token.is_reversed = False; token.default = ""; token.restore = ""; token.type = "output"; sxcmd.token_list.append(token)
		token = SXcmd_token(); token.key_base = "pixel_size"; token.key_prefix = "--"; token.label = "Output pixel size [A]"; token.help = "The original pixel size of dataset. This must be the pixel size after resampling when resample_ratio != 1.0. That is, it will be the pixel size of the output volume. "; token.group = "main"; token.is_required = True; token.is_locked = False; token.is_reversed = False; token.default = ""; token.restore = ""; token.type = "apix"; sxcmd.token_list.append(token)
		token = SXcmd_token(); token.key_base = "mol_mass"; token.key_prefix = "--"; token.label = "Molecular mass [kDa]"; token.help = "The estimated molecular mass of the target particle in kilodalton. "; token.group = "main"; token.is_required = True; token.is_locked = False; token.is_reversed = False; token.default = ""; token.restore = ""; token.type = "mass"; sxcmd.token_list.append(token)
		...
		token = SXcmd_token(); token.key_base = "resample_ratio"; token.key_prefix = "--"; token.label = "Resample ratio"; token.help = "Specify a value larger than 0.0. By default, the program does not resmaple the input volume (i.e. resample ratio is 1.0). Use this option maily to restore the original dimensions or pixel size of VIPER or R-VIPER model. Alternatively, specify the path to the output directory of an ISAC2 run. The program automatically extracts the resampling ratio used by the ISAC2 run. "; token.group = "main"; token.is_required = False; token.is_locked = False; token.is_reversed = False; token.default = "'1.0'"; token.restore = "'1.0'"; token.type = "dir"; sxcmd.token_list.append(token)
		token = SXcmd_token(); token.key_base = "box_size"; token.key_prefix = "--"; token.label = "Output box size [Pixels]"; token.help = "The x, y, and z dimensions of cubic area to be windowed from input 3D volume for output 3D volumes. This must be the box size after resampling when resample_ratio != 1.0. "; token.group = "main"; token.is_required = False; token.is_locked = False; token.is_reversed = False; token.default = "none"; token.restore = "none"; token.type = "box"; sxcmd.token_list.append(token)
		...
		token = SXcmd_token(); token.key_base = "shift3d_x"; token.key_prefix = "--"; token.label = "3D x-shift [Pixels]"; token.help = "Provide 3D x-shift corresponding to shifting the 3D volume along x-axis. "; token.group = "main"; token.is_required = False; token.is_locked = False; token.is_reversed = False; token.default = "0"; token.restore = "0"; token.type = "int"; sxcmd.token_list.append(token)
		token = SXcmd_token(); token.key_base = "shift3d_y"; token.key_prefix = "--"; token.label = "3D y-shift [Pixels]"; token.help = "Provide 3D y-shift corresponding to shifting the 3D volume along y-axis. "; token.group = "main"; token.is_required = False; token.is_locked = False; token.is_reversed = False; token.default = "0"; token.restore = "0"; token.type = "int"; sxcmd.token_list.append(token)
		token = SXcmd_token(); token.key_base = "shift3d_z"; token.key_prefix = "--"; token.label = "3D z-shift [Pixels]"; token.help = "Provide 3D z-shift corresponding to shifting the 3D volume along z-axis. "; token.group = "main"; token.is_required = False; token.is_locked = False; token.is_reversed = False; token.default = "0"; token.restore = "0"; token.type = "int"; sxcmd.token_list.append(token)
		token = SXcmd_token(); token.key_base = "invert_handedness"; token.key_prefix = "--"; token.label = "Invert handedness"; token.help = "Invert the handedness of the 3D volume. "; token.group = "main"; token.is_required = False; token.is_locked = False; token.is_reversed = False; token.default = False; token.restore = False; token.type = "bool"; sxcmd.token_list.append(token)
		...
		token = SXcmd_token(); token.key_base = "params_file"; token.key_prefix = ""; token.label = "Projection parameters"; token.help = "File containing the 3D projection parameters "; token.group = "main"; token.is_required = True; token.is_locked = False; token.is_reversed = False; token.default = ""; token.restore = ""; token.type = "params_any_txt"; sxcmd.token_list.append(token)
		token = SXcmd_token(); token.key_base = "output_folder"; token.key_prefix = ""; token.label = "Output directory"; token.help = "Output folder name "; token.group = "main"; token.is_required = True; token.is_locked = False; token.is_reversed = False; token.default = ""; token.restore = ""; token.type = "output"; sxcmd.token_list.append(token)
		...
		token = SXcmd_token(); token.key_base = "symmetry"; token.key_prefix = "--"; token.label = "Point-group symmetry"; token.help = "Symmetry - c0 creates full sphere distribution "; token.group = "main"; token.is_required = False; token.is_locked = False; token.is_reversed = False; token.default = "c1"; token.restore = "c1"; token.type = "sym"; sxcmd.token_list.append(token)
		token = SXcmd_token(); token.key_base = "pixel_size"; token.key_prefix = "--"; token.label = "Pixel size [A]"; token.help = "Pixel size of the project "; token.group = "advanced"; token.is_required = False; token.is_locked = False; token.is_reversed = False; token.default = "1.0"; token.restore = "1.0"; token.type = "apix"; sxcmd.token_list.append(token)
		token = SXcmd_token(); token.key_base = "delta"; token.key_prefix = "--"; token.label = "Angular sampling step [Degrees]"; token.help = "Angular step size in degree - Low deltas combined with low symmetry might crash your chimera session "; token.group = "advanced"; token.is_required = False; token.is_locked = False; token.is_reversed = False; token.default = "3.75"; token.restore = "3.75"; token.type = "float"; sxcmd.token_list.append(token)
		token = SXcmd_token(); token.key_base = "box_size"; token.key_prefix = "--"; token.label = "Particle box size [Pixels]"; token.help = "Box size "; token.group = "advanced"; token.is_required = False; token.is_locked = False; token.is_reversed = False; token.default = "256"; token.restore = "256"; token.type = "box"; sxcmd.token_list.append(token)
		token = SXcmd_token(); token.key_base = "particle_radius"; token.key_prefix = "--"; token.label = "Particle radius [Pixels]"; token.help = "Particle radius "; token.group = "advanced"; token.is_required = False; token.is_locked = False; token.is_reversed = False; token.default = "120"; token.restore = "120"; token.type = "int"; sxcmd.token_list.append(token)
		...
		token = SXcmd_token(); token.key_base = "dpi"; token.key_prefix = "--"; token.label = "Plot DPI"; token.help = "Dpi for the legend plot "; token.group = "advanced"; token.is_required = False; token.is_locked = False; token.is_reversed = False; token.default = "72"; token.restore = "72"; token.type = "int"; sxcmd.token_list.append(token)
		...
		sxcmd = SXcmd(); sxcmd.name = "sxheader"; sxcmd.subname = ""; sxcmd.mode = "import"; sxcmd.subset_config = ""; sxcmd.label = "Import Projection Parameters"; sxcmd.short_info = "Import projection parameters from a file created by a meridien run to header of the input stack, which required by 'Local Refinement from Stack' mode."; sxcmd.mpi_support = False; sxcmd.mpi_add_flag = False; sxcmd.category = "sxc_meridien"; sxcmd.role = "sxr_alt"; sxcmd.is_submittable = True
		...
		token = SXcmd_token(); token.key_base = "input_volume"; token.key_prefix = ""; token.label = "Input volume"; token.help = "Path to input volume file."; token.group = "main"; token.is_required = True; token.is_locked = False; token.is_reversed = False; token.default = ""; token.restore = ""; token.type = "data3d_one"; sxcmd.token_list.append(token)
