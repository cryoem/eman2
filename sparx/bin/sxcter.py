...
"""
	...
	parser.add_option("--f_start",			type="float",         default=-1.0,   help="Lowest frequency [A]: Lowest frequency to be considered in the CTF estimation. Determined automatically by default. (default -1.0)")
	parser.add_option("--f_stop",			type="float",         default=-1.0,   help="Highest frequency [A]: Highest frequency to be considered in the CTF estimation. Determined automatically by default. (default -1.0)")
