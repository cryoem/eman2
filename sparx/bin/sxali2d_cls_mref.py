...
def main():
	...
	usage = progname + " stack outdir --mf=0 --op=0 --cls=1 --ir=inner_radius --ou=outer_radius --rs=ring_step --xr=x_range --yr=y_range  --ts=translation_step --c=center --maxit=max_iter --ncls=class_num"
	parser = OptionParser(usage,version=SPARXVERSION)
	parser.add_option("--cls", type="float", default=1, help=" Classification method, 1. K-means, 2. Genetic algorithm, 3. K-means principle compoment analysis")
