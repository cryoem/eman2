...
usage = progname + " prj_stack buf_prefix vol_prefix nvol --CTF --snr=signal_noise_ratio --sym=symmetry -verbose=(0|1) --MPI"
...
bootstrap_run(prj_stack, buf_prefix, vol_prefix, nvol, options.CTF, options.snr, options.sym, options.verbose, options.MPI)
