...
"""
	...
	parser.add_option("--mask_threshold",       type="float",         default=5.0,                   help="the threshold (number of sigmas of summed two halves ) for adaptive_mask (effective only with --do_adaptive_mask)")
