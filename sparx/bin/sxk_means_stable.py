...
def main():
	...
	if len(args) < 2 or len(args) > 3:
		...
		if options.MPI:
			...
			'''if options.CUDA:
				pass#IMPORTIMPORTIMPORT from  development import  k_means_stab_MPICUDA_stream_YANG
			...
			pass#IMPORTIMPORTIMPORT from  statistics import  k_means_stab_MPI_stream
			...
			'''if options.CUDA:
				pass#IMPORTIMPORTIMPORT from  development  import  k_means_stab_CUDA_stream
			...
			pass#IMPORTIMPORTIMPORT from  statistics  import  k_means_stab_stream
