...
def main():
	...
	usage = progname + " stack outdir <maskfile> --ir=inner_radius --ou=outer_radius --rs=ring_step --xr=x_range --yr=y_range  --ts=translation_step --center=center --maxit=max_iter --CTF --snr=SNR --function=user_function_name"
