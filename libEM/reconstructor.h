...
//		FourierPixelInserter3D* inserter;
	...
	/** rel_nn4_ctfw Direct Fourier Weighted Inversion Reconstructor
     *
     */
	class rel_nn4_ctfwReconstructor:public Reconstructor
	{
	  public:
		rel_nn4_ctfwReconstructor();

		rel_nn4_ctfwReconstructor( const string& symmetry, int size, int npad, float snr, int sign );

		virtual ~rel_nn4_ctfwReconstructor();
		...
		*/
		...
		static Reconstructor *NEW()
		{
			return new rel_nn4_ctfwReconstructor();
		}
