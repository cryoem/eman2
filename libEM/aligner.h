...
namespace EMAN
{
	...
	{
	  public:
		EMData * align(EMData * this_img, EMData * to_img, const string & cmp_name = "FRC") const;
	...
	{
	  public:
		EMData * align(EMData * this_img, EMData * to_img, const string & cmp_name = "Variance") const;
