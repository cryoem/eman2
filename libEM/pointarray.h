...
namespace EMAN
{
	...
	class PointArray
	{
		...
		void set_from(PointArray * source, string sym = "", Transform &transform=Transform());
		void set_from(double *source, unsigned int num, string sym = "", Transform &transform=Transform());
