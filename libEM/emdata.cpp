...
EMData::EMData() :
#ifdef EMAN2_USING_CUDA
		cuda_array_handle(-1), cuda_pointer_handle(-1),
#endif //EMAN2_USING_CUDA
...
#ifdef EMAN2_USING_CUDA
		cuda_array_handle(-1), cuda_pointer_handle(0),
#endif //EMAN2_USING_CUDA
...
// 	}
	...
	EMData *clipped = get_clip(r1,get_edge_mean());
// 	EMData *clipped = copy()
