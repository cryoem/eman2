...
EMData *EMData::make_rotational_footprint( bool unwrap)
{
	...
	// as advised by Steve Ludtke - indeed, this caching doubles metric
	// generated by e2speedtest, which implies that classification is twice as fast.
	if ( rot_fp != 0 && unwrap == true) return new EMData(*rot_fp);
