...
// 				assert_consistent_type(THREED); // Transform does the assertion
			...
			*/
			...
			//static Transform icos_2_to_5();
			
			/** Get the transform that moves any icosahedron
			 * generated by eman2 so that it matches the 2-2-2 (MRC, FREALIGN) convention
			 * @return a Transforms, alt=58.28..., az=270
			*/
