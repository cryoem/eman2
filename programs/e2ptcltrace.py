...
"""
	...
	if options.eman1data != None:
		...
		if options.sym != "c1":
			...
			good_data.write("#e2ptcltrace.py data file\n")
			detect_convergence(options.convergence,options.dtheta,orienttracedata,cd,good,good_data,od)
			good.close()
			good_data.close()
...
def detect_convergence(converge,dtheta,data,classdata,good,good_data,optional=None):
