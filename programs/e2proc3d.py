...
def parse_infile(infile):
	...
	if ( nimg > 1 ):
		print "it appears as though %s contains more than one image" %infile
		data = EMData()
		data.read_image(infile, 0)
		...
		if ( z == 1 ):
			...
			for i in range(0,nimg):
				data.read_image(infile,i)
				print i, nimg
				return_data.insert_clip(data, (0,0,i) )
				
			return return_data
		else :
			print "Error, cannot operate on a stack of 3D images" 
			exit(1)
	else:
		data = EMData()
