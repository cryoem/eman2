...
def main():
	...
	parser.add_argument("--initgaus",type=int,help="Gaussians in the first pass, scaled with stage, default=250", default=250)
	...
	tf_set_device(dev=0,maxmem=args.gpuram)
...
def optimize_g(gaus,projsf,orts,txty):
	"""Performs an optimization cycle, updating the passed Gaussians object (gaus). Must provide Fourier transforms of the
	projections/particles to optimize against and the Orientations/txty array."""
