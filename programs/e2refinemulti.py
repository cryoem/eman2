...
"""
	...
	parser.add_argument("--input", dest="input", default=None,type=str, help="The name of the image file containing the particle data", guitype='filebox', row=0, col=0, rowspan=1, colspan=3)
	parser.add_argument("--models", dest="models", type=str,default="threed.0a.mrc", help="A comma separated list of initial 3-D models for refinement", guitype='filebox', row=5, col=0, rowspan=1, colspan=3)
