...
"""
	...
	parser.add_option("--input", dest="input", default=None,type="string", help="The name of the image file containing the particle data")
	parser.add_option("--models", dest="models", type="string",default="threed.0a.mrc", help="A comma separated list of initial 3-D models for refinement")
	...
	parser.add_option("--path", default=None, type="string",help="The name of a directory where results are placed. If unspecified will generate one automatically of type multi_??.")
	...
	parser.add_option("--sym", dest = "sym", help = "Specify symmetry - choices are: c<n>, d<n>, h<n>, tet, oct, icos. Optionally specify a comma separated list to specify per-model symmetry.")
