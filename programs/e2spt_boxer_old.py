...
def main():
	...
	parser.add_argument("--boxsize",type=int,default=0,help="Default=0. Used to extract particles without the GUI. Requires --coords. Box size in pixels",guitype='intbox',row=4, col=0, rowspan=1, colspan=1, mode="coords")
