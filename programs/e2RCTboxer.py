...
"""
	...
	parser.add_argument("--shrink", type=int, help="Shrink the images by an integer, uses math.meanshrink", default = 0, guitype='intbox', row=6, col=2, rowspan=1, colspan=1, mode="extraction")
