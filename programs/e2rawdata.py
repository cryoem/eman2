...
#	parser.add_argument("--inplace",action="store_true",help="Do processing inplace",default=False, guitype='boolbox', row=4, col=0, rowspan=1, colspan=1, mode='filter[True]')
