...
def main():
	...
	parser.add_option("--alignrcmp",type="string",help="The name and parameters of the comparitor used by the second stage (\'--alrignr\') aligner. See \'e2help.py cmp\'. An example is \'--alignecmp=phase\'. Default is dot.",default="dot:normalize=1")
