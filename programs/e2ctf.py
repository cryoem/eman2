...
images far from focus."""
	...
	parser.add_pos_argument(name="particles",help="List the file to process with e2ctf here.", default="", guitype='filebox', browser="EMParticlesTable(withmodal=True,multiselect=True)", positional=True, row=0, col=0,rowspan=1, colspan=2, mode='autofit,tuning,genoutp,gensf')
	...
	parser.add_argument("--computesf",action="store_true",help="Will determine the structure factor*envelope for the aggregate set of images", default=True, guitype='boolbox', row=3, col=0, rowspan=1, colspan=1, mode="gensf")
