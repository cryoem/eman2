...
#	parser.add_header(name="ctfheader", help='Options below this label are specific to e2ctflassaverage3d', title="### e2ctf options ###", default=None, row=1, col=0, rowspan=1, colspan=2, mode="autofit,tuning,genoutp,gensf")
	...
	parser.add_argument("--phaseflipproc",help="Optionally specify a --process style processor to be applied after phase flipping. Useful for masking, etc.",default=None, guitype='strbox', row=6, col=0, rowspan=1, colspan=3, mode='genoutp[filter.lowpass.gauss:cutoff_freq=.07]')
	parser.add_argument("--phaseflipproc2",help="Optionally specify a second --process style processor to be applied after phase flipping. Useful for masking, etc.",default=None, guitype='strbox', row=7, col=0, rowspan=1, colspan=3, mode='genoutp[filter.highpass.gauss:cutoff_freq=.005]')
	parser.add_argument("--phaseflipproc3",help="Optionally specify a third --process style processor to be applied after phase flipping. The 3 are applied sequentially.",default=None, guitype='strbox', row=8, col=0, rowspan=1, colspan=3, mode='genoutp[math.meanshrink:n=2]')
