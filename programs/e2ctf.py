...
images far from focus."""
	...
	parser.add_argument("--apix",type=float,help="Angstroms per pixel for all images",default=0, guidefault='self.pm().getAPIX()', guitype='floatbox', row=3, col=0, rowspan=1, colspan=1, mode='autofit')
	parser.add_argument("--voltage",type=float,help="Microscope voltage in KV",default=0, guidefault='self.pm().getVoltage()', guitype='floatbox', row=3, col=1, rowspan=1, colspan=1, mode='autofit')
	parser.add_argument("--cs",type=float,help="Microscope Cs (spherical aberation)",default=0, guidefault='self.pm().getCS()', guitype='floatbox', row=4, col=0, rowspan=1, colspan=1, mode='autofit')
