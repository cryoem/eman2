...
"""
	...
	parser.add_argument("--force",action="store_true",default=False,help="This will force an action that would normally fail due to failed checks.")
	parser.add_argument("--delete",action="store_true",default=False,help="This will delete (or at least empty) the named database(s)")
	parser.add_argument("--all",action="store_true",help="List per-particle info",default=False)
	parser.add_argument("--long",action="store_true",help="Long listing",default=False)
	parser.add_argument("--short",action="store_true",help="Dense listing of names only",default=False)
	...
	parser.add_argument("--dump",action="store_true",help="List contents of an entire database, eg 'e2bdb.py -D refine_01#register",default=False)
