...
def main():
	...
	parser.add_option("--path", default=None, type="string",help="The name of a directory where results have been generated by e2refine.py.")
	...
	if error:
		...
		db = db_open_dict("bdb:"+options.path+"#eotest.results")
		db[options.iteration+"_fsc"] = [xaxis,plot]
		db[options.iteration+"_fsc_error"] = [xaxis,error]
		db_close_dict("bdb:"+options.path+"#eotest.results")
