...
"""
	...
	parser.add_argument("--targetres", default=25.0, type=float,help="Target resolution in A of this refinement run. Do not be overoptimistic.", guitype='floatbox', row=10, col=0, rowspan=1, colspan=1, mode="refinement")
