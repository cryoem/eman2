...
"""
	...
	parser.add_argument("--focused", dest = "focused", default=None,help = "Highly experimental, and under development! Specify a 3-D mask to apply to the volume before projection. Focuses refinement on a specific portion of the structure. Incompatible with symmetry.", guitype='filebox', row=29, col=0, rowspan=1, colspan=3, mode="refinement")
