...
so in most cases it is not dealt with.'
	...
	if SIZE==96:
		...
		print 'An Intel Xeon E5645 2.4Ghz SF ----------------------------------- 3660 (6 cores -> 22,000)'
		print 'An Intel Xeon X5675 3.07Ghz SF ---------------------------------- 4170 (6 cores -> 25,000)'
		print 'An Intel Core i5-2500 3.30GHz (depends on turbo) ---------------- 5600 - 6300 (4 cores -> 22,400 - 25,200)'
		print 'An Intel Core i7-3960X 3.3Ghz SF -------------------------------- 6100 - 6600 (6 cores -> 36,600 - 39,600)'
		print 'An Intel Xeon E5-2670 2.6Ghz SF --------------------------------- 4900 (8 cores -> 39,200)'
		print '\nConsider using --big for a more representative value with modern high resolution maps'

	if SIZE==256:
		print 'For comparison (note these numbers are PER CORE. ie - for a quad core machine -> x4)'
		print 'An Intel Xeon E5645 2.4Ghz SF ----------------------------------- 580         (6 cores -> 3500)'
		print 'An Intel Core i5-2500 3.30GHz (depends on turbo) ---------------- 980 - 1180  (4 cores -> 3900 - 4700)'
		print 'An Intel Xeon X5675 3.07Ghz SF ---------------------------------- 770         (6 cores -> 4600)'
		print 'An Intel Xeon E5-2670 2.6Ghz SF --------------------------------- 780	     (8 cores -> 6240)'
		print 'An Intel Core i7-3960X 3.3Ghz SF -------------------------------- 1050 - 1260 (6 cores -> 6300 - 7560)'
