...
def main():
	...
	parser.add_argument("--box", type=int, help="size in pixels of the power spectra", default=256)
	parser.add_argument("--norm", dest="norm", action="store_true", help="Normalize the image before analysis")
