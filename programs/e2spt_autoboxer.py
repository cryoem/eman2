...
def main():
	...
	usage = """WARNING:  **PRELIMINARY** program, still heavily under development. 
				...
				are 'white'; which means you have to provide the tomogram with inverted (or 'white') contrast, --inverttomo is available for this purpose,
				and the same goes for any stacks provided (specimen particles, gold, carbon and/or background)."""
