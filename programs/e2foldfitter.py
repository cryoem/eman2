...
#	print (pdim2[0]-tdim2[0])/2,(pdim2[1]-tdim2[1])/2,(pdim2[2]-tdim2[2])/2,tdim2[0],tdim2[1],tdim2[2]
	probe.filter("eman1.normalize.edgemean")
...
#			prr.write_image('prr.%0d%0d%0d.mrc'%(a1,a2,a3))
			...
			ccf.filter("eman1.mask.zeroedge3d",{"x0":edge,"x1":edge,"y0":edge,"y1":edge,"z0":edge,"z1":edge})
			sum+=ccf
			ccf.filter("eman1.mask.onlypeaks",{"npeaks":0})		# only look at peak values in the CCF map
...
#		if not i[7]: best2.append(i)
	...
	sum.filter("eman1.mask.onlypeaks",{"npeaks":0})
