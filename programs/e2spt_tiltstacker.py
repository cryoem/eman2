...
#====================
#Author: Jesus Galaz-Montoya 2/20/2013 , Last update: March/12/2014
#====================
...
def main():
	...
	The options should be supplied in "--option=value", 
	...
	parser.add_argument("--input", type=str, help=""".hdf, 3D .st or .mrc file to unstack 
		(must also specify --unstack) or string common to all the files to put into an .st (MRC) stack; for example,
	...
	parser.add_argument("--clip",type=int,default=0,help="""This will clip the specified number
		of pixels from ALL the edges of each image (top, bottom, left and right).
		Only works for stacking; therefore, it does nothing if --unstack is specified.""")
