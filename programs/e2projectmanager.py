...
class PMGUIWidget(QtWidgets.QScrollArea):
	...
	def __init__(self, options, program, pm, mode):
		...
		self.scwidget.setMinimumWidth(int(self.width()-1.5*self.verticalScrollBar().width()))
		self.scwidget.setMaximumWidth(int(self.width()-1.5*self.verticalScrollBar().width()))
