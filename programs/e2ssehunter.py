...
def main():
	...
	parser.add_argument("--atoms", type=str, help="pseudoatoms file", default="none")
	parser.add_argument("--atomswt", type=float, help="pseudoatom weight", default=1.0)
	parser.add_argument("--coeff", type=str,help="helix correlation file",default="none")
	parser.add_argument("--coeffwt", type=float,help="helix correlation weight",default=1.0)
	parser.add_argument("--skeleton", type=str,help="skeleton file",default="none")
#	parser.add_argument("--sketype", type=str,help="skeleton type",default="none")
	parser.add_argument("--skeletonwt", type=float,help="skeleton weight",default=1.0)
	parser.add_argument("--helixlength", type=float,help="helix length om angstroms",default=16.2)
	parser.add_argument("--da", type=float,help="helix angular search step",default=5.0)
