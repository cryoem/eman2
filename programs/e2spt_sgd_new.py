...
def main():
	...
	parser.add_argument("--niter", type=int,help="iterations", default=100, guitype='intbox',row=10, col=0,rowspan=1, colspan=1, mode="model")
	parser.add_argument("--parallel","-P",type=str,help="Run in parallel, specify type:<option>=<value>:<option>=<value>. See http://blake.bcm.edu/emanwiki/EMAN2/Parallel",default="thread:8", guitype='strbox', row=30, col=0, rowspan=1, colspan=2, mode="model[thread:8]")
	parser.add_argument("--shrink", type=int,help="shrink", default=1, guitype='intbox',row=11, col=1,rowspan=1, colspan=1, mode="model")
	parser.add_argument("--batch", type=int,help="batch size", default=12,guitype='intbox',row=10, col=1,rowspan=1, colspan=1, mode="model")
	parser.add_argument("--ncls", type=int,help="number of classes", default=1,guitype='intbox',row=10, col=1,rowspan=1, colspan=1, mode="model")
	...
	parser.add_argument("--learnrate", type=float,help="learning rate, default 0.2", default=.2,guitype='floatbox',row=9, col=1,rowspan=1, colspan=1, mode="model")
	parser.add_argument("--res", type=float,help="target resolution", default=50,guitype='floatbox',row=9, col=1,rowspan=1, colspan=1, mode="model")
	parser.add_argument("--ref", type=str,help="Reference volume, not required. default=none", default=None,guitype='filebox', browser="EMBrowserWidget(withmodal=True,multiselect=False)", row=2, col=0,rowspan=1, colspan=2, mode="model")
	parser.add_argument("--sym", type=str,help="symmetry. Only c1 unless --ref used", default="c1",guitype='strbox',row=4, col=0,rowspan=1, colspan=1, mode="model")
