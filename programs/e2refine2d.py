...
#	parser.add_option("--simcmp",type="string",help="The name of a 'cmp' to be used in comparing the aligned images (default=dot:normalize=1)", default="dot:normalize=1")
	...
	parser.add_option("--classkeep",type="float",default=0.75,help="The fraction of particles to keep in each class, based on the similarity score generated by the --cmp argument.")
	...
	parser.add_option("--classiter", default=2, type="int", help="Number of iterations when making class-averages")
...
#		except: pass
		...
		cls_cmd = "e2classaverage.py --input=%s --classmx=%s#classmx_00 --output=%s#classes_init --iter=6 " %(options.input,options.path,options.path)
