...
def main():
	...
	parser.add_argument("--centeracf", default=False, action="store_true",help="This will use an alternative centering algorithm, which may work better with negative stain data. Alternative to --automask.")
