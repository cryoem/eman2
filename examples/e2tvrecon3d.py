...
def main():
	...
	parser.add_argument("--numpy",action="store_true",default=False, help="If specified, the program will utilize numpy for 'tilt stack' generation. This is for the sake of testing. It will NOT be a long-term option.")
	...
	if options.numpy:
		if options.verbose > 2: print "Generating %i tiltstacks via Numpy methods..."%(ysize)
		tiltstacks = get_numpy_tiltstacks( options, xsize, ysize )
	else:
		if options.verbose > 2: print "Generating %i tiltstacks via EMAN2 methods..."%(ysize)
		tiltstacks = get_numpy_tiltstacks( options, xsize, ysize )
...
# FILE/DIRECTORY NAMING UTILITIES
