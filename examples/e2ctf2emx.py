...
for f in sorted(argv[1:]):
	...
	print('<defocusU unit="nm">{:1.3f}</defocusU>'.format(1000.0*(ctf.defocus+old_div(ctf.dfdiff,2.0))))
	print('<defocusV unit="nm">{:1.3f}</defocusV>'.format(1000.0*(ctf.defocus-old_div(ctf.dfdiff,2.0))))
