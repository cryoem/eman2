...
'''
====================
Author: Jesus Galaz-Montoya - 02/March/2013, Last update: 06/2023
====================
			...
			for axis in axes_dict:
				...
				if options.nslices > 1 or options.allx or options.ally or options.allz:
					...
					if options.allx and axis == 'x':
						...
						runcmd(options,'e2proc2d.py ' + rotvolxname + ' ' + outname + ' --threed2twod --writejunk && cd ' + options.path + ' && rm tmp*')
					if options.ally and axis == 'y':
						...
						runcmd(options,'e2proc2d.py ' + rotvolyname + ' ' + outname + ' --threed2twod --writejunk && cd ' + options.path + ' && rm tmp*')
					if options.allz and axis == 'z':
						...
						runcmd(options,'e2proc2d.py ' + f + ' ' + outname + ' --threed2twod --writejunk && cd ' + options.path + ' && rm tmp*')
