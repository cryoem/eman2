...
e2rawdata.py orig_micrographs/* --edgenorm --xraypixel --ctfest --apix=1.275 --voltage=300.0 --cs=2.7 --ac=10.0 --threads=32 --defocusmin=0.6 --defocusmax=4.0
...
e2initialmodel.py --input=r2db_01/classes_sort_00.hdf --iter=12 --tries=30 --shrink=4 --sym=d2 --automaskexpand=-1 --parallel=thread:32
...
e2refine_easy.py --input=sets/all__ctf_flip_fullres.lst --model=refine_01/threed_04.hdf --targetres=8.0 --speed=5 --sym=d2 --iter=4 --mass=400.0 --invar --apix=0.0 --classkeep=0.9 --m3dkeep=0.8 --parallel=thread:32 --threads=32 --automaskexpand=-1 --ampcorrect=auto
