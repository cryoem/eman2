...
{
	EMData * e = new EMData();
	const char * img1 = TestUtil::get_debug_image("search.dm3");
	e->read_image(img1);
...
{
	EMData * e = new EMData();
	const char * img1 = TestUtil::get_debug_image("x.hed");
	...
	const char * img2 = TestUtil::get_debug_image("square288.mrc");
