...
{
	EMData * e = new EMData();
	string img1 = TestUtil::get_debug_image("x.hed");
	...
	e2->read_image(TestUtil::get_debug_image("square288.mrc"), 0);
...
{
	EMData * e = new EMData();
	e->read_image(TestUtil::get_debug_image("square288.mrc"));
...
void insert_beyond_existing_file()
{
	...
	EMData * e2 = new EMData();
	string img2 = TestUtil::get_debug_image("square288.mrc");
