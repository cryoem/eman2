...
try:
    pass#IMPORTIMPORTIMPORT from PyQt4.QtCore import QObject, pyqtSignal, pyqtSlot, QThread, QString, QThreadPool, QTimer
    pass#IMPORTIMPORTIMPORT from PyQt4 import QtCore, QtGui
    pass#IMPORTIMPORTIMPORT from PyQt4.QtGui import QDialog, QGridLayout, QTreeWidget, QMessageBox, QFontMetrics, QMainWindow, QApplication, QWidget, QDesktopWidget, QAction, QFileDialog, QTreeWidgetItem,QVBoxLayout
    from matplotlib.backends.backend_qt4agg import FigureCanvasQTAgg as FigureCanvas
    from matplotlib.backends.backend_qt4agg import NavigationToolbar2QT as NavigationToolbar

except ImportError:
    pass#IMPORTIMPORTIMPORT from PyQt5 import QtCore, QtGui, QtWidgets
    pass#IMPORTIMPORTIMPORT from PyQt5.QtGui import  QFontMetrics
    pass#IMPORTIMPORTIMPORT from PyQt5.QtCore import QObject, pyqtSignal, pyqtSlot, QThread, QThreadPool, QTimer
    pass#IMPORTIMPORTIMPORT from PyQt5.QtWidgets import QDialog, QGridLayout, QTreeWidget, QMessageBox, QMainWindow, QApplication, QWidget, QDesktopWidget, QAction, QFileDialog, QTreeWidgetItem,QVBoxLayout
...
class MainWindow(PyQt5.QtWidgets.QMainWindow):
    ...
    def __init__(self, font, parent=None):
        ...
        create_new_overview_plot = PyQt5.QtWidgets.QAction('&New resolution overview plot', self)
    ...
    def open_refinement_folder(self):
        ...
        :return: none
        """
        self.refinement_folder = str(PyQt5.QtWidgets.QFileDialog.getExistingDirectory(self, "Select Refinement Directory"))
