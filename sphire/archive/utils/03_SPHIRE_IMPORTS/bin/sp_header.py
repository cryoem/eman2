...
def main():
	...
	if len(args) != 1 :
		...
		sp_global_def.ERROR( "Invalid number of parameters provided. Please see usage information above." )
		return

	if options.params == None:
		sp_global_def.sxprint( "Usage: " + usage )
		sp_global_def.ERROR( "No parameters provided. Please see usage information above." )
		return
