...
def filt_vols( vols, fscs, mask3D ):
	...
	pass#IMPORTIMPORTIMPORT from sp_filter        import fit_tanh, filt_tanl, filt_table
...
def filterlocal(ui, vi, m, falloff, myid, main_node, number_of_proc):
	...
	pass#IMPORTIMPORTIMPORT from sp_utilities import bcast_number_to_all, bcast_list_to_all, model_blank, bcast_EMData_to_all, reduce_EMData_to_root
	pass#IMPORTIMPORTIMPORT from sp_morphology import threshold_outside
	pass#IMPORTIMPORTIMPORT from sp_filter import filt_tanl
	pass#IMPORTIMPORTIMPORT from sp_fundamentals import fft, fftip
