...
from sp_utilities import if_error_then_all_processes_exit_program, write_text_row, drop_image, model_gauss_noise, \
	get_im, set_params_proj, wrap_mpi_bcast, model_circle, bcast_number_to_all
...
"""
	...
	parser.add_option("--moon_elimination", type="string", default='',
	...
	from sp_multi_shc import multi_shc
	out_params, out_vol, out_peaks = multi_shc(all_projs, subset, runs_count, options, mpi_comm=mpi.MPI_COMM_WORLD,
											   log=log)
