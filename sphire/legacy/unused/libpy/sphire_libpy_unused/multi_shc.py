...
def Xali3d_multishc(stack, ref_vol, ali3d_options, mpi_comm = None, log = None, number_of_runs=2 ):
	...
	pass#IMPORTIMPORTIMPORT from utilities    import model_circle, get_input_from_string, get_params_proj, set_params_proj, wrap_mpi_gatherv, wrap_mpi_bcast, wrap_mpi_send, wrap_mpi_recv
	pass#IMPORTIMPORTIMPORT from mpi          import mpi_bcast, mpi_comm_size, mpi_comm_rank, MPI_FLOAT, MPI_COMM_WORLD, mpi_barrier, mpi_comm_split, mpi_comm_free
...
def ali3d_base(stack, ref_vol = None, ali3d_options = None, shrinkage = 1.0, mpi_comm = None, log = None, nsoft = 3, \
	...
	pass#IMPORTIMPORTIMPORT from alignment       import Numrinit, prepare_refrings, proj_ali_incore,  proj_ali_incore_local, shc, center_projections_3D
...
def volume_reconstruction(data, options, mpi_comm):
	...
	pass#IMPORTIMPORTIMPORT from utilities import bcast_EMData_to_all, model_circle
...
def shc_multi(data, refrings, numr, xrng, yrng, step, an, nsoft, sym, finfo=None):
	pass#IMPORTIMPORTIMPORT from utilities    import compose_transform2
	pass#IMPORTIMPORTIMPORT from fundamentals import mirror
...
def ali3d_multishc_soft(stack, ref_vol, ali3d_options, mpi_comm = None, log = None, nsoft=2 ):
	...
	pass#IMPORTIMPORTIMPORT from alignment       import Numrinit, prepare_refrings, proj_ali_incore_local
	pass#IMPORTIMPORTIMPORT from utilities       import get_im, file_type, model_circle, get_input_from_string, get_params_proj, wrap_mpi_gatherv, wrap_mpi_bcast
	pass#IMPORTIMPORTIMPORT from mpi             import mpi_bcast, mpi_comm_size, mpi_comm_rank, MPI_FLOAT, MPI_COMM_WORLD, mpi_barrier, mpi_reduce, MPI_INT, MPI_SUM
	pass#IMPORTIMPORTIMPORT from projection      import prep_vol
	pass#IMPORTIMPORTIMPORT from statistics      import hist_list
	pass#IMPORTIMPORTIMPORT from applications    import MPI_start_end
