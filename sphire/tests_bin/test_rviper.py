...
#todo adapt this path after copying the necessary files to the image
ABSOLUTE_PATH_TO_SPHIRE_DEMO_RESULTS_FOLDER_NEW = "/home/lusnig/Downloads/SphireDemoResults"
...
ABSOLUTE_SPHIRE_PATH= ABSOLUTE_PATH.split("/tests_bin")[0]
...
class Test_Error_cases(unittest.TestCase):
    ...
    @unittest.skip("unskip it after copy ABSOLUTE_PATH_TO_SPHIRE_DEMO_RESULTS_FOLDER_NEW")
