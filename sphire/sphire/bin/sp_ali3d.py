...
def main():
	...
	if len(args) < 3 or len(args) > 4:
		...
		if(options.ns):
			...
			from ..libpy.sp_development import  ali3d_saturn
			...
			sp_global_def.BATCH = True
			from ..libpy.sp_development import  ali3d_saturn2
			...
			if not options.MPI:
				...
				sp_global_def.BATCH = True
				if(options.nsoft == 1):
					from ..libpy.sp_applications import ali3d_shcMPI
					...
					from ..libpy.sp_applications import ali3d_shc0MPI
...
from ..libpy import sp_user_functions
			...
			sp_global_def.BATCH = True
			from ..libpy.sp_development import ali3d_shc2
			...
			from ..libpy.sp_applications import ali3dpsi_MPI
			sp_global_def.BATCH = True
			...
			if options.rantest:
				from ..libpy.sp_development import ali3d_rantest
				sp_global_def.BATCH = True
				...
				from ..libpy.sp_applications import ali3d
				sp_global_def.BATCH = True
