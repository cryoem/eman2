...
from ..libpy.sp_global_def import sxprint, ERROR, SPARX_MPI_TAG_UNIVERSAL
...
from ..libpy.sp_applications import MPI_start_end, within_group_refinement, ali2d_ras
from ..libpy.sp_pixel_error  import multi_align_stability
from ..libpy.sp_utilities    import send_EMData, recv_EMData
from ..libpy.sp_utilities    import get_image, bcast_number_to_all, set_params2D, get_params2D
from ..libpy.sp_utilities    import group_proj_by_phitheta, model_circle, get_input_from_string
...
def main():
	...
	#   Compute stability per projection projection direction, equal number assigned, thus overlaps
		...
		from ..libpy.sp_utilities import even_angles, nearestk_to_refdir, getvec
	...
	#   Compute stability per projection
		...
		sxprint("  C  ",myid,"  ",time()-st)
		from ..libpy.sp_utilities import nearest_proj
	...
	from ..libpy.sp_utilities import get_params_proj, read_text_file
	#if myid == 0:
