...
def run():
	...
	if len(args) < 2 or len(args) > 3:
		...
		from ..libpy.sp_applications import ali2d_rotationaltop
		...
		sp_global_def.BATCH = True
		if  options.MPI:
			from ..libpy.sp_applications import ali2d_base
			...
			if(myid == main_node):
				...
				outcome = 0
				log = None
			from ..libpy.sp_utilities       import bcast_number_to_all
			...
			"""
			from ..libpy.sp_applications import ali2d
