...
pass#IMPORTIMPORTIMPORT from mpi import MPI_SUM, mpi_reduce, mpi_init, mpi_finalize, MPI_COMM_WORLD, mpi_comm_rank, mpi_comm_size, mpi_barrier, \
...
pass#IMPORTIMPORTIMPORT from utilities import get_im, string_found_in_file, get_latest_directory_increment_value, store_value_of_simple_vars_in_json_file
pass#IMPORTIMPORTIMPORT from utilities import cmdexecute, if_error_then_all_processes_exit_program
pass#IMPORTIMPORTIMPORT from utilities import read_text_row, read_text_file, write_text_file, write_text_row, getindexdata#, print_program_start_information
pass#IMPORTIMPORTIMPORT from multi_shc import find_common_subset, do_volume, multi_shc
...
def calculate_list_of_independent_viper_run_indices_used_for_outlier_elimination(no_of_viper_runs_analyzed_together, 
	...
	pass#IMPORTIMPORTIMPORT from utilities import combinations_of_n_taken_by_k
...
def calculate_volumes_after_rotation_and_save_them(ali3d_options, rviper_iter, masterdir, bdb_stack_location, mpi_rank, mpi_size,
	...
	if( mpi_rank == 0):
		...
		pass#IMPORTIMPORTIMPORT from utilities import get_params3D, set_params3D, get_im, model_circle
