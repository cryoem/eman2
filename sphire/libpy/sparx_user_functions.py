...
def ref_ali2d_m( ref_data ):
	pass#IMPORTIMPORTIMPORT from sparx_utilities    import print_msg
	pass#IMPORTIMPORTIMPORT from filter       import fit_tanh, filt_tanl
	pass#IMPORTIMPORTIMPORT from sparx_utilities    import center_2D
	#  Prepare the reference in 2D alignment, i.e., low-pass filter and center.
	#  Input: list ref_data
	#   0 - mask
	#   1 - center flag
...
def ref_ali3dm( refdata ):
	pass#IMPORTIMPORTIMPORT from filter import fit_tanh, filt_tanl
	pass#IMPORTIMPORTIMPORT from sparx_utilities import get_im
...
def ref_ali3dm_ali_50S( refdata ):
	...
	for iref in range(numref):
		...
		if ali50s:
			pass#IMPORTIMPORTIMPORT from sparx_utilities    import get_params3D, set_params3D, combine_params3
...
def spruce_up( ref_data ):
	...
	nx = volf.get_xsize()
	pass#IMPORTIMPORTIMPORT from sparx_utilities import model_circle
...
def ref_ali3dm_new( refdata ):
	pass#IMPORTIMPORTIMPORT from sparx_utilities    import print_msg
	pass#IMPORTIMPORTIMPORT from sparx_utilities    import model_circle, get_im
...
def temp_dovolume( ref_data ):
	pass#IMPORTIMPORTIMPORT from sparx_utilities      import print_msg, read_text_row
	pass#IMPORTIMPORTIMPORT from filter         import fit_tanh, filt_tanl
	pass#IMPORTIMPORTIMPORT from fundamentals   import fshift
	pass#IMPORTIMPORTIMPORT from morphology     import threshold
	...
	pass#IMPORTIMPORTIMPORT from sparx_utilities    import read_text_file
...
def do_volume_mrk02(ref_data):
	...
	pass#IMPORTIMPORTIMPORT from sparx_utilities      import bcast_EMData_to_all, bcast_number_to_all, model_blank
	pass#IMPORTIMPORTIMPORT from fundamentals import rops_table, fftip, fft
	pass#IMPORTIMPORTIMPORT import types
	...
	if myid == 0:
		...
		if(Tracker["constants"]["mask3D"] == None):
			...
			pass#IMPORTIMPORTIMPORT from sparx_utilities import adaptive_mask
		...
		if( Tracker["PWadjustment"] ):
			pass#IMPORTIMPORTIMPORT from sparx_utilities    import read_text_file, write_text_file
	...
	if local_filter:
		...
		if myid == 0:
			#from sparx_utilities import write_text_file
