...
class Test_ali2d_MPI(unittest.TestCase):
    ...
    def test_wrong_number_params_too_few_parameters(self):
        ...
        with self.assertRaises(TypeError) as cm_old:
            oldfu.ali2d_MPI()
        self.assertEqual(
            str(cm_new.exception), "ali2d_MPI() takes at least 2 arguments (0 given)"
        )
...
class Test_ali2d_base(unittest.TestCase):
    ...
    def test_wrong_number_params_too_few_parameters(self):
        ...
        with self.assertRaises(TypeError) as cm_old:
            oldfu.ali2d_base()
        self.assertEqual(
            str(cm_new.exception), "ali2d_base() takes at least 2 arguments (0 given)"
        )
        self.assertEqual(str(cm_new.exception), str(cm_old.exception))
...
class Test_cpy(unittest.TestCase):
    def test_wrong_number_params_too_few_parameters(self):
        ...
        with self.assertRaises(TypeError) as cm_old:
            oldfu.cpy()
        self.assertEqual(
            str(cm_new.exception), "cpy() takes exactly 2 arguments (0 given)"
        )
        self.assertEqual(str(cm_new.exception), str(cm_old.exception))
    ...
    def test_error_hdf_not_found(self):
        ...
        with self.assertRaises(Exception) as cm_old:
            oldfu.cpy(ins_list, file_path_old)
        self.assertEqual(
            str(cm_new.failureException.message),
            "<attribute 'message' of 'exceptions.BaseException' objects>",
        )
        self.assertEqual(
            cm_new.failureException.message, cm_old.failureException.message
        )
...
class Test_project3d(unittest.TestCase):
    ...
    def test_wrong_number_params_too_few_parameters(self):
        ...
        with self.assertRaises(TypeError) as cm_old:
            oldfu.project3d()
        self.assertEqual(
            str(cm_new.exception), "project3d() takes at least 1 argument (0 given)"
        )
        self.assertEqual(str(cm_new.exception), str(cm_old.exception))
...
class Test_ali_vol(unittest.TestCase):
    ...
    def test_wrong_number_params_too_few_parameters(self):
        ...
        with self.assertRaises(TypeError) as cm_old:
            oldfu.ali_vol()
        self.assertEqual(
            str(cm_new.exception), "ali_vol() takes at least 4 arguments (0 given)"
        )
        self.assertEqual(str(cm_new.exception), str(cm_old.exception))
...
class Test_extract_value(unittest.TestCase):
    def test_wrong_number_params_too_few_parameters(self):
        ...
        with self.assertRaises(TypeError) as cm_old:
            oldfu.extract_value()
        self.assertEqual(
            str(cm_new.exception), "extract_value() takes exactly 1 argument (0 given)"
        )
        self.assertEqual(str(cm_new.exception), str(cm_old.exception))
...
class Test_header(unittest.TestCase):
    ...
    def test_wrong_number_params_too_few_parameters(self):
        ...
        with self.assertRaises(TypeError) as cm_old:
            oldfu.header()
        self.assertEqual(
            str(cm_new.exception), "header() takes at least 2 arguments (0 given)"
        )
        self.assertEqual(str(cm_new.exception), str(cm_old.exception))
...
class Test_MPI_start_end(unittest.TestCase):
    ...
    def test_wrong_number_params_too_few_parameters(self):
        ...
        with self.assertRaises(TypeError) as cm_old:
            oldfu.MPI_start_end()
        self.assertEqual(
            str(cm_new.exception), "MPI_start_end() takes exactly 3 arguments (0 given)"
        )
        self.assertEqual(str(cm_new.exception), str(cm_old.exception))
...
class Test_refvol(unittest.TestCase):
    def test_wrong_number_params_too_few_parameters(self):
        ...
        with self.assertRaises(TypeError) as cm_old:
            oldfu.refvol()
        self.assertEqual(
            str(cm_new.exception), "refvol() takes exactly 4 arguments (0 given)"
        )
        self.assertEqual(str(cm_new.exception), str(cm_old.exception))
...
class Test_within_group_refinement(unittest.TestCase):
    ...
    def test_wrong_number_params_too_few_parameters(self):
        ...
        self.assertEqual(
            ...
            "within_group_refinement() takes at least 13 arguments (0 given)",
        )
        self.assertEqual(str(cm_new.exception), str(cm_old.exception))
