...
from sphire.bin import sp_locres as oldfu
from sphire.utils.SPHIRE.bin import sp_locres as fu
...
class Test_helperFunction(unittest.TestCase):
    def test_makeAngRes(self):
        ...
        return_old = fu.makeAngRes(freqvol=IMAGE_3D, nx=IMAGE_3D.get_xsize(), ny=IMAGE_3D.get_ysize(),nz=IMAGE_3D.get_zsize(), pxSize=1.14, freq_to_real=True)
