...
filepath = os.path.join(ABSOLUTE_PATH_TO_RESOURCES, "user_functions.ref_ali2d_new")
# filepath_mask = os.path.join(os.getcwd(),  "resources_tests/pickles/user_functions.do_volume_mask_new")
# average_vol = os.path.join(os.getcwd(),  "resources_tests/average_volume.hdf")


argum = get_arg_from_pickle_file(filepath)
(refdata) = argum[0][0]
