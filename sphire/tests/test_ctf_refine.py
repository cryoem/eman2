...
from sphire.bin_py2 import sp_ctf_refine as oldfu
from sphire.bin_py3 import sp_ctf_refine as fu

from os import path
from test_module import ABSOLUTE_OLDBIN_PATH,ABSOLUTE_PATH_TO_SPHIRE_DEMO_RESULTS_FOLDER_NEW,ABSOLUTE_BIN_PATH,remove_dir,IMAGE_2D,get_arg_from_pickle_file,ABSOLUTE_PATH
import unittest
...
class Test_helperFunctions(unittest.TestCase):
    ...
    def test_apply_ctf(self):
        ...
        return_new = fu.apply_ctf(projection_2d=IMAGE_2D, ctf=ctf)
        return_old = oldfu.apply_ctf(projection_2d=IMAGE_2D, ctf=ctf)
        self.assertTrue(array_equal(return_new.get_2dview(), return_old.get_2dview()))
