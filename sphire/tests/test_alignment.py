...
from sphire.libpy_py3 import sp_projection
...
class Test_crit2d(unittest.TestCase):
    ...
    def test_wrong_number_params_too_few_parameters(self):
        ...
        with self.assertRaises(TypeError) as cm_old:
            oldfu.crit2d()
        self.assertEqual(
            str(cm_new.exception), "crit2d() takes exactly 2 arguments (0 given)"
        )
        self.assertEqual(str(cm_new.exception), str(cm_old.exception))
...
class Test_kbt(unittest.TestCase):
    def test_wrong_number_params_too_few_parameters(self):
        ...
        with self.assertRaises(TypeError) as cm_old:
            oldfu.kbt()
        self.assertEqual(
            str(cm_new.exception), "kbt() takes at least 1 argument (0 given)"
        )
        self.assertEqual(str(cm_new.exception), str(cm_old.exception))
        ...
        self.assertTrue(
            array_equal(
                ...
                [
                    ...
                    0.06114998832345009,
                    0.06103435158729553,
                    0.060918837785720825,
                    0.060803499072790146,
                    0.060688331723213196,
                    0.06057325750589371,
                    0.06045833230018616,
                    0.06034362316131592,
                    0.06022895872592926,
                    0.06011449918150902,
                    0.06000018119812012,
                    0.059886012226343155,
                    0.059771958738565445,
                    0.05965810641646385,
                    0.05954437702894211,
                    0.059430740773677826,
                    0.05931730195879936,
                    0.05920400843024254,
                    0.059090834110975266,
                    0.05897780880331993,
                    0.058864980936050415,
                    0.05875224620103836,
                    0.058639660477638245,
                    0.05852722004055977,
                    0.05841495096683502,
                    0.058302778750658035,
                    0.05819082632660866,
                    0.05807897448539734,
                    0.05796726420521736,
                    0.05785568058490753,
                    ...
                    0.05641848221421242,
                    0.05630887299776077,
                    0.056199487298727036,
                    0.05609024316072464,
                    0.055981144309043884,
                    0.055872149765491486,
                    0.05576331913471222,
                    0.05565464124083519,
                    0.05554603412747383,
                    0.05543766915798187,
                    ...
                    0.05500546470284462,
                    0.05489776283502579,
                    0.054790232330560684,
                    0.05468279868364334,
                    0.05457555875182152,
                    0.054468393325805664,
                    0.05436142534017563,
                    0.054254576563835144,
                    0.05414790287613869,
                    0.0540413036942482,
                    0.05393489822745323,
                    0.053828611969947815,
                    0.05372247472405434,
                    0.0536164864897728,
                    0.05351066216826439,
                    0.05340494215488434,
                    0.053299322724342346,
                    0.053193897008895874,
                    0.05308861657977104,
                    0.05298345908522606,
                    0.052878450602293015,
                    0.0527736097574234,
                    0.052668891847133636,
                    0.05256425216794014,
                    0.05245980620384216,
                    0.052355483174324036,
                    0.05225132778286934,
                    0.05214732140302658,
                    0.05204343795776367,
                    0.05193967744708061,
                    ...
                    0.05173255503177643,
                    0.05162923410534859,
                    0.051526084542274475,
                    0.05142301321029663,
                    0.051320113241672516,
                    0.05121733620762825,
                    0.051114656031131744,
                    0.05101217329502106,
                    0.05090983584523201,
                    0.05080762133002281,
                    0.05070552974939346,
                    0.050603609532117844,
                    0.05050178989768028,
                    0.05040009692311287,
                    0.050298575311899185,
                    0.05019719526171684,
                    0.05009596049785614,
                    0.049994856119155884,
                    0.04989387094974518,
                    0.04979303479194641,
                    0.04969228059053421,
                    0.049591757357120514,
                    0.049491338431835175,
                    0.04939104616641998,
                    0.04929089918732643,
                    0.04919089749455452,
                    0.049091022461652756,
                    0.04899127036333084,
                    ...
                    0.04859369248151779,
                    0.04849465191364288,
                    0.048395734280347824,
                    0.0482969656586647,
                    0.048198286443948746,
                    0.048099786043167114,
                    0.04800141602754593,
                    0.04790317267179489,
                    0.04780511185526848,
                    0.04770711809396744,
                    ...
                    0.04663844034075737,
                    0.04654211923480034,
                    0.046445924788713455,
                    0.04634983092546463,
                    0.046253908425569534,
                    0.0461580716073513,
                    0.046062398701906204,
                    0.04596691206097603,
                    0.04587151110172272,
                    0.04577624052762985,
                    0.04568111151456833,
                    ...
                    0.04530191794037819,
                    0.04520746320486069,
                    0.045113131403923035,
                    0.04501890763640404,
                    0.044924866408109665,
                    0.04483089596033096,
                    0.04473713040351868,
                    0.04464346542954445,
                    ...
                    0.04082838445901871,
                    0.04074034467339516,
                    0.040652450174093246,
                    0.04056466743350029,
                    0.04047701135277748,
                    0.040389467030763626,
                    0.0403020977973938,
                    0.04021481052041054,
                    0.040127694606781006,
                    0.04004066064953804,
                    0.0399538017809391,
                    0.039867036044597626,
                    0.0397803820669651,
                    0.03969390690326691,
                    0.039607539772987366,
                    0.03952129930257797,
                    0.03943517431616783,
                    0.03934919089078903,
                    0.03926333412528038,
                    0.039177604019641876,
                    0.039091985672712326,
                    0.039006512612104416,
                    0.03892116993665695,
                    0.03883594647049904,
                    ...
                    0.0376560352742672,
                    0.0375727117061615,
                    0.037489503622055054,
                    0.03740637004375458,
                    0.03732343018054962,
                    0.03724060207605362,
                    0.03715788573026657,
                    0.037075310945510864,
                    0.03699285164475441,
                    ...
                    0.03473410755395889,
                    0.03465520590543747,
                    0.034576449543237686,
                    0.034497808665037155,
                    0.03441927582025528,
                    0.03434087336063385,
                    ...
                    0.03356350585818291,
                    0.03348638862371445,
                    0.033409446477890015,
                    0.03333260118961334,
                    0.03325588256120682,
                    0.03317931666970253,
                    0.033102840185165405,
                    0.03302647918462753,
                    0.032950226217508316,
                    0.03287409991025925,
                    0.03279810771346092,
                    0.03272222355008125,
                    0.032646480947732925,
                    0.03257085382938385,
                    0.03249532729387283,
                    0.03241991624236107,
                    0.03234461322426796,
                    ...
                    0.031082892790436745,
                    0.031009726226329803,
                    0.030936695635318756,
                    0.030863741412758827,
                    0.03079095296561718,
                    0.030718252062797546,
                    0.03064567968249321,
                    0.030573219060897827,
                    0.0305008627474308,
                    0.030428633093833923,
                    0.03035651706159115,
                    0.030284514650702477,
                    0.030212638899683952,
                    0.030140867456793785,
                    0.030069218948483467,
                    0.02999768778681755,
                    0.029926296323537827,
                    0.029854966327548027,
                    0.029783764854073524,
                    0.029712693765759468,
                    0.029641730710864067,
                    0.029570885002613068,
                    0.02950017899274826,
                    0.029429573565721512,
                    0.02935904823243618,
                    0.02928866073489189,
                    0.029218384996056557,
                    0.029148228466510773,
                    0.029078207910060883,
                    0.0290082897990942,
                    0.02893848717212677,
                    0.02886876091361046,
                    0.02879917621612549,
                    0.02872970513999462,
                    0.028660336509346962,
                    0.02859111689031124,
                    0.028521990403532982,
                    0.02845296449959278,
                    0.028384042903780937,
                    0.028315246105194092,
                    0.0282465647906065,
                    0.028178023174405098,
                    0.02810957096517086,
                    0.02804124727845192,
                    0.027973012998700142,
                    0.027904871851205826,
                    0.0278368778526783,
                    0.027768999338150024,
                    0.027701225131750107,
                    0.027633564546704292,
                    0.027566008269786835,
                    0.02749856561422348,
                    0.027431214228272438,
                    0.027364013716578484,
                    0.027296917513012886,
                    0.027229923754930496,
                    0.027163032442331314,
                    0.02709626592695713,
                    0.027029605582356453,
                    0.026963036507368088,
                    0.02689661830663681,
                    0.02683030068874359,
                    0.026764076203107834,
                    0.026697978377342224,
                    0.026631971821188927,
                    0.026566093787550926,
                    0.026500318199396133,
                    0.02643464505672455,
                    0.02636909857392311,
                    0.026303647086024284,
                    0.026238318532705307,
                    0.026173096150159836,
                    0.026108000427484512,
                    0.02604297362267971,
                    0.02597808465361595,
                    0.025913288816809654,
                    0.02584862895309925,
                    0.025784064084291458,
                    0.025719624012708664,
                    0.025655275210738182,
                    0.025591012090444565,
                    0.02552688494324684,
                    0.025462862104177475,
                    0.02539895288646221,
                    0.025335172191262245,
                    0.025271471589803696,
                    0.025207877159118652,
                    0.025144385173916817,
                    0.025081021711230278,
                    0.0250177513808012,
                    0.024954594671726227,
                    0.024891575798392296,
                    0.024828629568219185,
                    0.024765806272625923,
                    0.02470306120812893,
                    0.024640437215566635,
                    0.024577932432293892,
                    0.024515550583600998,
                    0.02445325255393982,
                    0.02439108118414879,
                    0.024328993633389473,
                    0.02426699921488762,
                    0.024205142632126808,
                    0.02414339780807495,
                    0.024081740528345108,
                    0.02402018941938877,
                    0.023958759382367134,
                    0.023897409439086914,
                    0.023836171254515648,
                    0.023775067180395126,
                    0.02371405065059662,
                    0.023653138428926468,
                    0.02359234169125557,
                    0.023531639948487282,
                    0.02347104251384735,
                    0.02341054007411003,
                    0.02335016429424286,
                    0.023289892822504044,
                    0.023229729384183884,
                    0.023169657215476036,
                    0.023109694942831993,
                    0.023049844428896904,
                    0.02299008145928383,
                    0.022930441424250603,
                    0.02287088893353939,
                    0.02281145192682743,
                    0.022752119228243828,
                    0.02269289270043373,
                    0.022633779793977737,
                    0.022574737668037415,
                    0.02251581847667694,
                    0.022457005456089973,
                    0.022398296743631363,
                    0.022339684888720512,
                    0.02228119783103466,
                    0.022222798317670822,
                    0.02216448448598385,
                    0.022106295451521873,
                    0.02204820327460766,
                    0.021990207955241203,
                    0.021932344883680344,
                    0.0218745619058609,
                    0.021816881373524666,
                    0.021759293973445892,
                    0.021701809018850327,
                    0.021644439548254013,
                    0.021587174385786057,
                    0.021530017256736755,
                    0.021472955122590065,
                    0.021415984258055687,
                    0.02135910838842392,
                    0.021302348002791405,
                    0.021245691925287247,
                    0.02118915319442749,
                    0.02113269455730915,
                    0.02107633836567402,
                    0.02102009207010269,
                    0.020963922142982483,
                    ...
                    0.0205183457583189,
                    0.02046309970319271,
                    0.020407959818840027,
                    0.020352913066744804,
                    0.02029796503484249,
                    0.020243113860487938,
                    0.020188357681035995,
                    0.020133722573518753,
                    0.020079173147678375,
                    0.020024728029966354,
                    0.019970379769802094,
                    0.019916130229830742,
                    0.01986197754740715,
                    0.019807927310466766,
                    0.019753972068428993,
                    0.01970011554658413,
                    0.01964636519551277,
                    0.019592704251408577,
                    0.01953914575278759,
                    0.019485702738165855,
                    0.019432328641414642,
                    0.019379062578082085,
                    0.019325898960232735,
                    0.019272830337285995,
                    0.019219858571887016,
                    0.01916700229048729,
                    0.01911422796547413,
                    0.019061537459492683,
                    0.019008956849575043,
                    0.01895647495985031,
                    0.01890409365296364,
                    0.018851816654205322,
                    0.01879962906241417,
                    0.01874753274023533,
                    0.018695520237088203,
                    0.01864362135529518,
                    0.01859181933104992,
                    ...
                    0.018283016979694366,
                    0.018231889232993126,
                    0.01818086951971054,
                    0.01812993548810482,
                    0.018079090863466263,
                    0.018028343096375465,
                    0.017977677285671234,
                    0.017927121371030807,
                    0.017876673489809036,
                    0.01782630942761898,
                    0.017776040360331535,
                    0.017725860700011253,
                    0.01767577975988388,
                    0.017625780776143074,
                    0.017575901001691818,
                    0.01752609945833683,
                    0.01747640036046505,
                    0.017426790669560432,
                    0.017377274110913277,
                    0.017327850684523582,
                    0.017278514802455902,
                    0.017229294404387474,
                    0.017180154100060463,
                    0.017131108790636063,
                    0.017082152888178825,
                    0.017033297568559647,
                    0.01698453165590763,
                    0.016935862600803375,
                    0.016887277364730835,
                    0.0168387982994318,
                    0.016790399327874184,
                    0.016742104664444923,
                    0.016693895682692528,
                    ...
                    0.01640659011900425,
                    0.01635904796421528,
                    0.016311580315232277,
                    0.016264187172055244,
                    0.01621689833700657,
                    0.016169708222150803,
                    0.0161226037889719,
                    0.01607559621334076,
                    0.016028689220547676,
                    0.01598186045885086,
                    0.015935108065605164,
                    0.015888459980487823,
                    0.015841906890273094,
                    0.01579544134438038,
                    0.01574908010661602,
                    0.01570279523730278,
                    0.0156566072255373,
                    0.015610490925610065,
                    0.015564478933811188,
                    0.015518556348979473,
                    0.015472735278308392,
                    0.015426996164023876,
                    0.0153813436627388,
                    0.015335782431066036,
                    0.015290297567844391,
                    0.015244913287460804,
                    0.015199632383883,
                    0.015154429711401463,
                    0.015109311789274216,
                    0.015064287930727005,
                    0.015019354410469532,
                    0.01497449167072773,
                    0.01492973230779171,
                    0.014885074459016323,
                    0.014840495772659779,
                    0.014796003699302673,
                    0.014751600101590157,
                    0.014707286842167377,
                    0.014663043431937695,
                    0.014618916437029839,
                    0.014574863947927952,
                    0.014530900865793228,
                    0.014487026259303093,
                    0.014443236403167248,
                    0.014399537816643715,
                    0.014355924911797047,
                    0.01431240327656269,
                    0.014268964529037476,
                    0.014225614257156849,
                    0.014182349666953087,
                    0.014139172621071339,
                    0.014096097089350224,
                    0.014053082093596458,
                    0.014010168612003326,
                    0.013967340812087059,
                    0.013924595899879932,
                    0.01388193853199482,
                    0.01383938081562519,
                    0.01379689946770668,
                    0.013754487968981266,
                    0.013712177984416485,
                    0.013669953681528568,
                    0.013627813197672367,
                    0.013585759326815605,
                    0.013543802313506603,
                    0.013501920737326145,
                    0.013460110872983932,
                    0.013418399728834629,
                    0.013376773335039616,
                    0.013335230760276318,
                    0.013293784111738205,
                    0.013252414762973785,
                    0.013211129233241081,
                    0.013169912621378899,
                    0.0131287956610322,
                    0.013087764382362366,
                    0.013046827167272568,
                    0.013005961664021015,
                    0.012965183705091476,
                    0.012924485839903355,
                    0.012883862480521202,
                    0.012843336910009384,
                    0.012802901677787304,
                    0.012762543745338917,
                    0.01272226870059967,
                    0.012682073749601841,
                    0.012641963548958302,
                    0.012601927854120731,
                    0.012561983428895473,
                    0.012522133067250252,
                    0.012482358142733574,
                    0.012442661449313164,
                    0.012403050437569618,
                    0.012363521382212639,
                    0.01232406497001648,
                    0.012284712865948677,
                    0.01224543247371912,
                    0.01220623217523098,
                    0.012167118489742279,
                    0.012128082104027271,
                    0.012089126743376255,
                    0.012050258927047253,
                    0.012011467479169369,
                    0.011972762644290924,
                    0.011934138834476471,
                    0.011895595118403435,
                    0.011857128702104092,
                    0.011818761005997658,
                    0.0117804491892457,
                    0.01174222957342863,
                    0.011704090982675552,
                    0.01166603434830904,
                    0.01162805873900652,
                    0.011590173467993736,
                    0.011552358977496624,
                    0.011514614336192608,
                    0.011476960964500904,
                    0.011439384892582893,
                    0.011401895433664322,
                    0.011364481411874294,
                    0.01132715679705143,
                    0.011289904825389385,
                    0.011252721771597862,
                    0.011215625330805779,
                    0.011178611777722836,
                    0.01114167645573616,
                    0.011104831472039223,
                    0.011068057268857956,
                    0.011031358502805233,
                    0.010994731448590755,
                    0.010958192870020866,
                    0.01092173345386982,
                    0.010885359719395638,
                    0.01084905955940485,
                    0.010812836699187756,
                    0.01077669020742178,
                    0.010740612633526325,
                    0.010704625397920609,
                    0.010668725706636906,
                    0.01063289400190115,
                    0.010597140528261662,
                    0.010561463423073292,
                    0.01052586454898119,
                    0.01049034297466278,
                    0.010454891249537468,
                    0.010419536381959915,
                    0.01038424763828516,
                    0.010349037125706673,
                    0.010313904844224453,
                    0.010278847068548203,
                    0.010243868455290794,
                    0.010208966210484505,
                    0.010174139402806759,
                    0.01013939082622528,
                    0.010104718618094921,
                    0.01007012277841568,
                    0.010035604238510132,
                    0.0100011695176363,
                    0.009966797195374966,
                    0.009932504035532475,
                    0.009898290038108826,
                    0.009864152409136295,
                    0.009830090217292309,
                    0.009796111844480038,
                    0.009762201458215714,
                    0.009728354401886463,
                    0.009694594889879227,
                    0.009660910815000534,
                    0.009627299383282661,
                    0.009593776427209377,
                    0.009560317732393742,
                    0.0095269326120615,
                    0.009493612684309483,
                    0.009460380300879478,
                    0.00942721776664257,
                    0.00939413346350193,
                    0.00936113204807043,
                    0.00932819489389658,
                    0.009295333176851273,
                    0.009262535721063614,
                    0.009229821152985096,
                    0.009197180159389973,
                    0.00916462391614914,
                    0.00913213100284338,
                    0.009099714457988739,
                    0.009067367762327194,
                    0.009035087190568447,
                    0.009002887643873692,
                    0.008970770984888077,
                    0.00893872044980526,
                    0.008906741626560688,
                    0.008874837309122086,
                    0.008843003772199154,
                    0.008811235427856445,
                    0.0087795564904809,
                    0.008747942745685577,
                    0.008716399781405926,
                    0.00868492852896452,
                    0.008653531782329082,
                    0.00862220861017704,
                    0.008590945973992348,
                    0.008559772744774818,
                    0.008528664708137512,
                    0.008497627452015877,
                    0.008466661907732487,
                    0.008435769006609917,
                    0.008404946886003017,
                    0.008374196477234364,
                    0.008343515917658806,
                    0.008312908001244068,
                    0.008282370865345001,
                    0.00825190544128418,
                    0.008221509866416454,
                    0.00819119531661272,
                    0.00816093198955059,
                    0.008130749687552452,
                    0.008100636303424835,
                    0.008070597425103188,
                    0.008040625602006912,
                    0.00801073294132948,
                    0.007980902679264545,
                    0.007951132953166962,
                    0.00792144238948822,
                    0.00789182074368,
                    0.007862270809710026,
                    0.007832798175513744,
                    0.0078033865429461,
                    0.007774044759571552,
                    0.00774476258084178,
                    0.007715561892837286,
                    0.00768642732873559,
                    0.0076573616825044155,
                    0.007628373336046934,
                    0.007599447853863239,
                    0.0075705889612436295,
                    0.007541791535913944,
                    0.007513072341680527,
                    0.007484418340027332,
                    0.00745584350079298,
                    0.007427327800542116,
                    0.007398881949484348,
                    0.007370502222329378,
                    0.00734218442812562,
                    0.007313941139727831,
                    0.007285775151103735,
                    0.00725766783580184,
                    0.007229628041386604,
                    0.007201656233519316,
                    0.007173751946538687,
                    0.0071459063328802586,
                    0.007118145003914833,
                    0.007090444210916758,
                    0.00706280954182148,
                    0.007035240530967712,
                    0.007007739972323179,
                    0.006980305537581444,
                    0.006952930241823196,
                    0.006925636902451515,
                    0.006898402702063322,
                    0.006871235091239214,
                    0.0068441336043179035,
                    0.006817099638283253,
                    0.006790128070861101,
                    0.006763226818293333,
                    0.006736390292644501,
                    0.0067096189595758915,
                    0.00668291375041008,
                    0.006656273268163204,
                    0.006629700772464275,
                    0.006603200454264879,
                    0.006576748099178076,
                    0.006550372578203678,
                    0.00652405945584178,
                    0.006497811991721392,
                    0.006471630651503801,
                    0.006445520557463169,
                    0.006419467739760876,
                    0.0063934726640582085,
                    0.0063675506971776485,
                    0.00634169252589345,
                    0.006315899081528187,
                    0.00629017548635602,
                    0.0062645114958286285,
                    0.006238909903913736,
                    0.006213366985321045,
                    0.006187893450260162,
                    0.006162483710795641,
                    0.006137139163911343,
                    0.006111864931881428,
                    0.006086647976189852,
                    0.006061493884772062,
                    0.00603639567270875,
                    0.006011368706822395,
                    0.005986404605209827,
                    0.00596151128411293,
                    0.00593667384237051,
                    0.005911898799240589,
                    0.005887187086045742,
                    0.005862531252205372,
                    0.0058379448018968105,
                    0.005813427735120058,
                    0.0057889665476977825,
                    0.005764568690210581,
                    0.0057402318343520164,
                    0.005715958308428526,
                    0.005691738799214363,
                    0.005667596124112606,
                    0.005643508397042751,
                    0.005619482137262821,
                    0.005595517344772816,
                    0.0055716149508953094,
                    0.005547774024307728,
                    0.005523987580090761,
                    0.005500276573002338,
                    0.005476619582623243,
                    0.005453023128211498,
                    0.00542948953807354,
                    0.005406015552580357,
                    0.005382603965699673,
                    0.005359251983463764,
                    0.005335961934179068,
                    0.005312731023877859,
                    0.00528956251218915,
                    0.005266452673822641,
                    0.005243405234068632,
                    0.005220423452556133,
                    0.005197487305849791,
                    0.005174620077013969,
                    0.005151812452822924,
                    0.005129064433276653,
                    0.005106375552713871,
                    0.005083754658699036,
                    0.0050611854530870914,
                    0.005038669798523188,
                    0.005016221199184656,
                    0.004993831273168325,
                    0.0049714986234903336,
                    0.004949233960360289,
                    0.004927021451294422,
                    0.004904868081212044,
                    0.0048827663995325565,
                    0.00486073037609458,
                    0.004838753957301378,
                    0.00481683574616909,
                    0.004794982727617025,
                    0.004773181397467852,
                    0.004751437809318304,
                    0.004729747772216797,
                    0.0047081210650503635,
                    0.004686553496867418,
                    0.004665049258619547,
                    0.004643596708774567,
                    0.0046222023665905,
                    0.004600865766406059,
                    0.004579579923301935,
                    0.004558358807116747,
                    0.00453720148652792,
                    0.004516094457358122,
                    0.0044950456358492374,
                    0.0044740536250174046,
                    0.0044531188905239105,
                    0.004432234913110733,
                    0.004411420319229364,
                    0.004390656016767025,
                    0.0043699489906430244,
                    0.004349298309534788,
                    0.004328703973442316,
                    0.004308166913688183,
                    0.0042876796796917915,
                    0.004267261363565922,
                    0.004246892873197794,
                    0.004226579796522856,
                    0.004206323996186256,
                    0.004186123609542847,
                    0.004165979102253914,
                    0.004145890939980745,
                    0.004125857725739479,
                    0.00410588039085269,
                    0.004085958935320377,
                    0.00406609196215868,
                    0.0040462808683514595,
                    0.004026530776172876,
                    0.0040068244561553,
                    0.003987179137766361,
                    0.003967588301748037,
                    0.003948052879422903,
                    0.003928571939468384,
                    0.0039091515354812145,
                    0.0038897800259292126,
                    0.0038704571779817343,
                    0.0038511946331709623,
                    0.003831986803561449,
                    0.00381283275783062,
                    0.0037937387824058533,
                    0.003774693002924323,
                    0.0037557014729827642,
                    0.003736757906153798,
                    0.0037178746424615383,
                    0.0036990446969866753,
                    0.0036802683025598526,
                    0.003661550348624587,
                    0.003642881289124489,
                    0.0036242653150111437,
                    0.003605697536841035,
                    0.0035871879663318396,
                    0.003568731714040041,
                    0.0035503339022397995,
                    0.0035319835878908634,
                    0.003513685893267393,
                    0.003495441749691963,
                    0.0034772444050759077,
                    0.003459105035290122,
                    0.003441023640334606,
                    0.0034229890443384647,
                    0.0034050073008984327,
                    0.0033870774786919355,
                    0.0033692000433802605,
                    0.00335136940702796,
                    0.0033336011692881584,
                    0.0033158797305077314,
                    0.0032982099801301956,
                    0.0032805921509861946,
                    0.003263025777414441,
                    0.0032455110922455788,
                    0.0032280427403748035,
                    0.003210635855793953,
                    0.003193275537341833,
                    0.0031759662088006735,
                    0.003158707870170474,
                    0.0031415007542818785,
                    0.0031243443954735994,
                    0.003107239492237568,
                    0.0030901851132512093,
                    0.00307318102568388,
                    0.003056227695196867,
                    0.003039325587451458,
                    0.003022473305463791,
                    0.0030056762043386698,
                    0.0029889196157455444,
                    0.0029722184408456087,
                    0.002955567091703415,
                    0.0029389660339802504,
                    0.0029224150348454714,
                    0.00290591805242002,
                    0.0028894664719700813,
                    0.0028730598278343678,
                    0.0028567074332386255,
                    0.0028404046315699816,
                    0.0028241511899977922,
                    0.0028079517651349306,
                    0.002791796810925007,
                    0.0027756912168115377,
                    0.0027596300933510065,
                    0.002743622288107872,
                    0.0027276636101305485,
                    0.0027117538265883923,
                    0.0026958973612636328,
                    0.002680084900930524,
                    0.0026643211022019386,
                    0.002648601308465004,
                    0.0026329343672841787,
                    0.00261731562204659,
                    0.0026017497293651104,
                    0.0025862273760139942,
                    0.002570753451436758,
                    0.0025553270243108273,
                    0.002539944602176547,
                    0.0025246143341064453,
                    0.0025093357544392347,
                    0.0024941007141023874,
                    0.0024789131712168455,
                    0.002463773125782609,
                    0.002448680577799678,
                    0.002433630870655179,
                    0.0024186372756958008,
                    0.002403686288744211,
                    0.0023887825664132833,
                    0.00237392564304173,
                    0.0023591157514601946,
                    0.0023443526588380337,
                    0.0023296319413930178,
                    0.002314966404810548,
                    0.002300343243405223,
                    0.0022857666481286287,
                    0.002271236153319478,
                    0.002256752224639058,
                    0.0022423146292567253,
                    0.0022279229015111923,
                    0.0022135775070637465,
                    0.0021992779802531004,
                    0.002185024321079254,
                    0.0021708165295422077,
                    0.002156654605641961,
                    0.0021425422746688128,
                    0.0021284674294292927,
                    0.002114442177116871,
                    0.002100462093949318,
                    0.002086527645587921,
                    0.0020726381335407495,
                    0.0020587979815900326,
                    0.0020449988078325987,
                    0.0020312408450990915,
                    0.0020175317768007517,
                    0.0020038674119859934,
                    0.0019902477506548166,
                    0.001976676983758807,
                    0.00196314649656415,
                    0.001949660829268396,
                    0.0019362156745046377,
                    0.0019228184828534722,
                    0.0019094658782705665,
                    0.001896157395094633,
                    0.0018828966422006488,
                    0.0018696762854233384,
                    0.0,
                    0.0,
                    0.0,
                    0.0,
...
class Test_ali_vol_func_rotate(unittest.TestCase):
    ...
    def test_wrong_number_params_too_few_parameters(self):
        ...
        self.assertEqual(
            ...
            "ali_vol_func_rotate() takes exactly 2 arguments (0 given)",
        )
        self.assertEqual(str(cm_new.exception), str(cm_old.exception))
...
class Test_ali_vol_func_shift(unittest.TestCase):
    ...
    def test_wrong_number_params_too_few_parameters(self):
        ...
        self.assertEqual(
            str(cm_new.exception),
            "ali_vol_func_shift() takes exactly 2 arguments (0 given)",
        )
        self.assertEqual(str(cm_new.exception), str(cm_old.exception))
...
class Test_fine_2D_refinement(unittest.TestCase):
    def test_wrong_number_params_too_few_parameters(self):
        ...
        self.assertEqual(
            str(cm_new.exception),
            "fine_2D_refinement() takes at least 4 arguments (0 given)",
        )
        self.assertEqual(str(cm_new.exception), str(cm_old.exception))
...
class Test_align2d_direct3(unittest.TestCase):
    def test_wrong_number_params_too_few_parameters(self):
        ...
        self.assertEqual(
            str(cm_new.exception),
            "align2d_direct3() takes at least 2 arguments (0 given)",
        )
        self.assertEqual(str(cm_new.exception), str(cm_old.exception))
...
class Test_ali_nvol(unittest.TestCase):
    def test_wrong_number_params_too_few_parameters(self):
        ...
        with self.assertRaises(TypeError) as cm_old:
            oldfu.ali_nvol()
        self.assertEqual(
            str(cm_new.exception), "ali_nvol() takes exactly 2 arguments (0 given)"
        )
        self.assertEqual(str(cm_new.exception), str(cm_old.exception))
...
class Test_alivol_mask_getref(unittest.TestCase):
    def test_wrong_number_params_too_few_parameters(self):
        ...
        self.assertEqual(
            str(cm_new.exception),
            "alivol_mask_getref() takes exactly 2 arguments (0 given)",
        )
        self.assertEqual(str(cm_new.exception), str(cm_old.exception))
...
class Test_alivol_mask(unittest.TestCase):
    def test_wrong_number_params_too_few_parameters(self):
        ...
        with self.assertRaises(TypeError) as cm_old:
            oldfu.alivol_mask()
        self.assertEqual(
            str(cm_new.exception), "alivol_mask() takes exactly 3 arguments (0 given)"
        )
        self.assertEqual(str(cm_new.exception), str(cm_old.exception))
...
class Test_ali2d_single_iter(unittest.TestCase):
    ...
    def test_wrong_number_params_returns_TypeError_too_few_parameters(self):
        ...
        self.assertEqual(
            str(cm_new.exception),
            "ali2d_single_iter() takes at least 10 arguments (0 given)",
        )
        self.assertEqual(str(cm_new.exception), str(cm_old.exception))
    ...
    def test_few_shift_params_returns_IndexError_list_index_out_of_range(self):
        (not_used, numr, wr, not_used2, tavg, cnx, cny, xrng, yrng, step) = self.argum[
            0
        ]
        cs = [1]
        with self.assertRaises(IndexError) as cm_new:
            fu.ali2d_single_iter(
                data=deepcopy(self.argum[0][0]),
                numr=numr,
                wr=wr,
                cs=cs,
                tavg=tavg,
    ...
    def test_too_shift_params(self):
        ...
        self.assertTrue(array_equal(return_new, return_old))
        self.assertTrue(
            array_equal(return_new, (-14.731135129928589, 4.656862832605839, 0))
        )
    ...
    def test_NOmirror_mode_H_WITHCTF_randomMethod_SCF(self):
        ...
        self.assertTrue(array_equal(return_new, return_old))
        self.assertTrue(
            array_equal(return_new, (-11.895780010148883, 3.155013743788004, 0))
        )
    ...
    def test_NOmirror_mode_F_NOCTF_randomMethod_SCF(self):
        ...
        self.assertTrue(array_equal(return_new, return_old))
        self.assertTrue(
            array_equal(return_new, (-25.085551424417645, -20.18510612542741, 0))
        )
    ...
    def test_mirror_mode_F_NOCTF_randomMethod_SCF(self):
        ...
        self.assertTrue(
            allclose(
                return_new, (-25.085551424417645, -20.18510612542741, 0), atol=TOLERANCE
            )
        )
    ...
    def test_NOmirror_mode_H_WITHCTF_randomMethod_PCP_returns_typeError_object_float_hasnot_attibute__getitem__(
        ...
        self.assertEqual(
            str(cm_new.exception), "'float' object has no attribute '__getitem__'"
        )
        self.assertEqual(str(cm_new.exception), str(cm_old.exception))
...
class Test_ang_n(unittest.TestCase):
    def test_wrong_number_params_returns_TypeError_too_few_parameters(self):
        ...
        with self.assertRaises(TypeError) as cm_old:
            oldfu.ang_n()
        self.assertEqual(
            str(cm_new.exception), "ang_n() takes exactly 3 arguments (0 given)"
        )
        self.assertEqual(str(cm_new.exception), str(cm_old.exception))
...
class Test_log2(unittest.TestCase):
    def test_wrong_number_params_returns_TypeError_too_few_parameters(self):
        ...
        with self.assertRaises(TypeError) as cm_old:
            oldfu.log2()
        self.assertEqual(
            str(cm_new.exception), "log2() takes exactly 1 argument (0 given)"
        )
        self.assertEqual(str(cm_new.exception), str(cm_old.exception))
...
class Test_Numrinit(unittest.TestCase):
    def test_wrong_number_params_returns_TypeError_too_few_parameters(self):
        ...
        with self.assertRaises(TypeError) as cm_old:
            oldfu.Numrinit()
        self.assertEqual(
            str(cm_old.exception), "Numrinit() takes at least 2 arguments (0 given)"
        )
        self.assertEqual(str(cm_new.exception), str(cm_old.exception))
...
class Test_ringwe(unittest.TestCase):
    ...
    def test_wrong_number_params_returns_TypeError_too_few_parameters(self):
        ...
        with self.assertRaises(TypeError) as cm_old:
            oldfu.ringwe()
        self.assertEqual(
            str(cm_new.exception), "ringwe() takes at least 1 argument (0 given)"
        )
        self.assertEqual(str(cm_new.exception), str(cm_old.exception))
...
class Test_ornq(unittest.TestCase):
    ...
    def test_wrong_number_params_returns_TypeError_too_few_parameters(self):
        ...
        with self.assertRaises(TypeError) as cm_old:
            oldfu.ornq()
        self.assertEqual(
            str(cm_new.exception), "ornq() takes at least 9 arguments (0 given)"
        )
        self.assertEqual(str(cm_new.exception), str(cm_old.exception))
...
class Test_ormq(unittest.TestCase):
    ...
    def test_wrong_number_params_returns_TypeError_too_few_parameters(self):
        ...
        with self.assertRaises(TypeError) as cm_old:
            oldfu.ormq()
        self.assertEqual(
            str(cm_new.exception), "ormq() takes at least 9 arguments (0 given)"
        )
        self.assertEqual(str(cm_new.exception), str(cm_old.exception))
    ...
    def test_Full_mode(self):
        (image, crefim, xrng, yrng, step, mode, numr, cnx, cny, delta) = self.argum[
            0
        ]  # mode is F
        return_new = fu.ormq(
            image=image,
...
class Test_prepref(unittest.TestCase):
    ...
    def test_wrong_number_params_returns_TypeError_too_few_parameters(self):
        ...
        with self.assertRaises(TypeError) as cm_old:
            oldfu.prepref()
        self.assertEqual(
            str(cm_new.exception), "prepref() takes exactly 9 arguments (0 given)"
        )
        self.assertEqual(str(cm_new.exception), str(cm_old.exception))
...
class Test_prepare_refrings(unittest.TestCase):
    ...
    def test_wrong_number_params_returns_TypeError_too_few_parameters(self):
        ...
        self.assertEqual(
            str(cm_new.exception),
            "prepare_refrings() takes at least 2 arguments (0 given)",
        )
        self.assertEqual(str(cm_new.exception), str(cm_old.exception))
...
class Test_ali_vol_func(unittest.TestCase):
    ...
    def test_wrong_number_params_returns_TypeError_too_few_parameters(self):
        ...
        with self.assertRaises(TypeError) as cm_old:
            oldfu.ali_vol_func()
        self.assertEqual(
            str(cm_new.exception), "ali_vol_func() takes exactly 2 arguments (0 given)"
        )
        self.assertEqual(str(cm_new.exception), str(cm_old.exception))
...
class Test_align2d(unittest.TestCase):
    ...
    def test_wrong_number_params_returns_TypeError_too_few_parameters(self):
        ...
        with self.assertRaises(TypeError) as cm_old:
            oldfu.align2d()
        self.assertEqual(
            str(cm_new.exception), "align2d() takes at least 2 arguments (0 given)"
        )
        self.assertEqual(str(cm_new.exception), str(cm_old.exception))
...
class Test_align2d_scf(unittest.TestCase):
    def test_wrong_number_params_returns_TypeError_too_few_parameters(self):
        ...
        with self.assertRaises(TypeError) as cm_old:
            oldfu.align2d_scf()
        self.assertEqual(
            str(cm_new.exception), "align2d_scf() takes at least 2 arguments (0 given)"
        )
        self.assertEqual(str(cm_new.exception), str(cm_old.exception))
...
class Test_multialign2d_scf(unittest.TestCase):
    ...
    def test_NoneType__image_reference_typeError_NoneType_obj_hasnot_attribute___getitem__(
        ...
        self.assertEqual(str(cm_new.exception), str(cm_old.exception))
        self.assertEqual(
            str(cm_new.exception), "'NoneType' object has no attribute '__getitem__'"
        )
    ...
    def test_wrong_number_params_returns_TypeError_too_few_parameters(self):
        ...
        self.assertEqual(
            str(cm_new.exception),
            "multalign2d_scf() takes at least 4 arguments (0 given)",
        )
        self.assertEqual(str(cm_new.exception), str(cm_old.exception))
...
class Test_parabl(unittest.TestCase):
    ...
    def test_wrong_number_params_returns_TypeError_too_few_parameters(self):
        ...
        with self.assertRaises(TypeError) as cm_old:
            oldfu.parabl()
        self.assertEqual(
            str(cm_new.exception), "parabl() takes exactly 1 argument (0 given)"
        )
        self.assertEqual(str(cm_new.exception), str(cm_old.exception))
