...
from test_module import get_data, get_arg_from_pickle_file,get_real_data,create_kb
...
MASK_2DIMAGE= model_circle(2, IMAGE_2D.get_xsize(),IMAGE_2D.get_ysize(),IMAGE_2D.get_zsize())
MASK_IMAGE_BLANK_2D= model_circle(2, IMAGE_BLANK_2D.get_xsize(),IMAGE_BLANK_2D.get_ysize(),IMAGE_BLANK_2D.get_zsize())
MASK_3DIMAGE= model_circle(2, IMAGE_3D.get_xsize(),IMAGE_3D.get_ysize(),IMAGE_3D.get_zsize())
MASK_IMAGE_BLANK_3D= model_circle(2, IMAGE_BLANK_3D.get_xsize(),IMAGE_BLANK_3D.get_ysize(),IMAGE_BLANK_3D.get_zsize())
...
class Test_crit2d(unittest.TestCase):
    ...
    def test_wrong_number_params_too_few_parameters(self):
        ...
        with self.assertRaises(TypeError) as cm_old:
            oldfu.crit2d()
        self.assertEqual(cm_new.exception.message, "crit2d() takes exactly 2 arguments (0 given)")
    ...
    def test_None_img_in_data_returns_RuntimeError_NullPointerException(self):
        ...
        self.assertEqual(msg[3], 'NULL input image')
        self.assertEqual(msg[0].split(" ")[0], msg_old[0].split(" ")[0])
        self.assertEqual(msg[3], msg_old[3])

    def test_None_kb_filter_returns_RuntimeError_NullPointerException(self):
        with self.assertRaises(TypeError) as cm_new:
    ...
    def test_crit2dIMG(self):
        ...
        self.assertEqual(return_old, 4.04121637344)
...
class Test_eqproj_cascaded_ccc_fitness_function(unittest.TestCase):
    ...
    def test_wrong_number_params_too_few_parameters(self):
        ...
        self.assertEqual(cm_new.exception.message, "eqproj_cascaded_ccc_fitness_function() takes exactly 2 arguments (0 given)")
        self.assertEqual(cm_new.exception.message, cm_old.exception.message)


    def test_empty_args_returns_IndexError_list_index_out_of_range(self):
        with self.assertRaises(IndexError) as cm_new:
            fu.crit2d(args=[], data=[0,1,2,3,4,5,6])
        with self.assertRaises(IndexError) as cm_old:
            oldfu.crit2d(args=[], data=[0,1,2,3,4,5,6])
        self.assertEqual(cm_new.exception.message, "list index out of range")
        self.assertEqual(cm_new.exception.message, cm_old.exception.message)
...
class Test_format_list(unittest.TestCase):
    ...
    def test_wrong_number_params_too_few_parameters(self):
        ...
        with self.assertRaises(TypeError) as cm_old:
            oldfu.format_list()
        self.assertEqual(cm_new.exception.message, "format_list() takes exactly 1 argument (0 given)")
        self.assertEqual(cm_new.exception.message, cm_old.exception.message)
...
class Test_objective_function_just_ccc_has_maximum(unittest.TestCase):
    ...
    def test_wrong_number_params_too_few_parameters(self):
        ...
        self.assertEqual(cm_new.exception.message, "objective_function_just_ccc_has_maximum takes exactly 2 arguments (0 given)")
        self.assertEqual(cm_new.exception.message, cm_old.exception.message)
    ...
    def test_objective_function_just_ccc_has_maximum(self):
        return_old = oldfu.objective_function_just_ccc_has_maximum(args=self.params, data=[self.volft,"",IMAGE_2D,"","","",""])
...
class Test_objective_function_just_ccc_has_minimum(unittest.TestCase):
    ...
    def test_wrong_number_params_too_few_parameters(self):
        ...
        self.assertEqual(cm_new.exception.message, "objective_function_just_ccc_has_minimum() takes exactly 2 arguments (0 given)")
        self.assertEqual(cm_new.exception.message, cm_old.exception.message)
...
class Test_objective_function_just_ccc_has_minimum_only_reduced(unittest.TestCase):
    ...
    def test_wrong_number_params_too_few_parameters(self):
        ...
        self.assertEqual(cm_new.exception.message, "objective_function_just_ccc_has_minimum_reduced() takes exactly 2 arguments (0 given)")
        self.assertEqual(cm_new.exception.message, cm_old.exception.message)
...
class Test_objective_function_just_ccc_has_minimum_reduced_only_shifts(unittest.TestCase):
    ...
    def test_wrong_number_params_too_few_parameters(self):
        ...
        self.assertEqual(cm_new.exception.message, "objective_function_just_ccc_has_minimum_reduced_only_shifts() takes exactly 2 arguments (0 given)")
        self.assertEqual(cm_new.exception.message, cm_old.exception.message)
...
class Test_objective_function_just_ccc_has_minimum2(unittest.TestCase):
    ...
    def test_wrong_number_params_too_few_parameters(self):
        ...
        self.assertEqual(cm_new.exception.message, "objective_function_just_ccc_has_minimum2() takes exactly 2 arguments (0 given)")
        self.assertEqual(cm_new.exception.message, cm_old.exception.message)
...
class Test_objective_function_just_ccc_has_maximum___old(unittest.TestCase):
    def test_wrong_number_params_too_few_parameters(self):
        ...
        self.assertEqual(cm_new.exception.message, "objective_function_just_ccc_has_maximum___old() takes exactly 2 arguments (0 given)")
        self.assertEqual(cm_new.exception.message, cm_old.exception.message)
...
class Test_objective_function_just_ccc_rewrite(unittest.TestCase):
    ...
    def test_wrong_number_params_too_few_parameters(self):
        ...
        self.assertEqual(cm_new.exception.message, "objective_function_just_ccc_rewrite() takes exactly 5 arguments (0 given)")
        self.assertEqual(cm_new.exception.message, cm_old.exception.message)
...
class Test_eqproj_cascaded_ccc(unittest.TestCase):
    ...
    def test_wrong_number_params_too_few_parameters(self):
        ...
        self.assertEqual(cm_new.exception.message, "eqproj_cascaded_ccc() takes exactly 2 arguments (0 given)")
        self.assertEqual(cm_new.exception.message, cm_old.exception.message)
    ...
    def test_empty_data_returns_IndexError_list_index_out_of_range(self):
        ...
        with self.assertRaises(IndexError) as cm_old:
            oldfu.eqproj_cascaded_ccc(data=[], args=self.[1,2,3,4,5,6])
        self.assertEqual(cm_new.exception.message, "list index out of range")
        self.assertEqual(cm_new.exception.message, cm_old.exception.message)
...
class Test_twoD_fine_search(unittest.TestCase):
    ...
    def test_wrong_number_params_too_few_parameters(self):
        ...
        self.assertEqual(cm_new.exception.message, "twoD_fine_search() takes exactly 2 arguments (0 given)")
        self.assertEqual(cm_new.exception.message, cm_old.exception.message)
...
class Test_eqproj(unittest.TestCase):
    ...
    def test_wrong_number_params_too_few_parameters(self):
        ...
        with self.assertRaises(TypeError) as cm_old:
            oldfu.eqproj()
        self.assertEqual(cm_new.exception.message, "eqproj() takes exactly 2 arguments (0 given)")
        self.assertEqual(cm_new.exception.message, cm_old.exception.message)
...
class Test_eqprojDot(unittest.TestCase):
    ...
    def test_wrong_number_params_too_few_parameters(self):
        ...
        with self.assertRaises(TypeError) as cm_old:
            oldfu.eqprojDot()
        self.assertEqual(cm_new.exception.message, "eqprojDot() takes exactly 2 arguments (0 given)")
        self.assertEqual(cm_new.exception.message, cm_old.exception.message)
...
class Test_eqprojEuler(unittest.TestCase):
    def test_wrong_number_params_too_few_parameters(self):
        ...
        with self.assertRaises(TypeError) as cm_old:
            oldfu.eqprojEuler()
        self.assertEqual(cm_new.exception.message, "eqprojEuler() takes exactly 2 arguments (0 given)")
        self.assertEqual(cm_new.exception.message, cm_old.exception.message)
...
class Test_symm_func(unittest.TestCase):
    ...
    def test_wrong_number_params_too_few_parameters(self):
        ...
        with self.assertRaises(TypeError) as cm_old:
            oldfu.symm_func()
        self.assertEqual(cm_new.exception.message, "symm_func() takes exactly 2 arguments (0 given)")
        self.assertEqual(cm_new.exception.message, cm_old.exception.message)
...
class Test_find_symm(unittest.TestCase):
    ...
    def test_wrong_number_params_too_few_parameters(self):
        ...
        with self.assertRaises(TypeError) as cm_old:
            oldfu.find_symm()
        self.assertEqual(cm_new.exception.message, "find_symm() takes exactly 9 arguments (0 given)")
        self.assertEqual(cm_new.exception.message, cm_old.exception.message)
...
#todo: how tests a kb ? I did once, look for it in the code
class Test_kbt(unittest.TestCase):
    def test_wrong_number_params_too_few_parameters(self):
        ...
        with self.assertRaises(TypeError) as cm_old:
            oldfu.kbt()
        self.assertEqual(cm_new.exception.message, "kbt() takes at least 1 argument (0 given)")
        self.assertEqual(cm_new.exception.message, cm_old.exception.message)
...
class Test_ormq_peaks(unittest.TestCase):
    ...
    def test_wrong_number_params_too_few_parameters(self):
        ...
        with self.assertRaises(TypeError) as cm_old:
            oldfu.ormq_peaks()
        self.assertEqual(cm_new.exception.message, "ormq_peaks() takes exactly 9 arguments (0 given)")
        self.assertEqual(cm_new.exception.message, cm_old.exception.message)
    ...
    def test_Empty_image_returns_TypeError(self):
        ...
        self.assertEqual(cm_new.exception.message, "float argument required, not list")
        self.assertEqual(cm_new.exception.message, cm_old.exception.message)
...
class Test_select_k(unittest.TestCase):
    def test_wrong_number_params_too_few_parameters(self):
        ...
        with self.assertRaises(TypeError) as cm_old:
            oldfu.select_k()
        self.assertEqual(cm_new.exception.message, "select_k() takes exactly 2 arguments (0 given)")
        self.assertEqual(cm_new.exception.message, cm_old.exception.message)
...
class Test_sim_anneal(unittest.TestCase):
    ...
    def test_wrong_number_params_too_few_parameters(self):
        ...
        with self.assertRaises(TypeError) as cm_old:
            oldfu.sim_anneal()
        self.assertEqual(cm_new.exception.message, "sim_anneal() takes exactly 5 arguments (0 given)")
        self.assertEqual(cm_new.exception.message, cm_old.exception.message)
...
class Test_sim_ccf(unittest.TestCase):
    ...
    def test_wrong_number_params_too_few_parameters(self):
        ...
        with self.assertRaises(TypeError) as cm_old:
            oldfu.sim_ccf()
        self.assertEqual(cm_new.exception.message, "sim_ccf() takes exactly 5 arguments (0 given)")
        self.assertEqual(cm_new.exception.message, cm_old.exception.message)
...
class Test_sim_anneal2(unittest.TestCase):
    ...
    def test_wrong_number_params_too_few_parameters(self):
        ...
        with self.assertRaises(TypeError) as cm_old:
            oldfu.sim_anneal2()
        self.assertEqual(cm_new.exception.message, "sim_anneal2() takes at least 2 arguments (0 given)")
        self.assertEqual(cm_new.exception.message, cm_old.exception.message)
...
class Test_sim_anneal3(unittest.TestCase):
    ...
    def test_wrong_number_params_too_few_parameters(self):
        ...
        with self.assertRaises(TypeError) as cm_old:
            oldfu.sim_anneal3()
        self.assertEqual(cm_new.exception.message, "sim_anneal3() takes exactly 8 arguments (0 given)")
        self.assertEqual(cm_new.exception.message, cm_old.exception.message)
...
class Test_prep_vol_kb(unittest.TestCase):
    def test_wrong_number_params_too_few_parameters(self):
        ...
        with self.assertRaises(TypeError) as cm_old:
            oldfu.prep_vol_kb()
        self.assertEqual(cm_new.exception.message, "prep_vol_kb() takes at least 2 arguments (0 given)")
        self.assertEqual(cm_new.exception.message, cm_old.exception.message)
...
class Test_prepare_refrings_projections(unittest.TestCase):
    ...
    def test_wrong_number_params_returns_TypeError_too_few_parameters(self):
        ...
        self.assertEqual(cm_new.exception.message, "prepare_refrings_projections() takes at least 2 arguments (0 given)")
        self.assertEqual(cm_new.exception.message, cm_old.exception.message)
...
class Test_prepare_refrings2(unittest.TestCase):
    ...
    def test_wrong_number_params_returns_TypeError_too_few_parameters(self):
        ...
        self.assertEqual(cm_new.exception.message, "prepare_refrings2() takes at least 2 arguments (0 given)")
        self.assertEqual(cm_new.exception.message, cm_old.exception.message)
...
class Test_refprojs(unittest.TestCase):
    ...
    def test_wrong_number_params_too_few_parameters(self):
        ...
        with self.assertRaises(TypeError) as cm_old:
            oldfu.refprojs()
        self.assertEqual(cm_new.exception.message, "refprojs() takes exactly 8 arguments (0 given)")
        self.assertEqual(cm_new.exception.message, cm_old.exception.message)
...
class Test_(unittest.TestCase):
    ...
    def test_wrong_number_params_too_few_parameters(self):
        ...
        self.assertEqual(cm_new.exception.message, "proj_ali_incore_zoom() takes at least 6 arguments (0 given)")
        self.assertEqual(cm_new.exception.message, cm_old.exception.message)
...
class Test_proj_ali_incore_local_zoom(unittest.TestCase):
    def test_wrong_number_params_too_few_parameters(self):
        ...
        self.assertEqual(cm_new.exception.message, "proj_ali_incore_local_zoom() takes at least 8 arguments (0 given)")
        self.assertEqual(cm_new.exception.message, cm_old.exception.message)
...
class Test_ornq_gridding(unittest.TestCase):
    ...
    def test_wrong_number_params_too_few_parameters(self):
        ...
        with self.assertRaises(TypeError) as cm_old:
            oldfu.ornq_gridding()
        self.assertEqual(cm_new.exception.message, "ornq_gridding() takes at least 9 arguments (0 given)")
        self.assertEqual(cm_new.exception.message, cm_old.exception.message)
...
class Test_shc(unittest.TestCase):
    ...
    def test_shc(self):
        peak, pixel_error, number_of_checked_refs, iref = oldfu.shc(data="", refrings="", list_of_reference_angles="",
                                                                    numr="", xrng="", yrng="", step="", an=-1.0,
                                                                    sym="c1", finfo=None)
        pass
...
class Test_Numrinit(unittest.TestCase):
    ...
    def test_Full_mode(self):
        ...
        self.assertTrue(array_equal(return_new, return_old))
        self.assertTrue(array_equal(return_new, [2, 1, 16, 3, 17, 32, 4, 49, 32, 5, 81, 32]))

    def test_Half_mode(self):
        return_new = fu.Numrinit(2, 5, skip=1, mode="not_F")
        return_old = oldfu.Numrinit(2, 5, skip=1, mode="not_F")
        self.assertTrue(array_equal(return_new, return_old))
        self.assertTrue(array_equal(return_new, [2, 1, 8, 3, 9, 16, 4, 25, 16, 5, 41, 32]))
...
class Test_prepare_refrings(unittest.TestCase):
    ...
    def test_No_kb_ArgumentError_in_EMData_extract_plane_function(self):
        with self.assertRaises(TypeError) as cm_new:
            fu.prepare_refrings(self.volft, None,nz=4, delta=2.0, ref_a= even_angles(60.0), sym="c1", numr=self.numr, MPI=False, phiEqpsi="Minus", kbx=None, kby=None, initial_theta=0.1, delta_theta=0.5, initial_phi=0.1)
        with self.assertRaises(TypeError) as cm_old:
            oldfu.prepare_refrings(self.volft, None,nz=4, delta=2.0, ref_a= even_angles(60.0), sym="c1", numr=self.numr, MPI=False, phiEqpsi="Minus", kbx=None, kby=None, initial_theta=0.1, delta_theta=0.5, initial_phi=0.1)
        output_msg = "Python argument types in\n    EMData.extract_plane(EMData, Transform, NoneType)\ndid not match C++ signature:\n    extract_plane(EMAN::EMData {lvalue}, EMAN::Transform tf, EMAN::Util::KaiserBessel {lvalue} kb)"
        self.assertEqual(cm_new.exception.message, output_msg)
        self.assertEqual(cm_new.exception.message, cm_old.exception.message)
    ...
    def test_kb_cubic_sym_c1_and_referenceAngles_got_via_sparx_utilities_even_angles_and_Minus(self):
        volft,kb = prep_vol(self.volft)
        return_new = fu.prepare_refrings(volft, kb,nz=4, delta=2.0, ref_a= even_angles(60.0), sym="c1", numr=self.numr, MPI=False, phiEqpsi="Minus", kbx=None, kby=None, initial_theta=0.1, delta_theta=0.5, initial_phi=0.1)
        return_old = oldfu.prepare_refrings(volft, kb,nz=4, delta=2.0, ref_a= even_angles(60.0), sym="c1", numr=self.numr, MPI=False, phiEqpsi="Minus", kbx=None, kby=None, initial_theta=0.1, delta_theta=0.5, initial_phi=0.1)
        self.test_all_the_conditions(return_new,return_old)

    def test_kb_rect_sym_c1_and_referenceAngles_got_via_sparx_utilities_even_angles_and_Minus(self):
        volft, kbx, kby, kbz = prep_vol(model_blank(100, 50, 100))
        return_new = fu.prepare_refrings(volft, kbz,nz=4, delta=2.0, ref_a= even_angles(60.0), sym="c1", numr=self.numr, MPI=False, phiEqpsi="Minus", kbx=kbx, kby=kby, initial_theta=0.1, delta_theta=0.5, initial_phi=0.1)
        return_old = oldfu.prepare_refrings(volft, kbz,nz=4, delta=2.0, ref_a= even_angles(60.0), sym="c1", numr=self.numr, MPI=False, phiEqpsi="Minus", kbx=kbx, kby=kby, initial_theta=0.1, delta_theta=0.5, initial_phi=0.1)
        self.test_all_the_conditions(return_new,return_old)
...
class Test_align2d(unittest.TestCase):
    ...
    def test_Full_mode_zero_lastRing(self):
        ...
        return_old = oldfu.align2d(image, refim, xrng=[0, 0], yrng=[0, 0], step=1, first_ring=1, last_ring=0, rstep=1, mode = "F")
        self.assertTrue(array_equal(return_new, return_old))
        self.assertTrue(array_equal(return_new, (149.20416355133057, 0.0, 0.0, 0, 231789.05009828304)))
    ...
    def test_Half_mode_zero_lastRing(self):
        ...
        self.assertTrue(array_equal(return_new, return_old))
        self.assertTrue(array_equal(return_new, (0.75210951268672943, -0.0, 0.0, 1, 109166.1448026784)))
    ...
    def test_Full_mode(self):
        ...
        self.assertTrue(array_equal(return_new, return_old))
        self.assertTrue(array_equal(return_new, (271.26248359680176, 0.0, -0.0, 1, 47.040936375909936)))
    ...
    def test_Half_mode(self):
        ...
        self.assertTrue(array_equal(return_new, return_old))
        self.assertTrue(array_equal(return_new, (49.386130571365356, -0.0, 0.0, 1, 25.68331681913696)))
...
class Test_align2d_scf(unittest.TestCase):
    ...
    def test_with_valid_params(self):
        ...
        self.assertTrue(array_equal(return_new, return_old))
        self.assertTrue(array_equal(return_new,(179.20237851329148, 3.2698990821823117, 0.7647050324258848, 1, 218570.84244701988)))
    ...
    def test_with_invalid_ou_error_msg_output(self):
        ...
        self.assertTrue(array_equal(return_new, return_old))
        self.assertTrue(array_equal(return_new, (179.97646629810333, 2.9426632285057943, 0.8089097572080193, 1, 219435.78332319538)))
...
class Test_multialign2d_scf(unittest.TestCase):
    ...
    def test_with_valid_params_cimage_with_mode_F(self):
        ...
        return_old = oldfu.multalign2d_scf(dataa[0], [cimage], frotim, numr, xrng, yrng, ou=174)
        self.assertTrue(array_equal(return_new, return_old))
        self.assertTrue(array_equal(return_new,  (-3.885814464943489, 1.3383300498977648, 0, 53.547465205192566, 0, 22.231731358743193)))
    ...
    def test_with_valid_params_cimage_with_mode_H(self):
        ...
        return_old = oldfu.multalign2d_scf(dataa[0], [cimage], frotim, numr, xrng, yrng, ou=174)
        self.assertTrue(array_equal(return_new, return_old))
        self.assertTrue(array_equal(return_new,  (-3.887984832242739, 1.3200827893762717, 0, 53.596163392066956, 0, 22.225716444502115)))
