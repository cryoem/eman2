...
FILE_LIST_NOSE_TEST = ["test_morphology.py","test_projection.py","test_reconstruction.py","test_utilities.py", "test_alignment.py", "test_filter.py", "test_fundamentals.py", "test_statistics.py"]
