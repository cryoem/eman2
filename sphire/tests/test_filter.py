...
from tests.test_module import IMAGE_2D, IMAGE_BLANK_2D, IMAGE_3D, IMAGE_BLANK_3D, MASK

TOLERANCE = 0.0075

from libpy_py3 import sp_filter as oldfu
...
class Test_filt_vols(unittest.TestCase):
    ...
    def test_with_circularMASK(self):
        # not able to perform the real test because same values changes every time
...
class Test_filterlocal(unittest.TestCase):
    ...
    @unittest.skip("it crash because index out of error after 'if myid != main_node'. I think it has to run on the cluster to work properly")
