...
from bin_py3 import sp_pipe as oldfu
from sphire.bin import sp_pipe as fu
...
@unittest.skip("nov_26 IT FAILS because Adnan removes the link to the folder present in ABSOLUTE_PATH_TO_SPHIRE_DEMO_RESULTS_FOLDER_NEW")
