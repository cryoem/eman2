...
from bin_py3 import sp_window as oldfu

from tests.test_module import ABSOLUTE_OLDBIN_PATH,ABSOLUTE_BIN_PATH,remove_list_of_file,remove_dir, ABSOLUTE_PATH_TO_RESOURCES
...
class Test_Error_cases(unittest.TestCase):
    ...
    def test_wrong_CTF_param_source_error(self):
        testargs_new =  [path.join(ABSOLUTE_BIN_PATH, "sp_window.py"),path.join(ABSOLUTE_PATH_TO_RESOURCES,"../CorrectedSums","corrsum_dw","TcdA1-*_frames.mrc"), path.join(ABSOLUTE_PATH_TO_RESOURCES,"../02_CRYOLO","CBOX","TcdA1-*_frames.cbox"),  "nofileCCTER",'lucaprovawindow','--box_size=352' ]
        testargs_old = [path.join(ABSOLUTE_OLDBIN_PATH, "sp_window.py"),path.join(ABSOLUTE_PATH_TO_RESOURCES,"../CorrectedSums","corrsum_dw","TcdA1-*_frames.mrc"), path.join(ABSOLUTE_PATH_TO_RESOURCES,"../02_CRYOLO","CBOX","TcdA1-*_frames.cbox"),  "nofileCCTER",'lucaprovawindow','--box_size=352' ]
    ...
    def test_wrong_input_coordinates_path_pattern_error(self):
        testargs_new =  [path.join(ABSOLUTE_BIN_PATH, "sp_window.py"),path.join(ABSOLUTE_PATH_TO_RESOURCES,"../CorrectedSums","corrsum_dw","TcdA1-*_frames.mrc"), "nofile",  "nofileCCTER",'lucaprovawindow','--box_size=352' ]
        testargs_old = [path.join(ABSOLUTE_OLDBIN_PATH, "sp_window.py"),path.join(ABSOLUTE_PATH_TO_RESOURCES,"../CorrectedSums","corrsum_dw","TcdA1-*_frames.mrc"), "nofile",  "nofileCCTER",'lucaprovawindow','--box_size=352' ]
        with patch.object(sys, 'argv', testargs_new):
            with self.assertRaises(SystemExit):
                old_stdout = sys.stdout
                print_new = StringIO()
    ...
    @unittest.skip("Segmentation Fault occuring")
    ...
    def test_existing_output_dir_error(self):
        testargs_new =  [path.join(ABSOLUTE_BIN_PATH, "sp_window.py"),path.join(ABSOLUTE_PATH_TO_RESOURCES,"../CorrectedSums","corrsum_dw","TcdA1-*_frames.mrc"), path.join(ABSOLUTE_PATH_TO_RESOURCES,"../02_CRYOLO","EMAN","TcdA1-*_frames.cbox"),  path.join(ABSOLUTE_PATH_TO_RESOURCES,"../01_CTER","Tutorial_partres_select.txt"), ABSOLUTE_PATH_TO_RESOURCES,'--box_size=352' ]
        testargs_old = [path.join(ABSOLUTE_OLDBIN_PATH, "sp_window.py"),path.join(ABSOLUTE_PATH_TO_RESOURCES,"../CorrectedSums","corrsum_dw","TcdA1-*_frames.mrc"), path.join(ABSOLUTE_PATH_TO_RESOURCES,"../02_CRYOLO","EMAN","TcdA1-*_frames.cbox"),  path.join(ABSOLUTE_PATH_TO_RESOURCES,"../01_CTER","Tutorial_partres_select.txt"), ABSOLUTE_PATH_TO_RESOURCES,'--box_size=352' ]
        with patch.object(sys, 'argv', testargs_new):
            with self.assertRaises(SystemExit):
                old_stdout = sys.stdout
                print_new = StringIO()
    ...
    def test_no_micrograph_files_are_found(self):
        testargs_new =  [path.join(ABSOLUTE_BIN_PATH, "sp_window.py"),path.join(ABSOLUTE_PATH_TO_RESOURCES,"../CorrectedSums","corrsum_dw","TcdA1-*_not_a_file.mrc"), path.join(ABSOLUTE_PATH_TO_RESOURCES,"../02_CRYOLO","EMAN","TcdA1-*_frames.box"),  path.join(ABSOLUTE_PATH_TO_RESOURCES,"../01_CTER","Tutorial_partres_select.txt"), "test_windows",'--box_size=352' ]
        testargs_old = [path.join(ABSOLUTE_OLDBIN_PATH, "sp_window.py"),path.join(ABSOLUTE_PATH_TO_RESOURCES,"../CorrectedSums","corrsum_dw","TcdA1-*_not_a_file.mrc"), path.join(ABSOLUTE_PATH_TO_RESOURCES,"../02_CRYOLO","EMAN","TcdA1-*_frames.box"),  path.join(ABSOLUTE_PATH_TO_RESOURCES,"../01_CTER","Tutorial_partres_select.txt"), "test_windows",'--box_size=352' ]
        with patch.object(sys, 'argv', testargs_new):
            with self.assertRaises(SystemExit):
                old_stdout = sys.stdout
                print_new = StringIO()
    ...
    def test_coordinates_file_notFound_format_error(self):
        testargs_new =  [path.join(ABSOLUTE_BIN_PATH, "sp_window.py"),path.join(ABSOLUTE_PATH_TO_RESOURCES,"../CorrectedSums","corrsum_dw","TcdA1-*_frames.mrc"), path.join(ABSOLUTE_PATH_TO_RESOURCES,"../02_CRYOLO","CBOX","TcdA1-*_frames.box"),  path.join(ABSOLUTE_PATH_TO_RESOURCES,"../01_CTER","Tutorial_partres_select.txt"), "test_windows",'--box_size=352' ]
        testargs_old = [path.join(ABSOLUTE_OLDBIN_PATH, "sp_window.py"),path.join(ABSOLUTE_PATH_TO_RESOURCES,"../CorrectedSums","corrsum_dw","TcdA1-*_frames.mrc"), path.join(ABSOLUTE_PATH_TO_RESOURCES,"../02_CRYOLO","CBOX","TcdA1-*_frames.box"),  path.join(ABSOLUTE_PATH_TO_RESOURCES,"../01_CTER","Tutorial_partres_select.txt"), "test_windows",'--box_size=352' ]
        with patch.object(sys, 'argv', testargs_new):
            with self.assertRaises(SystemExit):
                old_stdout = sys.stdout
                print_new = StringIO()
    ...
    def test_partres_file_not_found(self):
        testargs_new =  [path.join(ABSOLUTE_BIN_PATH, "sp_window.py"),path.join(ABSOLUTE_PATH_TO_RESOURCES,"../CorrectedSums","corrsum_dw","TcdA1-*_frames.mrc"), path.join(ABSOLUTE_PATH_TO_RESOURCES,"../02_CRYOLO","EMAN","TcdA1-*_frames.box"),  path.join(ABSOLUTE_PATH_TO_RESOURCES,"../01_CTER","Tutorial_partres_select_not_found.txt"), "test_windows_new",'--box_size=352' ]
        testargs_old = [path.join(ABSOLUTE_OLDBIN_PATH, "sp_window.py"),path.join(ABSOLUTE_PATH_TO_RESOURCES,"../CorrectedSums","corrsum_dw","TcdA1-*_frames.mrc"), path.join(ABSOLUTE_PATH_TO_RESOURCES,"../02_CRYOLO","EMAN","TcdA1-*_frames.box"),  path.join(ABSOLUTE_PATH_TO_RESOURCES,"../01_CTER","Tutorial_partres_select_not_found.txt"), "test_windows_old",'--box_size=352' ]
        with patch.object(sys, 'argv', testargs_new):
            with self.assertRaises(SystemExit):
                old_stdout = sys.stdout
                print_new = StringIO()
    ...
    def test_error_invalid_option_value(self):
        testargs_new =  [path.join(ABSOLUTE_BIN_PATH, "sp_window.py"),path.join(ABSOLUTE_PATH_TO_RESOURCES,"../CorrectedSums","corrsum_dw","TcdA1-*_frames.mrc"), path.join(ABSOLUTE_PATH_TO_RESOURCES,"../02_CRYOLO","EMAN","TcdA1-*_frames.box"),  path.join(ABSOLUTE_PATH_TO_RESOURCES,"../01_CTER","Tutorial_partres_select.txt"), "test_windows_new","--coordinates_format='eman1'",'--box_size=352' ]
        testargs_old = [path.join(ABSOLUTE_OLDBIN_PATH, "sp_window.py"),path.join(ABSOLUTE_PATH_TO_RESOURCES,"../CorrectedSums","corrsum_dw","TcdA1-*_frames.mrc"), path.join(ABSOLUTE_PATH_TO_RESOURCES,"../02_CRYOLO","EMAN","TcdA1-*_frames.box"),  path.join(ABSOLUTE_PATH_TO_RESOURCES,"../01_CTER","Tutorial_partres_select.txt"), "test_windows_old","--coordinates_format='eman1'",'--box_size=352' ]
        with patch.object(sys, 'argv', testargs_new):
            with self.assertRaises(SystemExit):
                old_stdout = sys.stdout
                print_new = StringIO()
    ...
    def test_error_files_do_not_match(self):
        testargs_new = [path.join(ABSOLUTE_BIN_PATH, "sp_window.py"),path.join(ABSOLUTE_PATH_TO_RESOURCES, "../CorrectedSums", "corrsum_dw","TcdA1-001*_frames.mrc"),path.join(ABSOLUTE_PATH_TO_RESOURCES, "../02_CRYOLO", "EMAN","TcdA1-001*_frames.box"),path.join(ABSOLUTE_PATH_TO_RESOURCES, "../01_CTER","Tutorial_partres_select.txt"), "outfolder_new", '--box_size=352']
        testargs_old = [path.join(ABSOLUTE_OLDBIN_PATH, "sp_window.py"),path.join(ABSOLUTE_PATH_TO_RESOURCES, "../CorrectedSums", "corrsum_dw","TcdA1-001*_frames.mrc"),path.join(ABSOLUTE_PATH_TO_RESOURCES, "../02_CRYOLO", "EMAN","TcdA1-001*_frames.box"),path.join(ABSOLUTE_PATH_TO_RESOURCES, "../01_CTER","Tutorial_partres_select.txt"), "outfolder_old", '--box_size=352']
        with patch.object(sys, 'argv', testargs_new):
            with self.assertRaises(SystemExit):
                old_stdout = sys.stdout
                print_new = StringIO()
