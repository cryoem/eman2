...
//         .def( other< int >() - self )
	...
	typedef EMAN::Vec3f (EMAN::Transform3D::*transform3d_tranform_3d)(const EMAN::Vec3f&) const;
	typedef EMAN::Vec2f (EMAN::Transform3D::*transform3d_tranform_2d)(const EMAN::Vec2f&) const;
	...
	class_< EMAN::Transform3D >("Transform3D", init<  >())
		...
		.def("transform", transform3d_tranform_3d(&EMAN::Transform3D::transform))
		.def("transform", transform3d_tranform_2d(&EMAN::Transform3D::transform))
