...
BOOST_PYTHON_MODULE(libpyTransform2)
{
    ...
    class_< EMAN::Transform >("Transform", init<  >())
        ...
        .def(init< EMAN::Transform::EulerType, EMAN::Dict& >())
        .def(init< const EMAN::Vec3f&, EMAN::Transform::EulerType, EMAN::Dict& >())
        .def(init< const EMAN::Vec3f&, const EMAN::Vec3f&, EMAN::Transform::EulerType, EMAN::Dict& >())
        ...
        .def("set_rotation", (void (EMAN::Transform::*)(EMAN::Transform::EulerType, EMAN::Dict&) )&EMAN::Transform::set_rotation)
        ...
        .def("row_mult", &EMAN::Transform::row_mult)
        .def("row_add", &EMAN::Transform::row_add)
        .def("row_exch", &EMAN::Transform::row_exch)
        .def("print", &EMAN::Transform::print)
