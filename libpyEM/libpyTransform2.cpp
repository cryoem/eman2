...
BOOST_PYTHON_MODULE(libpyTransform2)
{
    class_< EMAN::Vec3f >("Vec3f", init<  >())
        ...
        .def("dot", (float (EMAN::Vec3f::*)(const EMAN::Vec3f&) const)&EMAN::Vec3f::dot)
        .def("dot", (float (EMAN::Vec3f::*)(const EMAN::Vec3i&) const)&EMAN::Vec3f::dot)
        .def("cross", (EMAN::Vec3f (EMAN::Vec3f::*)(const EMAN::Vec3f&) const)&EMAN::Vec3f::cross)
        .def("cross", (EMAN::Vec3f (EMAN::Vec3f::*)(const EMAN::Vec3i&) const)&EMAN::Vec3f::cross)
        .def("negate", &EMAN::Vec3f::negate, return_internal_reference< 1 >())
        .def("get_as_list", &EMAN::Vec3f::get_as_list)
    ...
    class_< EMAN::Vec3i >("Vec3i", init<  >())
        ...
        .def("negate", &EMAN::Vec3i::negate, return_internal_reference< 1 >())
        .def("get_as_list", &EMAN::Vec3i::get_as_list)
    ...
    class_< EMAN::Matrix3f >("Matrix3f", init<  >())
        ...
        .def("set_from_list", &EMAN::Matrix3f::set_from_list)
        ...
        .def("create_transpose", &EMAN::Matrix3f::create_transpose)
    ...
    class_< EMAN::Matrix4f >("Matrix4f", init<  >())
        ...
        .def("set_from_list", &EMAN::Matrix4f::set_from_list)
        ...
        .def("get_row", &EMAN::Matrix4f::get_row)
        .def("get_col", &EMAN::Matrix4f::get_col)
        .def( self - other< float >() )
        .def( self * other< float >() )
        .def( self / self )
        .def( self == self )
    ...
    class_< EMAN::Transform >("Transform", init<  >())
        ...
        .def("get_scale", (EMAN::Vec3f (EMAN::Transform::*)() const)&EMAN::Transform::get_scale)
