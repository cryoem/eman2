...
BOOST_PYTHON_MEMBER_FUNCTION_OVERLOADS(EMAN_Transform_incrementtrans_overloads_2_3, increment_trans,2, 3)
...
//	class_< EMAN::Transform, std::auto_ptr<EMAN::Transform>  >("Transform", init<  >())
		...
		.def("increment_trans", (void (EMAN::Transform::*)(const float&, const float&, const float&) )&EMAN::Transform::increment_trans, EMAN_Transform_incrementtrans_overloads_2_3(args("x", "y", "z"), "Increment the post translation component\n \nx - the x translation\ny - the y translation\nz - the z translation (default = 0)\n"))
		.def("increment_trans", (void (EMAN::Transform::*)(const EMAN::Vec3f&) )&EMAN::Transform::increment_trans, args("v"), "Increment the post translation component using a Vec3f\n \nv - the 3D translation vector\n")
		.def("increment_trans", (void (EMAN::Transform::*)(const EMAN::Vec2f&) )&EMAN::Transform::increment_trans, args("v"), "v - the 2D translation vector\n")
		...
		.def("increment_rotation", (void (EMAN::Transform::*)(const EMAN::Transform&) )&EMAN::Transform::increment_rotation, args("rotation"), "Increment the rotation using a noter tranfromation matrix.")
		...
		.def("increment_scale", &EMAN::Transform::increment_scale, args("scale"), "Increment the scale\n \nscale - the amount to scale by\n")
