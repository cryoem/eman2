...
class EMInspector3D(QtWidgets.QWidget):
	...
	def getLightsWidget(self):
		...
		lightslabel.setMaximumHeight(30)
		font = QtGui.QFont()
		font.setBold(True)
		...
		positionlabel.setMaximumHeight(20)
	...
	def updateInspector(self):
		...
		if self.cameratab_open:
			...
			self.cappingcolor.setColor(QtGui.QColor(int(255*self.scenegraph().camera.getCapColor()[0]),int(255*self.scenegraph().camera.getCapColor()[1]),int(255*self.scenegraph().camera.getCapColor()[2])))
			self._get_vv_state()
			self.scenegraph().setZslice()
			self.camerawidget.updateWidget()
		# utils
		self.backgroundcolor.setColor(QtGui.QColor(int(255*self.scenegraph().clearcolor[0]),int(255*self.scenegraph().clearcolor[1]),int(255*self.scenegraph().clearcolor[2])))
