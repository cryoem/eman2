...
class EMItem3D(object): #inherit object for new-style class (new-stype classes required for super() and Python properties)
	...
	def get_transformlayout(layout, idx, attribdict):
		...
		attribdict["tx"].setMinimumWidth(100)
		attribdict["ty"].setMinimumWidth(100)
		...
		attribdict["tz"].setMinimumWidth(100)
		attribdict["zoom"].setMinimumWidth(100)
		...
		attribdict["az"] .setMinimumWidth(100)
		attribdict["alt"].setMinimumWidth(100)
