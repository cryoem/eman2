	...
	def headerData(self,sec,orient,role):
		if orient==Qt.Horizontal:
			if role==Qt.DisplayRole :
				return EMBoxesModel.headers[sec]
...
class EMRCTBoxesModel(EMFileItemModel):
	...
	def headerData(self,sec,orient,role):
		if orient==Qt.Horizontal:
			if role==Qt.DisplayRole :
				return EMRCTBoxesModel.headers[sec]
			elif role==Qt.ToolTipRole:
				return None								# May fill this in later
...
class EMRawDataModel(EMFileItemModel):
	...
	def headerData(self,sec,orient,role):
		if orient==Qt.Horizontal:
			if role==Qt.DisplayRole :
				return EMRawDataModel.headers[sec]
			elif role==Qt.ToolTipRole:
				return None								# May fill this in later
