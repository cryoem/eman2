...
class EMReconstructAliFile(WorkFlowTask):
	'''Use this task for reconstructing ali files as generated by IMOD into 3D volumes using EMAN2's Fourier reconstructor. This requires you to supply the tlt file and ali files that are generated by IMOD.'''
