...
class EMReconstructAliFile(WorkFlowTask):
	'''Use this task for reconstructing ali files as generated by IMOD into 3D volumes using EMAN2's Fourier reconstructor. This requires you to supply the tlt file.'''
	...
	def get_params(self):
		...
		plot_table = EMPlotTable(desc_short="Tlt file",desc_long="Use this tool to browse for your tlt file",single_selection=True)
		ali_table = EMTomographicFileTable(desc_short="Ali file",desc_long="Use this tool to browse for your ali file",single_selection=True)
		
		for table in [plot_table,ali_table]:
		...
		params.append([plot_table,ali_table])
