...
class EMFontInspector(QtGui.QWidget, EMLightsInspectorBase):
	def __init__(self,target) :
		...
		self.cbb.currentIndexChanged[QtCore.QString].connect(target.setColor)
		...
		self.text.textChanged[QtCore.QString].connect(self.on_text_change)
		...
		self.Dfont.currentIndexChanged [QtCore.QString].connect(self.on_Dfont_change)
