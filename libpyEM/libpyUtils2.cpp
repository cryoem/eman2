...
BOOST_PYTHON_MODULE(libpyUtils2)
{
    ...
    class_< EMAN::Util >("Util", init<  >())
        ...
        .def("pad", &EMAN::Util::pad, return_value_policy< manage_new_object >(), EMAN_Util_pad_overloads_3_8())
        ...
        .def("reconstitue_image_mask", &EMAN::Util::reconstitue_image_mask, return_value_policy< manage_new_object >())
        ...
        .staticmethod("voea")
        .staticmethod("reconstitue_image_mask")
        .staticmethod("alrq")
