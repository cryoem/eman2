...
BOOST_PYTHON_MODULE(libpyUtils2)
{
	scope* EMAN_Util_scope = new scope(
		...
		.def("SqEuc_dist", &EMAN::Util::SqEuc_dist)
		.def("cml_line_in3d_full", &EMAN::Util::cml_line_in3d_full)
		.def("cml_line_in3d_iagl", &EMAN::Util::cml_line_in3d_iagl)
		.def("cml_weights", &EMAN::Util::cml_weights)
		.def("cml_spin", &EMAN::Util::cml_spin)
		.def("cml_line_pos", &EMAN::Util::cml_line_pos)
		.def("cml_list_line_pos", &EMAN::Util::cml_list_line_pos)
		...
		.staticmethod("SqEuc_dist")
		.staticmethod("cml_line_in3d_full")
		.staticmethod("cml_line_in3d_iagl")
		.staticmethod("cml_weights")
		.staticmethod("cml_spin")
		.staticmethod("cml_line_pos")
		.staticmethod("cml_list_line_pos")
