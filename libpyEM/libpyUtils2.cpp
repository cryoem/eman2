...
BOOST_PYTHON_FUNCTION_OVERLOADS(EMAN_Util_decimation_overloads_2_4, EMAN::Util::decimation, 2, 4)
...
BOOST_PYTHON_MODULE(libpyUtils2)
{
    ...
    class_< EMAN::Util >("Util", init<  >())
        ...
        .def("decimation", &EMAN::Util::decimation, EMAN_Util_decimation_overloads_2_4()[ return_value_policy< manage_new_object >() ])
