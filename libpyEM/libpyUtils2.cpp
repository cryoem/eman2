...
BOOST_PYTHON_MODULE(libpyUtils2)
{
    ...
    class_< EMAN::Util >("Util", init<  >())
        ...
        .def("spline_mat", &EMAN::Util::spline_mat)
        .def("spline", &EMAN::Util::spline)
        .def("splint", &EMAN::Util::splint)
        .def("sort_mat", &EMAN::Util::sort_mat)
        .def("Radialize", &EMAN::Util::Radialize)
