...
BOOST_PYTHON_MODULE(libpyUtils2)
{
    ...
    class_< EMAN::TestUtil >("TestUtil", init<  >())
        ...
        .def("to_IntPoint", &EMAN::TestUtil::to_IntPoint)
        .def("from_IntPoint", &EMAN::TestUtil::from_IntPoint)
        .def("to_FloatPoint", &EMAN::TestUtil::to_FloatPoint)
        .def("from_FloatPoint", &EMAN::TestUtil::from_FloatPoint)
        .def("to_IntSize", &EMAN::TestUtil::to_IntSize)
        .def("from_IntSize", &EMAN::TestUtil::from_IntSize)
        .def("to_FloatSize", &EMAN::TestUtil::to_FloatSize)
        .def("from_FloatSize", &EMAN::TestUtil::from_FloatSize)
        .def("to_Vec3f", &EMAN::TestUtil::to_Vec3f)
        .def("from_Vec3f", &EMAN::TestUtil::from_Vec3f)
        .def("to_Vec3i", &EMAN::TestUtil::to_Vec3i)
        .def("from_Vec3i", &EMAN::TestUtil::from_Vec3i)
        .staticmethod("from_IntSize")
        .staticmethod("from_FloatSize")
        .staticmethod("to_IntPoint")
        .staticmethod("to_FloatPoint")
        .staticmethod("to_Vec3i")
        .staticmethod("to_IntSize")
        .staticmethod("from_IntPoint")
        .staticmethod("from_Vec3f")
        .staticmethod("to_FloatSize")
        .staticmethod("from_Vec3i")
        .staticmethod("from_FloatPoint")
        .staticmethod("get_debug_image")
        .staticmethod("to_emobject")
        .staticmethod("to_Vec3f")
    ;
