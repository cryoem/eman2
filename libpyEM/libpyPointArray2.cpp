...
BOOST_PYTHON_MODULE(libpyPointArray2)
{
    ...
    class_< EMAN::PointArray >("PointArray", init<  >())
        ...
        .def("align_2d", &EMAN::PointArray::align_2d)
        ...
        .def("set_from", (void (EMAN::PointArray::*)(double*, unsigned int, const std::string&, EMAN::Transform3D*) )&EMAN::PointArray::set_from, EMAN_PointArray_set_from_overloads_2_4())
