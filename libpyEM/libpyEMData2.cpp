...
BOOST_PYTHON_FUNCTION_OVERLOADS(EMAN_EMData_read_images_by_index_overloads_1_3, EMAN::EMData::read_images_by_index, 1, 3)

BOOST_PYTHON_FUNCTION_OVERLOADS(EMAN_EMData_read_images_by_ext_overloads_3_5, EMAN::EMData::read_images_by_ext, 3, 5)
...
BOOST_PYTHON_MODULE(libpyEMData2)
{
    class_< EMAN::EMData >("EMData", init<  >())
        ...
        .def("set_translation", (void (EMAN::EMData::*)(const EMAN::Vec3<float>&) )&EMAN::EMData::set_translation)
        ...
        .def("get_average_nimg", &EMAN::EMData::get_average_nimg)
        .def("set_average_nimg", &EMAN::EMData::set_average_nimg)
        ...
        .def("get_xorigin", &EMAN::EMData::get_xorigin)
        .def("get_yorigin", &EMAN::EMData::get_yorigin)
        .def("get_zorigin", &EMAN::EMData::get_zorigin)
        .def("get_xpixel", &EMAN::EMData::get_xpixel)
        .def("get_ypixel", &EMAN::EMData::get_ypixel)
        .def("get_zpixel", &EMAN::EMData::get_zpixel)
		...
		.def("render_amp8",&EMAN::EMData::render_amp8_wrapper)
        .def("read_images_by_index", &EMAN::EMData::read_images_by_index, EMAN_EMData_read_images_by_index_overloads_1_3())
