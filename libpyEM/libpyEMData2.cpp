...
BOOST_PYTHON_MODULE(libpyEMData2)
{
    ...
    class_< EMAN::EMData >("EMData_cpp", init<  >())
        ...
        .def("FH2F", &EMAN::EMData::FH2F, return_value_policy< manage_new_object >())
        ...
        .def("set_array_offsets", &EMAN::EMData::set_array_offsets, EMAN_EMData_set_array_offsets_overloads_0_3())
        ...
        .def("gridrot2d_kbi0", &EMAN::EMData::gridrot2d_kbi0, return_value_policy< manage_new_object >(), EMAN_EMData_gridrot2d_kbi0_overloads_1_3())
        .def("extractpoint", &EMAN::EMData::extractpoint)
        .def("fouriergrid", &EMAN::EMData::fouriergrid, return_value_policy< manage_new_object >())
