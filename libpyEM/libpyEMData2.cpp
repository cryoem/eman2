...
// 	.def("get_data_void_pointer", (EMAN::Dict (EMAN::EMData::*)() const)&EMAN::EMData::get_data_void_pointer) removed by d.woolford - we never got the idea off the ground
	...
	.def("project", (EMAN::EMData* (EMAN::EMData::*)(const std::string&, const EMAN::Transform3D&) )&EMAN::EMData::project, return_value_policy< manage_new_object >() )
	...
	.def("fft_continuous_rotate", &EMAN::EMData::fft_continuous_rotate, return_value_policy< manage_new_object >())
	.def("ifft_realspace_rotate", &EMAN::EMData::ifft_realspace_rotate, return_value_policy< manage_new_object >())
...
//       .def("FourInterpol_i", &EMAN::EMData::FourInterpol_i, EMAN_EMData_FourInterpol_i_overloads_1_4()[ return_value_policy< manage_new_object >() ])
	...
	.def("norm_pad", &EMAN::EMData::norm_pad, return_value_policy< manage_new_object >())
