...
BOOST_PYTHON_MEMBER_FUNCTION_OVERLOADS(EMAN_EMData_calc_hist_overloads_0_2, calc_hist, 0, 2)
...
BOOST_PYTHON_MODULE(libpyEMData2)
{
    ...
    class_< EMAN::EMData >("EMData", init<  >())
        ...
        .def("calc_hist", &EMAN::EMData::calc_hist, EMAN_EMData_calc_hist_overloads_0_2())
