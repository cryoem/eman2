...
//	.def("set_supp_pickle", &EMAN::EMData::set_supp_pickle)
	...
	.def("get_value_at_wrap", (float (EMAN::EMData::*)(int, int, int) const)&EMAN::EMData::get_value_at_wrap)
	.def("get_value_at_wrap", (float (EMAN::EMData::*)(int, int) const)&EMAN::EMData::get_value_at_wrap)
	.def("get_value_at_wrap", (float (EMAN::EMData::*)(int) const)&EMAN::EMData::get_value_at_wrap)
	.def("get_complex_at", (std::complex<float> (EMAN::EMData::*)(int, int) const)&EMAN::EMData::get_complex_at)
	...
	.def("rot_scale_trans2D_background", &EMAN::EMData::rot_scale_trans2D_background, return_value_policy< manage_new_object >())
	.def("rot_scale_trans", &EMAN::EMData::rot_scale_trans, return_value_policy< manage_new_object >())
	.def("rot_scale_trans_background", &EMAN::EMData::rot_scale_trans_background, return_value_policy< manage_new_object >())
	...
	.def("rot_scale_conv_new_background", &EMAN::EMData::rot_scale_conv_new_background, return_value_policy< manage_new_object >())
	...
	.def("max_search", &EMAN::EMData::max_search)
