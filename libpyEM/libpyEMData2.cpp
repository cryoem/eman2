...
BOOST_PYTHON_MODULE(libpyEMData2)
{
    class_< EMAN::EMData >("EMData", init<  >())
        ...
        .def("get_2dview", (boost::multi_array_ref<float,2> (EMAN::EMData::*)() const)&EMAN::EMData::get_2dview)
        .def("get_3dview", (boost::multi_array_ref<float,3> (EMAN::EMData::*)() const)&EMAN::EMData::get_3dview)
        .def("get_2dview", (boost::multi_array_ref<float,2> (EMAN::EMData::*)(int, int) const)&EMAN::EMData::get_2dview)
        .def("get_3dview", (boost::multi_array_ref<float,3> (EMAN::EMData::*)(int, int, int) const)&EMAN::EMData::get_3dview)
