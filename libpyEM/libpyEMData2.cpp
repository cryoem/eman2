...
BOOST_PYTHON_MODULE(libpyEMData2)
{
    ...
    class_< EMAN::EMData >("EMData", init<  >())
        ...
        .def("process", (EMAN::EMData* (EMAN::EMData::*)(const std::string&, const EMAN::Dict&) )&EMAN::EMData::process, EMAN_EMData_process_overloads_1_2()[ return_value_policy< manage_new_object >() ])
	...
	.def("clip_inplace", &EMAN::EMData::clip_inplace, return_value_policy< reference_existing_object >())
        ...
        .def("__rsub__", (EMAN::EMData* (*)(const EMAN::EMData&, float) )&EMAN::operator-, return_value_policy< manage_new_object >() )
        .def("__rmul__", (EMAN::EMData* (*)(const EMAN::EMData&, float) )&EMAN::operator*, return_value_policy< manage_new_object >() )
        .def("__rdiv__", (EMAN::EMData* (*)(const EMAN::EMData&, float) )&EMAN::operator/, return_value_policy< manage_new_object >() )        
