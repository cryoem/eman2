...
BOOST_PYTHON_MEMBER_FUNCTION_OVERLOADS(EMAN_EMData_compute_missingwedge_stats_overloads_2_3, EMAN::EMData::compute_missingwedge_stats, 2, 3)
...
//	.def("rotate_translate", (void (EMAN::EMData::*)(const EMAN::Transform3D&) )&EMAN::EMData::rotate_translate, args("t"), "Rotate then translate the image.\nDEPRECATED USE EMData::Transform\n \nt - The rotation and translation transformation to be done.")
	...
	.def("getwedgestats", &EMAN::EMData::compute_missingwedge_stats, EMAN_EMData_compute_missingwedge_stats_overloads_2_3(args("wedgeangle", "wedgexform", "influnce"), "get the missingt wedge mean ansd std")[ return_value_policy< manage_new_object >() ])
