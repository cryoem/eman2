...
BOOST_PYTHON_MODULE(libpyEMData2)
{
    ...
    class_< EMAN::EMData >("EMData", init<  >())
        ...
        .def("power", &EMAN::EMData::power)
        .def("real", &EMAN::EMData::real)
        .def("imag", &EMAN::EMData::imag)
        .def("real2complex", &EMAN::EMData::real2complex, EMAN_EMData_real2complex_overloads_0_1())
