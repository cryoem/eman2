...
BOOST_PYTHON_MEMBER_FUNCTION_OVERLOADS(EMAN_EMData_do_fft_overloads_0_1, do_fft, 0, 1)

BOOST_PYTHON_MEMBER_FUNCTION_OVERLOADS(EMAN_EMData_do_ift_overloads_0_1, do_ift, 0, 1)
...
BOOST_PYTHON_MODULE(libpyEMData2)
{
    class_< EMAN::EMData >("EMData", init<  >())
        ...
        .def("do_fft", &EMAN::EMData::do_fft, return_value_policy< manage_new_object >(), EMAN_EMData_do_fft_overloads_0_1())
        .def("do_ift", &EMAN::EMData::do_ift, return_value_policy< manage_new_object >(), EMAN_EMData_do_ift_overloads_0_1())
        ...
        .def("is_padded", &EMAN::EMData::is_padded)
        .def("set_pad", &EMAN::EMData::set_pad)
