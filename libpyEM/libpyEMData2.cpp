...
BOOST_PYTHON_MEMBER_FUNCTION_OVERLOADS(EMAN_EMData_rot_scale_trans2D_overloads_4_5, rot_scale_trans2D, 4, 5)
...
BOOST_PYTHON_MODULE(libpyEMData2)
{
    ...
    class_< EMAN::EMData >("EMData", init<  >())
        ...
        .def("align", &EMAN::EMData::align, return_value_policy< manage_new_object >(), EMAN_EMData_align_overloads_2_4())
        ...
        .def("rot_scale_trans2D", &EMAN::EMData::rot_scale_trans2D, return_value_policy< manage_new_object >(), EMAN_EMData_rot_scale_trans2D_overloads_4_5())
