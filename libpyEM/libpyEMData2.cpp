...
BOOST_PYTHON_MEMBER_FUNCTION_OVERLOADS(EMAN_EMData_rot_scale_conv_new_3D_overloads_7_8, EMAN::EMData::rot_scale_conv_new_3D, 7, 8)
...
BOOST_PYTHON_MEMBER_FUNCTION_OVERLOADS(EMAN_EMData_rot_scale_conv_new_background_3D_overloads_7_8, EMAN::EMData::rot_scale_conv_new_background_3D, 7, 8)
...
BOOST_PYTHON_MEMBER_FUNCTION_OVERLOADS(EMAN_EMData_helicise_rect_overloads_3_6, EMAN::EMData::helicise_rect, 3, 6)
...
//	.def("symplane0_ctf", &EMAN::EMData::symplane0_ctf)
	...
	.def("rot_scale_conv_new_3D", &EMAN::EMData::rot_scale_conv_new_3D, EMAN_EMData_rot_scale_conv_new_3D_overloads_7_8(args("phi", "theta", "psi", "delx", "dely", "delz", "kb", "scale"), " ")[ return_value_policy< manage_new_object >() ])
	...
	.def("rot_scale_conv_new_background_3D", &EMAN::EMData::rot_scale_conv_new_background_3D, EMAN_EMData_rot_scale_conv_new_background_3D_overloads_7_8(args("phi", "theta", "psi", "delx", "dely", "delz", "kb", "scale"), "")[return_value_policy< manage_new_object >()])
	...
	.def("helicise_rect", &EMAN::EMData::helicise_rect, EMAN_EMData_helicise_rect_overloads_3_6(args("pixel_size", "dp", "dphi", "section_use", "radius"), "Apply rectangualr helical symmetry\nWorks only for a volume.\n \npixel_size - pixel size in Angstroms.\ndp - repeat in z direction in Angstroms.\ndphi - angular repeat in degrees.\nsection_use - how much of z section to use for symmetrization (between zero and one)(default=1.0).\nradius - radius of the structure (default nx/2-1)(default=-1.0).\ninrad - minimum radius of the structure (default 0.0)(default=-1.0).\n \nreturn New image")[return_value_policy< manage_new_object >()])
