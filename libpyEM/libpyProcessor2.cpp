...
BOOST_PYTHON_MODULE(libpyProcessor2)
{
    ...
    // Class to wrap CUDA kmeans code
    ...
    class_< EMAN::MPICUDA_kmeans, boost::noncopyable >("MPICUDA_kmeans", init<>())
      .def("test", &EMAN::MPICUDA_kmeans::test)
      .def("test2", &EMAN::MPICUDA_kmeans::test2)
      ...
      .def("get_NC_from_ASG", &EMAN::MPICUDA_kmeans::get_NC_from_ASG)
      ...
      .def("compute_sum", &EMAN::MPICUDA_kmeans::compute_sum)
      .def("compute_ave2", &EMAN::MPICUDA_kmeans::compute_ave2)
      ...
      .def("compute_ave_frombank", &EMAN::MPICUDA_kmeans::compute_ave_frombank)
      .def("compute_NC_frombank", &EMAN::MPICUDA_kmeans::compute_NC_frombank)
      .def("append_flat_image_tobank", &EMAN::MPICUDA_kmeans::append_flat_image_tobank)
      .def("setup_bank", &EMAN::MPICUDA_kmeans::setup_bank)
      .def("set_ASG_tobank", &EMAN::MPICUDA_kmeans::set_ASG_tobank)
    ;
